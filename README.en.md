...
![Plugins](https://img.shields.io/badge/plugins-1438-facc15?style=flat-square)
...
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 3273 | 🟢 ok | DSH Web UI plugin & skin collection: task board, git panel, etc. |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 1545 | 🟢 ok | Sidebar workbench: file render/terminal/git/subagent |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1048 | ⚪ unknown | DSH Web whale-girl skin series |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 500 | 🟢 ok | Vision for text-only models: image QA, screenshot OCR, UI reconstruction |
...
| [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) | 62 | 🟢 ok | Rewind conversation and workspace state |
...
| [dsh-openbiliclaw](https://github.com/whiteguo233/dsh-openbiliclaw) | 31 | ⚪ unknown | OpenBiliClaw content-agent bridge for DSH |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 50 | ⚪ unknown | Mnemon three-layer memory deep integration |
...
| [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) | 10 | ⚪ unknown | OpenMAIC: classrooms, slides, interactive widgets |
...
| [ego-browser](https://github.com/Fisfzy/ego-browser) | 18 | ⚪ unknown | Bridge ego-lite Chromium browser into DSH |
...
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 193 | 🟢 ok | Chrome sidebar extension letting DSH drive the browser. |
...
| [dsh-specflow](https://github.com/lonelymoon87/dsh-specflow) | 1 | ⚪ unknown | Specification-driven development toolkit for DeepSeek Harness. |
...
| [deepseek-harness-vsc-extension](https://github.com/weinibuliu/deepseek-harness-vsc-extension) | 10 | ⚪ unknown | DeepSeek Harness for VS Code |
...
| [anysearch-dsh](https://github.com/anysearch-team/anysearch-dsh) | 57 | 🟢 ok | AnySearch web search provider and advanced search tools for DeepSeek Harness (DSH) |
...
| [dsh-stock-watch](https://github.com/Awu12277/dsh-stock-watch) | 28 | ⚪ unknown | A股自选股实时行情盯盘插件 - DeepSeek Harness Web 右上角可折叠弹窗 |
...
| [dsh-spec-loop](https://github.com/tianji-qingtian/dsh-spec-loop) | 13 | ⚪ unknown | Spec-driven 开发闭环（OpenSpec 兼容）：/spec 命令族驱动 生成规格 → 批准 → 实现 → 逐条验收 → 归档 | Spec-driven dev loop (OpenSpec-compatible) for DeepSeek Ha… |
...
| [dsh-pet](https://github.com/PC2005-cloud/dsh-pet) | 55 | 🟢 ok | DeepSeek Harness 桌面宠物插件 + 完整素材生成链：AI 提示词 → 绿幕视频 → 透明动画 → 可安装插件，从零到宠物全流程可复现 |
...
| [dsh-agy](https://github.com/chaos-03x/dsh-agy) | 8 | 🟢 ok | Google Antigravity (agy) OAuth auth + model access plugin for DeepSeek Harness: multi-account pool, 429 rotation, device fingerpr… |
...
| [dsh-anchored-standard](https://github.com/xiaobright/dsh-anchored-standard) | 2844 | ⚪ unknown | Two-phase DeepSeek Harness preset: Minimal-aligned bootstrap, then full Standard tools (Project2 98/99) |
...
| [dsh-docling](https://github.com/Sqhao-O/dsh-docling) | 17 | ⚪ unknown | Native Docling document intelligence for DeepSeek Harness. |
...
| [dsh-docs](https://github.com/Sqhao-O/dsh-docs) | 17 | ⚪ unknown | Native Docling document intelligence for DeepSeek Harness. |
...
| [dsh-free-search](https://github.com/DDDMUC/dsh-free-search) | 4 | ⚪ unknown | Free web search provider for DeepSeek Harness - DuckDuckGo backend, no API key needed |
...
| [pi-deepseek-anchor](https://github.com/kxh4892636/pi-deepseek-anchor) | 11 | ⚪ unknown | pi extension: DeepSeek V4 Pro Minimal-anchored bootstrap, then full Standard tools (port of dsh-anchored-standard) |
...
| [anime-find](https://github.com/cocofhu/anime-find) | 5 | ⚪ unknown | DeepSeek Harness 搜番插件：对话内多源搜索番剧，卡片展示 Bangumi 评分与详情，支持复制磁力。 |
...
| [dsh-claude-ux](https://github.com/eri64/dsh-claude-ux) | 25 | ⚪ unknown | DSH plugin: Claude-style Chinese risk control & conversation autonomy for DeepSeek Harness web |
...
| [dsh-ikun-pet](https://github.com/eric-song-dev/dsh-ikun-pet) | 5 | ⚪ unknown | DeepSeek Harness（DSH）永久插件：Deep diving 回答期间用坤宠动图填满深潜状态行下方区块——进度条 0%→100%，每 20% 切换动作与文案，完成时系统级播放「你干嘛~哎哟」 |
...
| [dsh-skill-picker](https://github.com/a735624258/dsh-skill-picker) | 4 | ⚪ unknown | DSH 实现 workbuddy 同款选择 skill 功能 | WorkBuddy-style skill picker for DeepSeek Harness: pick a skill in the composer, insert the offi… |
...
| [ui-status-label](https://github.com/alingalingling/ui-status-label) | 37 | ⚪ unknown | Customize the whale-girl thinking-status label |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1048 | ⚪ unknown | DSH Web whale-girl skin series |
| [dsh-focus-chat](https://github.com/dingyi222666/dsh-focus-chat) | 16 | ⚪ unknown | Focused-chat minimal session view |
...
| [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) | 60 | ⚪ unknown | Selection annotation: select→annotate→send |
...
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 133 | ⚪ unknown | Inline interactive UI components in chat |
| [dsh-input-history](https://github.com/lhh010/dsh-input-history) | 4 | ⚪ unknown | Input history: Ctrl+Up/Down to recall sent messages |
| [dsh-navbar](https://github.com/vlln/dsh-navbar) | 26 | ⚪ unknown | Conversation node navbar |
...
| [dsh-status-rotator](https://github.com/01Virex/dsh-status-rotator) | 13 | ⚪ unknown | Web plugin replacing the DSH status display. |
...
| [deepseek-harness-skin](https://github.com/HeiGeAi/deepseek-harness-skin) | 38 | ⚪ unknown | deepseek-harness-skin — DSH plugin (ui) |
...
| [dsh-pet](https://github.com/FlytoMAYDAY80/dsh-pet) | 9 | 🟢 ok | dsh-pet — DSH plugin (ui) |
...
| [dsh-meme-hub](https://github.com/the-beating-light-of-the-nail/dsh-meme-hub) | 25 | ⚪ unknown | The meme side of DeepSeek Harness — 贪玩蓝鲸/QQ2006/whale girls/mini-games · A curated tour of the wildest dsh plugins |
...
| [dsh-undo-plugin](https://github.com/lire1131/dsh-undo-plugin) | 48 | ⚪ unknown | DSH plugin: snapshot & rollback your plugin/skin/settings configs. Auto-save on change, undo/redo stack, snapshot manager panel,… |
| [plugin-manager](https://github.com/whyihaveyou/dsh-suite) | 7 | 🟢 ok | In-app plugin store for DSH Web UI: browse the dsh-suite catalog, search/filter/sort, compat badges, one-click install — a Store… |
...
| [dsh-catppuccin](https://github.com/NoNameLeGo/dsh-catppuccin) | 7 | 🟢 ok | DeepSeek Harness Web GUI 的 Catppuccin 主题插件：Latte / Frappé / Macchiato / Mocha 四种风味一键切换 |
...
| [dsh-any-background](https://github.com/Tkingxiao/dsh-any-background) | 6 | 🟢 ok | 一个自定义主题插件，包括背景图（大小和位置），主界面和设置界面（透明度，色轮全色主题色）插件 |
...
| [dsh-message-preview](https://github.com/asukasec/dsh-message-preview) | 3 | ⚪ unknown | Right-side user-message navigator for the DeepSeek Harness Web UI. |
...
| [dsh-liang-skin](https://github.com/kingOfSoySauce/dsh-liang-skin) | 54 | ⚪ unknown | DeepSeek Harness 滑动变阻器皮肤 |
...
| [dsh-dream-skin](https://github.com/RevolutionLA/dsh-dream-skin) | 30 | ⚪ unknown | DeepSeek Harness 换肤 / 壁纸 / 主题包插件 (dsh-plugin) — 8 套 Mirage 主题、每用户强调色、壁纸2.0、主题包导入导出/分享链接、收藏与随机，纯原生 token 系统实现。 |
...
| [voyager](https://github.com/Nagi-ovo/voyager) | 19473 | ⚪ unknown | Enhancement suite for Gemini, AI Studio, Claude & ChatGPT — plus a prompt manager for any web UI, DeepSeek Harness included. / 面向… |
...
| [dsh-routing-suite](https://github.com/dragonbaba/dsh-routing-suite) | 6 | ⚪ unknown | Lightweight, localized task routing for DeepSeek Harness |
...
| [dsh-plugin-tts](https://github.com/1624318455/dsh-plugin-tts) | 4 | ⚪ unknown | Edge TTS voice plugin for DeepSeek Harness: read assistant replies aloud, auto-read toggle, voice settings panel (free, no API ke… |
...
| [dsh-catppuccin-theme](https://github.com/NoNameLeGo/dsh-catppuccin-theme) | 7 | ⚪ unknown | DeepSeek Harness Web GUI 的 Catppuccin 主题插件：Latte / Frappé / Macchiato / Mocha 四种主题一键切换，内置可开关的玻璃质感（Glassmorphism） |
...
| [dsh-evolve](https://github.com/william-jin-cmu/dsh-evolve) | 8 | ⚪ unknown | Self-evolution: agent grows/prunes its own abilities |
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 112 | ⚪ unknown | Cross-session long-term memory + background self-evolution |
...
| [dsh-sidechain](https://github.com/Buyi-wsgzg/dsh-sidechain) | 7 | ⚪ unknown | Side-chain sessions: /side persistent + /btw one-off |
...
| [dsh-plugin-claude-bridge](https://github.com/YYTbit/dsh-plugin-claude-bridge) | 6 | 🟢 ok | Bridge Claude Code memory, skills, and config into DeepSeek Harness |
...
| [dsh-mneme](https://github.com/modusensus/dsh-mneme) | 15 | ⚪ unknown | dsh-mneme — DSH plugin (session) |
...
| [dsh-client-pricing](https://github.com/Miyazawai/dsh-client-pricing) | 11 | ⚪ unknown | 会话顶栏实时显示 DeepSeek API 价格（峰谷定价 / 现行一口价，flash / pro 自动切换） | DeepSeek Harness client plugin: live DeepSeek API pricing badge (peak/o… |
...
| [dsh-noema](https://github.com/ZSeven-W/dsh-noema) | 81 | ⚪ unknown | Noema long-term memory plugin for DSH: durable, inspectable agent memory with recall tools and a settings page. |
...
| [DSH-recall-plugin](https://github.com/limbo947/DSH-recall-plugin) | 10 | 🟢 ok | DSH 消息撤回插件：回到发送该消息时的状态 |
...
| [dsh-chatgpt-bridge](https://github.com/jiezeng2004-design/dsh-chatgpt-bridge) | 6 | ⚪ unknown | MCP bridge that lets ChatGPT create, view, continue, and control DeepSeek Harness (DSH) agent sessions. |
...
| [dsh-files](https://github.com/taxueseek/dsh-files) | 5 | ⚪ unknown | DeepSeek Harness dual-face plugin: session-isolated file upload with colorful composer cards + read_document tool (text/PDF/DOCX/… |
...
| [dsh-mermaid](https://github.com/AKS1st/dsh-mermaid) | 3 | ⚪ unknown | 在 DSH Web 会话中把 Mermaid 代码围栏渲染为 SVG 图表 | Render Mermaid code fences as SVG diagrams in DSH Web messages |
...
| [dsh-recall-plugin](https://github.com/limbo947/dsh-recall-plugin) | 10 | ⚪ unknown | DSH 消息撤回插件：回到发送该消息时的状态 |
...
| [dsh-archived-sessions](https://github.com/MuWinds/dsh-archived-sessions) | 4 | ⚪ unknown | DeepSeek Harness 插件-归档会话管理，支持释放、清除归档会话 |
...
| [dsh-Remote](https://github.com/Blank-not-black/dsh-Remote) | 5 | ⚪ unknown | DSH Remote · 口袋里的 DSH 控制台 会话 · 审批 · 提问 · 文件传输，局域网 / Tailscale 直连 多服务器自动选优，聊天记录离线可看 带 Token 鉴权，数据只在你的设备之间流动 |
...
| [dsh-self-improved](https://github.com/madage/dsh-self-improved) | 4 | ⚪ unknown | DeepSeek Harness long-term memory & self-evolving plugin: L0 capture -> L1 memory extraction -> L2 scene grouping -> L3 user pers… |
...
| [dsh-vision](https://github.com/william-jin-cmu/dsh-vision) | 29 | 🟢 ok | view_image tool bridging any OpenAI-compatible VLM |
| [modlens](https://github.com/liustack/modlens) | 2277 | 🟢 ok | The first vision plugin for DeepSeek Harness — let text-only models see. |
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 943 | ⚪ unknown | Vision toolbox & skills for text-only models: multi-image QA, UI reconstruction, GUI automation. |
...
| [TokenLedger](https://github.com/zh667/TokenLedger) | 19 | ⚪ unknown | Token usage accounting for DeepSeek Harness, reconciled against New API and Sub2API relay-site billing |
...
| [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) | 30 | 🟢 ok | Unofficial DeepSeek Harness LLM provider plugin for Command Code: live model catalog, reasoning-effort support, Models-page card.… |
...
| [dsh-usage-stats](https://github.com/Make0209/dsh-usage-stats) | 14 | 🟢 ok | DeepSeek Harness 插件：GitHub 风格用量热力图 + Token / 缓存命中 / 账户余额看板 + 工作区别名管理。 |
...
| [dsh-AuthInOne](https://github.com/Stormycry-cryp/dsh-AuthInOne) | 12 | ⚪ unknown | DeepSeek Harness plugin for OpenAI Codex account login, API and custom OpenAI-compatible providers, model switching, token usage… |
...
| [deepseek-harness-studio](https://github.com/fufankeji/deepseek-harness-studio) | 135 | ⚪ unknown | DeepSeek Harness Studio：面向 DeepSeek Harness 的现代化桌面开发环境，内置插件中心、视觉增强与本地 Host。 |
...
| [mirage-dsh](https://github.com/strukto-ai/mirage) | 3464 | ⚪ unknown (exact pin dsh-fs@0.0.1-rc.1 / dsh-shell@0.0.1-rc.5，与 0.1.0-rc.6 线可能冲突；layer-1 判定) | Swap DSH's fs/shell providers for a mirage virtual workspace: file tools and shell commands act on mounted resources (RAM, disk,… |
...
| [exo](https://github.com/exoharness/exo) | 716 | ⚪ unknown | Fully recursive agent+harness that self-edits at runtime |
| [synergy](https://github.com/SII-Holos/synergy) | 545 | ⚪ unknown | General-purpose agent for the Open Agentic Web |
| [ccteam](https://github.com/firstintent/ccteam) | 165 | ⚪ unknown | Orchestrates Claude Code/Codex/Grok/Kimi into one team |
...
| [distill](https://github.com/LoserFox/distill) | 19 | ⚪ unknown | Auto conversation distillation: background subagent reflection |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 399 | 🟢 ok | AgentTeams plugin |
...
| [dsh-plugin-product-subagents](https://github.com/shaokeyibb/dsh-plugin-product-subagents) | 9 | 🟢 ok | Role-based Codex/Claude Code/ACP subagent presets. |
...
| [Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 2837 | ⚪ unknown | VibeSkills is a general-purpose Skill that automatically routes local Skills and intelligently orchestrates harness workflows. |
...
| [ds-spec-loop](https://github.com/songyang0603/ds-spec-loop) | 17 | ⚪ unknown | Portable Agent Skill for repository-native Spec programming, informed by public DeepSeek Harness engineering patterns. |
...
| [pi2dsh](https://github.com/weijiafu14/pi2dsh) | 17 | ⚪ unknown | Bridge the Pi and DeepSeek Harness ecosystems: one Pi Host ABI runs unmodified Pi extensions as native DSH plugins. 打通 Pi 与 DSH 生… |
...
| [dsh-llm-oauth](https://github.com/ziyou979/dsh-llm-oauth) | 4 | ⚪ unknown | DeepSeek Harness plugin: OAuth / subscription-plan LLM providers (Grok, GitHub Copilot, OpenAI Codex, Anthropic, OpenRouter) |
...
| [deepseek-harness-mobile](https://github.com/sorsama/deepseek-harness-mobile) | 7 | ⚪ unknown | Android companion for DeepSeek Harness | chat, goals, approvals & notifications from your phone, over your LAN. Kotlin + Jetpack… |
...
| [dsh-balance-plugin](https://github.com/Francis-Xavier-code/dsh-balance-plugin) | 22 | 🟢 ok | deepSeek 余额监控与用量统计（DSH 动态 Cordis 插件）：余额监控 · 官方充值入口 · 用量统计 · 三方插件管理 |
...
| [dsh-pocket](https://github.com/shaobeichen/dsh-pocket) | 11 | ⚪ unknown | 把 DeepSeek Harness 装进你的口袋：电脑上跑 dsh web，手机扫码即同步访问（局域网 + 公网，实时同屏） |
...
| Plugin | ⭐ | Compat | Description |
|---|---|---|---|
| [EchoBird](https://github.com/edison7009/EchoBird) | 3039 | ⚪ unknown | One-click install + model switch across 20+ coding agents |
| [awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) | 1038 | ⚪ unknown | DSH plugin directory with daily compatibility tracking |
...
| [awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 582 | ⚪ unknown | DSH ecosystem curation: plugins, tools, infra |
| [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 187 | 🟢 ok | DeepSeek Harness terminal UI |
| [agent-skills](https://github.com/GitHubxsy/agent-skills) | 20 | ⚪ unknown | Reusable skills for AI coding agents |
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 258 | ⚪ unknown | Codex-style @file mentions for DeepSeek Harness: search workspace files in the composer and attach their contents to prompts. |
...
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 451 | ⚪ unknown | 2005-style sidebar ads plugin (parody) |
...
| [dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil) | 96 | 🟢 ok | OpenPencil design preview and editing plugin for DSH |
| [oh-dsh-desktop](https://github.com/hust-open-atom-club/oh-dsh-desktop) | 212 | ⚪ unknown | Extensible macOS DSH workbench with native PTY |
| [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) | 152 | ⚪ unknown | In-chat generative UI: interactive HTML cards |
...
| [plugin-registry](https://github.com/vlln/plugin-registry) | 49 | ⚪ unknown | DSH plugin registry infra: browser panel for official repository plugins |
| [create-dsh-plugin](https://github.com/whyihaveyou/dsh-suite) | 3 | 🟢 ok | Scaffold a DeepSeek Harness (DSH) plugin in seconds — tool / events / webui templates, next-tag version pinning, and a built-in -… |
...
| [dsh-telegram-channel](https://github.com/hi-wenw/dsh-telegram-channel) | 6 | ⚪ unknown | DeepSeek Harness Telegram mobile remote: bind live Web sessions (Codex-style). Install: dsh plugin add github:hi-wenw/dsh-telegra… |
...
| [dsh-notification-center](https://github.com/610la/dsh-notification-center) | 7 | ⚪ unknown | DSH 通知中心插件：对话/任务完成、报错、等待批准等事件触发浏览器通知 + 21 种匹配音效 |
...
| [dsh-lark](https://github.com/sugarforever/dsh-lark) | 6 | ⚪ unknown | DeepSeek Harness Plugin for Lark Integration |

> Badges: 🟢 compatible · 🔴 broken · ⚪ unverified · ⚫ unmaintained.
> 1438 entries total, grouped by category, sorted by ⭐ within each. Schema dictionary: [docs/catalog-schema.md](docs/catalog-schema.md).
<!-- CATALOG:END -->
