...
![Plugins](https://img.shields.io/badge/plugins-1232-facc15?style=flat-square)
...
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 1977 | ⚪ unknown | DSH Web UI plugin & skin collection: task board, git panel, etc. |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 795 | ⚪ unknown | Sidebar workbench: file render/terminal/git/subagent |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 608 | ⚪ unknown | DSH Web whale-girl skin series |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 339 | ⚪ unknown | Vision for text-only models: image QA, screenshot OCR, UI reconstruction |
...
| [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) | 42 | ⚪ unknown | Rewind conversation and workspace state |
...
| [dsh-interconnect](https://github.com/Chinesezjc/dsh-interconnect) | 26 | ⚪ unknown | Cross-instance message/event handoff |
...
| [dsh-plugin-mineru](https://github.com/HuanLinOTO/dsh-plugin-mineru) | 11 | ⚪ unknown | MineRU document parsing tools |
...
| [dsh-tool-search](https://github.com/vibeinging/dsh-tool-search) | 2 | ⚪ unknown | Per-agent on-demand tool discovery + progressive schema |
...
| [modsearch](https://github.com/liustack/modsearch) | 94 | ⚪ unknown | Web search plugin for DeepSeek Harness. |
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 96 | ⚪ unknown | Chrome sidebar extension letting DSH drive the browser. |
...
| [dsh-github-connector](https://github.com/kaziii/dsh-github-connector) | 3 | ⚪ unknown | GitHub connector for DeepSeek Harness (dsh): one-click connect, create/review/merge PRs from the conversation |
| [deepseek-pet](https://github.com/keleus/deepseek-pet) | 9 | ⚪ unknown | deepseek-pet — DSH plugin (tools) |
...
| [dsh-composer-history](https://github.com/PerryLink/dsh-composer-history) | 3 | ⚪ unknown | Terminal-style input history for the DeepSeek Harness web composer - edge-first arrow keys, draft stashing with exact restore, Es… |
...
| [dsh-github](https://github.com/PerryLink/dsh-github) | 3 | ⚪ unknown | GitHub integration for DeepSeek Harness: create PRs, review PRs in background jobs, read issues - every write gated by human appr… |
...
| [dsh-codex](https://github.com/Yan-Zero/dsh-codex) | 8 | ⚪ unknown | Use your ChatGPT subscription in DeepSeek Harness through OpenAI's Codex sign-in flow |
...
| [dsh-terminal](https://github.com/ZgblKylin/dsh-terminal) | 3 | ⚪ unknown | Integrate terminal plugin for DeepSeek Harness |
...
| [dsh-doctor](https://github.com/jorinyang/dsh-doctor) | 1 | ⚪ unknown | DeepSeek Harness environment diagnostic tool: dsh_doctor checks env, profile, config, bundles, mount, port, health, and disk |
...
| [dsh-doctor](https://github.com/asdf17128/dsh-doctor) | 1 | ⚪ unknown | Find what your DeepSeek Harness (dsh) patches silently broke — dead patches, config fields dropped by whole-config replacement, u… |
...
| [dsh-prompt-enhancer](https://github.com/Fishsb/dsh-prompt-enhancer) | 2 | ⚪ unknown | dsh-prompt-enhancer — DSH plugin (tools) |
...
| [dsh-verification-receipt](https://github.com/030611/dsh-verification-receipt) | 4 | ⚪ unknown | Privacy-minimal heuristic per-turn verification summaries for DeepSeek Harness |
...
| [dsh-kanban](https://github.com/isolat-3k/dsh-kanban) | 1 | ⚪ unknown | dsh-kanban — DSH plugin (tools) |
| [dsh-tool-git](https://github.com/lxj808624/dsh-tool-git) | 3 | ⚪ unknown | Structured safe Git tools for DeepSeek Harness (dsh): git_status/diff/log/branch/stage/commit/stash/show + destructive-command gu… |
...
| [dsh-plugin-knowledge-graph](https://github.com/Luke-Yong/dsh-plugin-knowledge-graph) | 2 | ⚪ unknown | dsh-plugin-knowledge-graph for Deepseek Harness |
...
| [MuseAI](https://github.com/yejiming/MuseAI) | 542 | ⚪ unknown | 创建你的 AI 角色，进入你的故事世界。和角色聊天、冒险、穿书，让每一次互动都留下羁绊（支持 DeepSeek Harness 插件，欢迎使用） |
...
| [deepseek-harness-cli](https://github.com/soolaugust/deepseek-harness-cli) | 1 | ⚪ unknown | DeepSeek Harness: Everything is a Plugin. |
...
| [dsh-toy](https://github.com/c3ll256/dsh-toy) | 28 | ⚪ unknown | Toy Control Protocol for DSH |
...
| [dsh-bottom-bar](https://github.com/kc0ed/dsh-bottom-bar) | 2 | ⚪ unknown | 用于提供更丰富的DeepSeek Harness底栏信息显示插件 |
...
| [dsh-pet](https://github.com/PC2005-cloud/dsh-pet) | 14 | ⚪ unknown | DeepSeek Harness 桌面宠物插件 + 完整素材生成链：AI 提示词 → 绿幕视频 → 透明动画 → 可安装插件，从零到宠物全流程可复现 |
...
| [dsh-agy](https://github.com/chaos-03x/dsh-agy) | 4 | ⚪ unknown | Google Antigravity (agy) OAuth auth + model access plugin for DeepSeek Harness: multi-account pool, 429 rotation, device fingerpr… |
...
| [dsh-article-publish](https://github.com/yangyongzhen/dsh-article-publish) | 2 | ⚪ unknown | Publish articles from DeepSeek Harness to CSDN / Juejin / CNBlog. dsh plugin. |
...
| [dsh-anchored-standard](https://github.com/xiaobright/dsh-anchored-standard) | 483 | ⚪ unknown | Two-phase DeepSeek Harness preset: Minimal-aligned bootstrap, then full Standard tools (Project2 98/99) |
...
| [dsh-qqbot](https://github.com/tencent-connect/dsh-qqbot) | 18 | ⚪ unknown | 让 QQ 机器人接入 DeepSeek Harness（dsh）的官方插件 |
...
| [dsh-side-chat](https://github.com/AHGGG/dsh-side-chat) | 5 | ⚪ unknown | Codex-style Side Chat for DeepSeek Harness — select text, ask follow-up questions in a focused side conversation, and keep the ma… |
...
| [dsh-museai-tavern](https://github.com/yejiming/dsh-museai-tavern) | 4 | ⚪ unknown | MuseAI的DeepSeek Harness插件，可以将你的MuseAI角色放进DSH使用啦！ |
...
| [dsh-plugin-working-status](https://github.com/Abyss-Seeker/dsh-plugin-working-status) | 4 | ⚪ unknown | 把思考状态里那句 "Deep diving..." 改成你喜欢的任何话。超轻量级。 |
...
| [dsh-plugin-manager](https://github.com/monk233/dsh-plugin-manager) | 3 | ⚪ unknown | DSH 插件管理, 一键启用/禁用插件 |
...
| [dsh-plugin](https://github.com/Tabbit-Browser/dsh-plugin) | 6 | ⚪ unknown | Tabbit Broser plugins for Deepseek Harness |
...
| [dsh-docling](https://github.com/Sqhao-O/dsh-docling) | 3 | ⚪ unknown | Native Docling document intelligence for DeepSeek Harness. |
...
| [dsh-plugin-diff-review](https://github.com/Civitasv/dsh-plugin-diff-review) | 2 | ⚪ unknown | Diff Review Plugin for DeepSeek Harness |
...
| [dsh-us-stocks](https://github.com/Realyujie/dsh-us-stocks) | 3 | ⚪ unknown | US stock market data tools for DeepSeek Harness, powered by yahoo-finance2 |
...
| [dsh-chat-timeline](https://github.com/jjxjjjjiik-bot/dsh-chat-timeline) | 3 | ⚪ unknown | 1:1 port of DeepSeek's official web right-side chat navigation rail (ScrollNav) as a DeepSeek Harness (DSH) plugin |
...
| [deepseek-harness-for-vscode](https://github.com/skymecode/deepseek-harness-for-vscode) | 3 | ⚪ unknown | deepseek-harness for vscode .This is a community project, and we welcome your valuable feedback! |
| [DSH-EvoResearch](https://github.com/Karbo123/DSH-EvoResearch) | 3 | ⚪ unknown | 自进化科研工作流 |
...
| [dsh-auto-mode](https://github.com/NanmiCoder/dsh-auto-mode) | 6 | ⚪ unknown | Safe automatic permissions for DeepSeek Harness. |
...
| [dsh-docs](https://github.com/Sqhao-O/dsh-docs) | 3 | ⚪ unknown | Native Docling document intelligence for DeepSeek Harness. |
| [dsh-hanako](https://github.com/Nyasers/dsh-hanako) | 3 | ⚪ unknown | DSH for Hanako |
...
| [dsh-find-skill](https://github.com/Moximxxx/dsh-find-skill) | 2 | ⚪ unknown | dsh plugin bridging the vercel-labs/skills ecosystem: LLM-driven skill search, install, and lifecycle for temp/project/global sco… |
...
| [superpowers-dsh](https://github.com/LayneChai/superpowers-dsh) | 19 | ⚪ unknown | Superpowers skills for DeepSeek Harness: TDD, debugging, planning, and collaboration skills adapted from obra/superpowers |
| [dsh-skill-viewer](https://github.com/Fishquito7/dsh-skill-viewer) | 23 | ⚪ unknown | DSH Web UI plugin: Skills settings section with hot enable/disable, delete and add |
...
| [dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill) | 4 | ⚪ unknown | Complete reverse-skill (85 SKILL.md) as a DeepSeek Harness (dsh) Cordis plugin — reverse engineering, authorized pentesting and s… |
...
| [dsh-youmind-plugin](https://github.com/seamas0825-lab/dsh-youmind-plugin) | 2 | ⚪ unknown | YouMind OpenAPI tools and skill bundle for DeepSeek Harness |
...
| [dsh-design-skills](https://github.com/zhaiyateng/dsh-design-skills) | 4 | ⚪ unknown | Design aesthetics skill pack for DeepSeek Harness (DSH) - keeps vibe-coded websites away from the AI look. 6 styles: dark-saas, a… |
...
| [ui-status-label](https://github.com/alingalingling/ui-status-label) | 30 | ⚪ unknown | Customize the whale-girl thinking-status label |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 608 | ⚪ unknown | DSH Web whale-girl skin series |
| [dsh-focus-chat](https://github.com/dingyi222666/dsh-focus-chat) | 15 | ⚪ unknown | Focused-chat minimal session view |
...
| [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) | 41 | ⚪ unknown | Selection annotation: select→annotate→send |
...
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 76 | ⚪ unknown | Inline interactive UI components in chat |
...
| [dsh-drag-and-drop](https://github.com/bill9109/dsh-drag-and-drop) | 5 | ⚪ unknown | Cross-platform file drag & drop with raw path insertion |
...
| [dsh-web-ui-notify](https://github.com/bill9109/dsh-web-ui-notify) | 11 | ⚪ unknown | Desktop notifications for DSH |
| [ex-setting](https://github.com/omdsh-dev/ex-setting) | 2 | ⚪ unknown | DSH settings extension |
| [whale-girl](https://github.com/vlln/whale-girl) | 131 | ⚪ unknown | QQ-pet-style desktop pet plugin |
...
| [deepseek-harness-skin](https://github.com/HeiGeAi/deepseek-harness-skin) | 26 | ⚪ unknown | deepseek-harness-skin — DSH plugin (ui) |
...
| [dsh-pet](https://github.com/FlytoMAYDAY80/dsh-pet) | 7 | ⚪ unknown | dsh-pet — DSH plugin (ui) |
...
| [dsh-builtin-toggles](https://github.com/Starfie1d1272/dsh-builtin-toggles) | 5 | ⚪ unknown | Safe GUI toggles for optional built-in plugins in DeepSeek Harness Web. |
...
| [dsh-skin](https://github.com/KinGao294/dsh-skin) | 10 | ⚪ unknown | Skin switcher + custom wallpaper for DeepSeek Harness (dsh): curated --dsw-alias-* palettes, translucent wallpaper with opacity/b… |
| [dsh-pomodoro](https://github.com/causebefore/dsh-pomodoro) | 2 | ⚪ unknown | dsh-pomodoro — DSH plugin (ui) |
...
| [dsh-plugin-workshop](https://github.com/yyyyukari/dsh-plugin-workshop) | 16 | ⚪ unknown | Steam Workshop-style in-app plugin browser for DeepSeek Harness (DSH) Web UI - zero-server: search, trending windows, Chinese sea… |
...
| [dsh-meme-hub](https://github.com/the-beating-light-of-the-nail/dsh-meme-hub) | 15 | ⚪ unknown | The meme side of DeepSeek Harness — 贪玩蓝鲸/QQ2006/whale girls/mini-games · A curated tour of the wildest dsh plugins |
...
| [dsh-outline](https://github.com/urzeye/dsh-outline) | 5 | ⚪ unknown | DeepSeek Harness（DSH）Web GUI 的实时大纲插件 |
...
| [touhou-hakurei](https://github.com/xiake595/touhou-hakurei) | 4 | ⚪ unknown | 灵梦（Reimu）·博丽神社（东方Project）美化版皮肤：神社昼夜实景背景、灵梦立绘、画框侧边栏与输入框、纸白透明界面 — DeepSeek Harness Web GUI skin |
...
| [Catppuccin-dsh-theme](https://github.com/zhijun-dai/Catppuccin-dsh-theme) | 2 | ⚪ unknown | Soothing pastel theme for DeepSeek Harness |
...
| [dsh-workbench](https://github.com/Dpf555/dsh-workbench) | 5 | ⚪ unknown | VS Code-style three-column Explorer + Monaco editor plugin for the DeepSeek Harness web GUI |
...
| [dsh-sidebar-qa](https://github.com/ChenRuoT/dsh-sidebar-qa) | 5 | ⚪ unknown | 一个基于DSH-better-sidebar的侧边栏提问tab，实现类codex的侧边提问或claude code的/btw功能 |
...
| [dsh-skin-appearance](https://github.com/Vim0x3c/dsh-skin-appearance) | 3 | ⚪ unknown | DeepSeek Harness 外观定制插件：八套内置主题 + 自定义壁纸（透明度/模糊），Host 设置持久化 | Appearance plugin for dsh web |
...
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 59 | ⚪ unknown | Cross-session long-term memory + background self-evolution |
...
| [plugin-session-export](https://github.com/whyihaveyou/dsh-suite) | 3 | 🟢 ok | Export the append-only session log as human-readable Markdown / HTML, grouped by trajectory source (system prompt / reasoning / t… |
| [dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) | 28 | ⚪ unknown | Import chat history from Claude Code/Codex/Reasonix into DSH. |
...
| [context-vista](https://github.com/GooodWei/context-vista) | 4 | ⚪ unknown | context-vista — DSH plugin (session) |
...
| [dsh-memento](https://github.com/PerryLink/dsh-memento) | 3 | ⚪ unknown | Bounded, layered, approval-gated, auditable cross-session memory for DeepSeek Harness (capability seam: ctx.memory + SQLite provi… |
...
| [dsh-memento](https://github.com/PerryLink/dsh-memento) | 3 | ⚪ unknown | Bounded, layered, approval-gated, auditable cross-session memory for DeepSeek Harness (capability seam: ctx.memory + SQLite provi… |
| [dsh-archive-viewer](https://github.com/keepermttl/dsh-archive-viewer) | 3 | ⚪ unknown | dsh-archive-viewer — DSH plugin (session) |
| [dsh-codex-provider](https://github.com/Hu9956/dsh-codex-provider) | 5 | ⚪ unknown | OpenAI Codex provider for DeepSeek Harness with device-code OAuth, Codex CLI import, token refresh, and a web settings panel. |
...
| [dsh-prompt-stash](https://github.com/Wine-Red/dsh-prompt-stash) | 3 | ⚪ unknown | dsh-prompt-stash — DSH plugin (session) |
...
| [dsh-plugin-session-import](https://github.com/huguangyu666/dsh-plugin-session-import) | 4 | ⚪ unknown | DeepSeek Harness plugin: import claude-code / codex / reasonix / zcode sessions |
...
| [dsh-continual-evolve](https://github.com/ZK-Andy/dsh-continual-evolve) | 4 | ⚪ unknown | Continual self-evolution plugin for DeepSeek Harness: versioned, auditable, rollback-safe harness state refined from session traj… |
| [dsh-command-opt](https://github.com/csiroqa/dsh-command-opt) | 1 | ⚪ unknown | dsh-command-opt — DSH plugin (session) |
| [dsh-telemetry-redactor](https://github.com/030611/dsh-telemetry-redactor) | 3 | ⚪ unknown | Fail-closed export-copy redaction for DeepSeek Harness session telemetry |
...
| [dsh-latex-tools](https://github.com/liuup/dsh-latex-tools) | 3 | ⚪ unknown | ♾️ Copy and export the LaTeX in DeepSeek Harness 悬停任意 LaTeX 公式即可复制 TeX 源码或导出为独立的 SVG 文件 |
| [dsh-memory](https://github.com/Towzai/dsh-memory) | 1 | ⚪ unknown | Cross-session memory plugin for DeepSeek Harness (dsh): embedding search + automatic system-prompt injection |
...
| [dsh-token-panel](https://github.com/juhe291/dsh-token-panel) | 5 | ⚪ unknown | Real-time token consumption HUD plugin for DeepSeek Harness. Live token usage monitor, context pressure, cost estimation, history… |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 29 | ⚪ unknown | A DeepSeek Harness plugin for Context insight panel — a Context tab in the web UI showing what the model's context window is made… |
...
| [dsh-archived-sessions](https://github.com/Zephyr-vibe/dsh-archived-sessions) | 6 | ⚪ unknown | DSH Session Manager: manage conversations, archive/restore, delete safely, open record folders. |
...
| [dsh-billing](https://github.com/TheTianzz/dsh-billing) | 5 | ⚪ unknown | DeepSeek Harness plugin: 账户余额 + 会话费用（/balance /cost 命令、deepseek_billing 工具、Web UI 双胶囊），官方价格每 12 小时自动同步 |
...
| [dsh-usage-stats](https://github.com/lanlandeli/dsh-usage-stats) | 4 | ⚪ unknown | DeepSeek Harness 精美 Token 数据面板：趋势图、活跃热力图、模型用量分析与 CSV/JSON 导出。 |
| [dsh-balance-tide](https://github.com/huanyuLv/dsh-balance-tide) | 2 | ⚪ unknown | DeepSeek Harness (DSH) Web 插件: 余额 + 峰谷计价潮汐提示。显示 DeepSeek 账户余额与本会话花费, 并在余额前提示当前峰/谷价格档位、距切换倒计时与使用建议。 |
...
| [deepseek-harness-wallet](https://github.com/feibi-mochi/deepseek-harness-wallet) | 6 | ⚪ unknown | Balance monitoring, per-session spend & token tracking, low-balance alerts, and an official recharge shortcut for DeepSeek Harnes… |
...
| [dsh-usage-plugin](https://github.com/feiyang-dev/dsh-usage-plugin) | 3 | ⚪ unknown | DeepSeek Harness 用量与消耗插件（dsh-usage）—— 每次调用的 token 用量/缓存命中统计、峰谷计费、余额查询、CSV/JSON/PNG 导出，可经桌面端一键安装或命令行 dsh plugin add 安装。 |
...
| [dsh-noema](https://github.com/ZSeven-W/dsh-noema) | 3 | ⚪ unknown | Noema long-term memory plugin for DSH: durable, inspectable agent memory with recall tools and a settings page. |
| [dsh-memoir](https://github.com/Qinling-Melon-Farmers/dsh-memoir) | 3 | ⚪ unknown | DSH 项目持久化记忆插件（TypeScript）：会话归纳 + 经验教训沉淀，写入 PROJECT_MEMORY.md 与全局索引；每轮工作结束自动提醒蒸馏、自动注入未来 AGENTS；附 Web GUI 记忆面板（项目/全局 tab、检索、手动记录/删除… |
| [dsh-LorebookMD](https://github.com/609476965/dsh-LorebookMD) | 3 | ⚪ unknown | DSH lorebook-driven fiction writer plugin: import Tavern/SillyTavern character cards & world books, save local Markdown settings,… |
| [DSH-recall-plugin](https://github.com/limbo947/DSH-recall-plugin) | 3 | ⚪ unknown | DSH 消息撤回插件：回到发送该消息时的状态 |
...
| [dsh-mcp-lens](https://github.com/labmimors/dsh-mcp-lens) | 3 | ⚪ unknown | Shrink MCP context in DeepSeek Harness: 1,000 remote tools behind 2 exact-schema interfaces, with a measured V4 Flash cost pilot. |
...
| [dsh-voice](https://github.com/3274375092/dsh-voice) | 2 | ⚪ unknown | DeepSeek Harness 的语音输入插件:网页里点 🎤(或按Ctrl+空格)说话,识别文本作为普通消息提交进会话。纯输入,与 agent preset/人设完全解耦,任何模式下都只是"另一种输入法"。 |
...
| [dsh-vision](https://github.com/william-jin-cmu/dsh-vision) | 20 | ⚪ unknown | view_image tool bridging any OpenAI-compatible VLM |
| [modlens](https://github.com/liustack/modlens) | 1322 | ⚪ unknown | The first vision plugin for DeepSeek Harness — let text-only models see. |
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 841 | ⚪ unknown | Vision toolbox & skills for text-only models: multi-image QA, UI reconstruction, GUI automation. |
...
| [dsh-llm-codex-oauth](https://github.com/Player-MINEPIG/dsh-llm-codex-oauth) | 6 | ⚪ unknown | dsh-llm-codex-oauth — DSH plugin (llm) |
...
| [dsh-mac-vision](https://github.com/Kevoyuan/dsh-mac-vision) | 1 | ⚪ unknown | On-device macOS OCR and Apple Vision for DeepSeek Harness — one native plugin with a bundled Skill. |
...
| [dsh-cost](https://github.com/dongsheng123132/dsh-cost) | 3 | ⚪ unknown | Evidence-first token cost ledger and budget checks for DeepSeek Harness |
...
| [dsh-advisor](https://github.com/omdsh-dev/dsh-advisor) | 7 | ⚪ unknown | Advisor - Pair a second model that passively reviews each turn and injects notes. 搭配一个会在每轮对话被动注入见解和审查的副模型。 |
...
| [dsh-codex-subscription](https://github.com/yequ172672/dsh-codex-subscription) | 6 | ⚪ unknown | DSH 插件:直接复用 Codex CLI 本地登录订阅凭证,在 DeepSeek Harness 中使用 ChatGPT 订阅模型,无需 API Key | DSH plugin: reuse your Codex CLI local subscripti… |
| [dsh-vision](https://github.com/oil-oil/dsh-vision) | 24 | ⚪ unknown | Near-native image understanding for DeepSeek Harness |
...
| [dsh-minigames](https://github.com/omdsh-dev/dsh-minigames) | 2 | ⚪ unknown | DSH Web UI 右侧小游戏面板：18 款离线小游戏（恐龙跳一跳 / 俄罗斯方块 / 坦克大战 / 扫雷 / 2048 / 数独 / 吃豆人 / 跟枪练习等），可扩展游戏注册表，等待模型回复或修 bug 时的摸鱼神器 |
| [dsh-vision](https://github.com/237229953-create/dsh-vision) | 2 | ⚪ unknown | DSH plugin: text-only models (e.g. DeepSeek-V4) automatically see images via a vision model. Official surface-replace, cache-frie… |
...
| [dsh-gui-customization](https://github.com/LAN-TINA-WS/dsh-gui-customization) | 7 | ⚪ unknown | Nous Blue theme, ambient glow and background image customization for DeepSeek Harness Web UI. DSH 界面设定插件：Nous 蓝配色 / 氛围光 / 背景图（中英双… |
...
| [dsh-opencode-go-usage](https://github.com/Xenia0922/dsh-opencode-go-usage) | 4 | ⚪ unknown | DeepSeek Harness 插件:OpenCode Go 用量与花费悬浮仪表盘(配额、逐请求成本、模型/来源分布) |
...
| [TokenLedger](https://github.com/zh667/TokenLedger) | 2 | ⚪ unknown | Token usage accounting for DeepSeek Harness, reconciled against New API and Sub2API relay-site billing |
...
| [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) | 4 | ⚪ unknown | Unofficial DeepSeek Harness LLM provider plugin for Command Code: live model catalog, reasoning-effort support, Models-page card.… |
| [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) | 2 | ⚪ unknown | Use ChatGPT (Codex), Claude, and Grok (X Premium) subscriptions as DeepSeek Harness LLM providers — OAuth login in the web UI, no… |
...
| [dsh-usage-stats](https://github.com/Make0209/dsh-usage-stats) | 5 | ⚪ unknown | DeepSeek Harness 插件：GitHub 风格用量热力图 + Token / 缓存命中 / 账户余额看板 + 工作区别名管理。 |
...
| [deepseek-heartflow](https://github.com/yun520-1/deepseek-heartflow) | 3 | ⚪ unknown | HeartFlow (心虫) as a DSH plugin — AGI 第1层辨别门禁: heartflow_check tool + automatic output supervision |
...
| [exo](https://github.com/exoharness/exo) | 647 | ⚪ unknown | Fully recursive agent+harness that self-edits at runtime |
...
| [distill](https://github.com/LoserFox/distill) | 15 | ⚪ unknown | Auto conversation distillation: background subagent reflection |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 253 | ⚪ unknown | AgentTeams plugin |
| [dsh-automation](https://github.com/titanwings/dsh-automation) | 32 | ⚪ unknown | Run scheduled tasks in fresh sessions per plan |
...
| [dsh-work](https://github.com/vibeinging/dsh-work) | 26 | ⚪ unknown | Local-first AI workbench for DSH plugins |
| [dsh-advisor](https://github.com/btspoony/dsh-advisor) | 7 | ⚪ unknown | Second model passively reviews each turn and injects advice |
...
| [dsh-milestone](https://github.com/SnowCrescenter-tech/dsh-milestone) | 12 | ⚪ unknown | Git-style milestone timeline plugin. |
...
| [deepseek-harness-fnos](https://github.com/techysy/deepseek-harness-fnos) | 6 | ⚪ unknown | deepseek-harness-fnos — DSH plugin (orchestration) |
...
| [dsh-clawrouter](https://github.com/BlockRunAI/dsh-clawrouter) | 9 | ⚪ unknown | A second brain for your DeepSeek Harness agent — strong-model review before risky tool calls, plus 70 models from one wallet. |
...
| [dsh-wecom](https://github.com/TtTRz/dsh-wecom) | 3 | ⚪ unknown | WeCom AI Bot channel for DeepSeek Harness — every chat runs a persistent, preset-backed agent with real tools. |
...
| [dsh-phone](https://github.com/railgun0325/dsh-phone) | 6 | ⚪ unknown | 让 DeepSeek Harness 的 agent 跑在手机里，通过 Magisk root 原生操作安卓系统（截图/点击/滑动/开应用）+ 移动端布局 + WebView APK |
...
| [dsh-kun-like-pet](https://github.com/liyupi/dsh-kun-like-pet) | 15 | ⚪ unknown | Kun Like 桌宠 —— DeepSeek Harness 桌面宠物插件：右下角小坤宠随 Agent 工作状态切换 9 种动作，任务完成播放「你干嘛~哎哟」 |
| [dsh-file-review](https://github.com/left0ver/dsh-file-review) | 8 | ⚪ unknown | a dsh plugin - review files that an agent just changed,you can see the diff |
...
| [Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 2765 | ⚪ unknown | VibeSkills is a general-purpose Skill that automatically routes local Skills and intelligently orchestrates harness workflows. |
...
| [DeepSeekHarnessRemoteGateway](https://github.com/lbwnb666-ai/DeepSeekHarnessRemoteGateway) | 2 | ⚪ unknown | 一个轻量级 DeepSeek Harness 远程网关，让你通过 Web 或移动设备远程访问和控制本地 AI Agent |
...
| [dsh-gitbash-preset](https://github.com/liceses/dsh-gitbash-preset) | 3 | ⚪ unknown | DeepSeek Harness 插件：一键安装「极简模式 (Git Bash)」agent preset —— 把 DSH 自带极简模式中的 bash 调用映射到 Git for Windows 的 bash（MSYS），让 Windows 上的极简模式真… |
...
| [pi2dsh](https://github.com/weijiafu14/pi2dsh) | 7 | ⚪ unknown | Bridge the Pi and DeepSeek Harness ecosystems: one Pi Host ABI runs unmodified Pi extensions as native DSH plugins. 打通 Pi 与 DSH 生… |
...
| [dsh-easyssh](https://github.com/chenw2759-wq/dsh-easyssh) | 5 | ⚪ unknown | 用于远程ssh快速相应，同时可以直接在前端操作/查看远程服务器上的信息与代码。 |
...
| [dsh-remote](https://github.com/flymysql/dsh-remote) | 9 | ⚪ unknown | Remote-access assistant for DeepSeek Harness: /remote command and settings page printing the exact SSH tunnel / reverse-tunnel /… |
| [dsh-web-billing](https://github.com/bpc-oss/dsh-web-billing) | 4 | ⚪ unknown | RMB/USD token-billing plugin for DeepSeek Harness (dsh web): official-policy auto pricing with peak/off-peak hours, per-message l… |
| [dsh-spend](https://github.com/nonewind/dsh-spend) | 3 | ⚪ unknown | Token usage & cost monitor for DeepSeek Harness — floating widget with multi-dimensional stats, time-series charts, auto-detected… |
...
| [deepseek-harness-mobile](https://github.com/sorsama/deepseek-harness-mobile) | 1 | ⚪ unknown | Android companion for DeepSeek Harness | chat, goals, approvals & notifications from your phone, over your LAN. Kotlin + Jetpack… |
...
| [dsh-balance](https://github.com/crazywoola/dsh-balance) | 10 | ⚪ unknown | DeepSeek Harness balance plugin for the Settings page |
...
| [dsh-IDE](https://github.com/chenw2759-wq/dsh-IDE) | 5 | ⚪ unknown | 这是一个ssh前端程序，可以让UI体现类似lab的功能！用于远程ssh快速相应，同时可以直接在前端操作/查看远程服务器上的信息与代码。 |
...
| [dsh-galgame](https://github.com/Lanxing6480/dsh-galgame) | 3 | ⚪ unknown | 我要成为Galgame高手！！将你的Vibe coding界面修改成为Galgame的样子，在不影响工作的情况下和赏心悦目的DeepSeek娘进行友好互动 |
...
| [dsh-balance-plugin](https://github.com/Francis-Xavier-code/dsh-balance-plugin) | 3 | ⚪ unknown | deepSeek 余额监控与用量统计（DSH 动态 Cordis 插件）：余额监控 · 官方充值入口 · 用量统计 · 三方插件管理 |
| [dsh-web-lan-access](https://github.com/AcidGr/dsh-web-lan-access) | 2 | ⚪ unknown | DeepSeek Harness (dsh) Web plugin |
| [hesi-dsh-plugins](https://github.com/qiuqiukof-oss/hesi-dsh-plugins) | 2 | ⚪ unknown | DeepSeek Harness (DSH) 插件 —— 圆桌讨论（Roundtable）与 一键执行流（Plan） Hesi 出品 · 同源实现 |
...
| [awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) | 842 | ⚪ unknown | DSH plugin directory with daily compatibility tracking |
...
| [awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 404 | ⚪ unknown | DSH ecosystem curation: plugins, tools, infra |
| [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 135 | ⚪ unknown | DeepSeek Harness terminal UI |
| [agent-skills](https://github.com/GitHubxsy/agent-skills) | 20 | ⚪ unknown | Reusable skills for AI coding agents |
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 139 | ⚪ unknown | Codex-style @file mentions for DeepSeek Harness: search workspace files in the composer and attach their contents to prompts. |
...
| [dsh-notification](https://github.com/omdsh-dev/dsh-notification) | 40 | ⚪ unknown | Desktop notifications for DeepSeek Harness turn completions, with per-outcome controls and include/exclude keyword rules. |
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 341 | ⚪ unknown | 2005-style sidebar ads plugin (parody) |
...
| [oh-dsh-desktop](https://github.com/hust-open-atom-club/oh-dsh-desktop) | 167 | ⚪ unknown | Extensible macOS DSH workbench with native PTY |
| [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) | 85 | ⚪ unknown | In-chat generative UI: interactive HTML cards |
| [awesome-DSH-plugin](https://github.com/Alex-Yanggg/awesome-DSH-plugin) | 53 | ⚪ unknown | Curated list of DSH plugins, extensions and tools |
...
| [dsh-emoji](https://github.com/hellodigua/dsh-emoji) | 13 | ⚪ unknown | Auto-add emoji to AI replies |
...
| [awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 101 | ⚪ unknown | Bilingual complete list of the DSH plugin ecosystem |
| [dsh-launcher](https://github.com/Ruler4396/dsh-launcher) | 78 | ⚪ unknown | WebView2-based DSH launcher |
| [dsh-minigames](https://github.com/lhh010/dsh-minigames) | 13 | ⚪ unknown | Side game panel (18 offline mini-games) |
| [dsh-stickers](https://github.com/william-jin-cmu/dsh-stickers) | 12 | ⚪ unknown | Bidirectional sticker reactions |
...
| [plugin-registry](https://github.com/vlln/plugin-registry) | 36 | ⚪ unknown | DSH plugin registry infra: browser panel for official repository plugins |
| [create-dsh-plugin](https://github.com/whyihaveyou/dsh-suite) | 3 | 🟢 ok | Scaffold a DeepSeek Harness (DSH) plugin in seconds — tool / events / webui templates, next-tag version pinning, and a built-in -… |
...
| [dsh-notification-center](https://github.com/610la/dsh-notification-center) | 5 | ⚪ unknown | DSH 通知中心插件：对话/任务完成、报错、等待批准等事件触发浏览器通知 + 21 种匹配音效 |
...
> 1232 entries total, grouped by category, sorted by ⭐ within each. Schema dictionary: [docs/catalog-schema.md](docs/catalog-schema.md).
<!-- CATALOG:END -->
