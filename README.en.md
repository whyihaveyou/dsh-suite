...
![Plugins](https://img.shields.io/badge/plugins-1897-facc15?style=flat-square)
...
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 7512 | 🟢 ok | DSH Web UI plugin & skin collection: task board, git panel, etc. |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3567 | 🟢 ok | Sidebar workbench: file render/terminal/git/subagent |
...
| [MuseAI](https://github.com/yejiming/MuseAI) | 644 | ⚪ unknown | 创建你的 AI 角色，进入你的故事世界。和角色聊天、冒险、穿书，让每一次互动都留下羁绊（支持 DeepSeek Harness 插件，欢迎使用） |
...
| [dsh-agy](https://github.com/chaos-03x/dsh-agy) | 37 | 🟢 ok | Google Antigravity (agy) OAuth auth + model access plugin for DeepSeek Harness: multi-account pool, 429 rotation, device fingerpr… |
...
| [dsh-free-search](https://github.com/DDDMUC/dsh-free-search) | 172 | 🟢 ok | Free web search provider for DeepSeek Harness - DuckDuckGo backend, no API key needed |
...
| [dsh-redteam-model](https://github.com/SeaOf0/dsh-redteam-model) | 427 | 🟢 ok | 基于dsh web实现的多种模式，目的是服务于redteam进行授权的安全研究，覆盖渗透测试、红队评估、代码审计等范围领域，请勿用于非法行为。（允许二开，赋予模块各位自己的业务逻辑，不定期完善逻辑与修复bug） |
...
| [dsh-infinite-gen-2](https://github.com/Minglink/dsh-infinite-gen-2) | 1419 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DeepSeek 专用破甲插件「无限二代」dsh-infinite-gen-2 — armor-breaking plugin for DeepSeek稳定化破甲提示词，求 Star 收藏 ⭐ |
...
| [dsh-infinite-gen-3](https://github.com/Minglink/dsh-infinite-gen-3) | 1419 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DeepSeek 专用破甲插件「无限三代」dsh-infinite-gen-3 — armor-breaking plugin for DeepSeek，破甲版：稳定化破甲，求 Star 收藏 ⭐ |
...
| [dsh-plugin-shop](https://github.com/LivXue/dsh-plugin-shop) | 721 | 🟢 ok | The most comprehensive DeepSeek Harness plugin market — refreshed daily, sourced across the Internet, reviewed before publishing. |
...
| [dsh-council](https://github.com/a1exsun/dsh-council) | 72 | ⚪ unknown | Multi-model council for DeepSeek Harness: independent answers, anonymous peer reviews, and an inspectable final decision. |
...
| [dsh-fylar-office-editor](https://github.com/FylarOpen/dsh-fylar-office-editor) | 34 | ⚪ unknown | Office document preview, editing, and DOCX generation for DeepSeek Harness, powered by Fylar Office SDK. |
| [dsh-defend](https://github.com/PerryLink/dsh-defend) | 13 | 🟢 ok | Prompt-injection, jailbreak, and secret-leak defense for DeepSeek Harness: Aho-Corasick detection with allow/ask/block intercepti… |
...
| [dsh-local-ai](https://github.com/PerryLink/dsh-local-ai) | 12 | ⚪ unknown | Local-model (Ollama) integration for DeepSeek Harness: discover, pull, remove, and inspect local models, route requests to them b… |
...
| [dsh-skills-manager](https://github.com/MichengAI/dsh-skills-manager) | 50 | 🟢 ok | DSH Skills Manager 基于 DeepSeek Harness 的Skills管理插件 |
...
| [dsh-skin](https://github.com/KinGao294/dsh-skin) | 18 | 🟢 ok | Skin switcher + custom wallpaper for DeepSeek Harness (dsh): curated --dsw-alias-* palettes, translucent wallpaper with opacity/b… |
...
| [Catppuccin-dsh-theme](https://github.com/zhijun-dai/Catppuccin-dsh-theme) | 9 | ⚪ unknown | Soothing pastel theme for DeepSeek Harness |
...
| [dsh-update-checker](https://github.com/Airmetro/dsh-update-checker) | 18 | 🟢 ok | DeepSeek Harness (DSH) 更新检测插件：自动检查 npm 最新版并在 GUI 顶部横幅提示，支持中英文跟随系统语言、一键安装更新并重启服务。Auto update checker for DeepSeek Harness with loc… |
...
| [voyager](https://github.com/Nagi-ovo/voyager) | 20053 | ⚪ unknown | Enhancement suite for Gemini, AI Studio, Claude & ChatGPT — plus a prompt manager for any web UI, DeepSeek Harness included. / 面向… |
...
| [dsh-client-ui-custom](https://github.com/yoli-mi/dsh-client-ui-custom) | 34 | ⚪ unknown | Configurable DSH web-surface plugin: wallpaper & frosted-glass themes, accent colors, custom keyboard shortcuts, app-usage panel,… |
...
| [DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 2296 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接喊来你的dsh安装 |
...
| [dsh-infinite-gen-4](https://github.com/Minglink/dsh-infinite-gen-4) | 1419 | 🟢 ok | DeepSeek v4.1 flash 网络安全红队工具（无限四代） — jailbreak prompts and test suite for DeepSeek 求 Star 收藏 ⭐ |
...
| [DSHBox](https://github.com/WSK-build/DSHBox) | 13 | ⚪ unknown | DSHBox — Run DeepSeek Harness locally on Android phones and tablets. One APK with Debian, Node.js, DSH, and WebView — no root or… |
...
| [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) | 168 | 🟢 ok | Second-model AI auto-review for DeepSeek Harness approval requests: a read-only reviewer subagent returns structured allow/deny v… |
...
| [MemOS](https://github.com/MemTensor/MemOS) | 11308 | ⚪ unknown | Self-evolving memory OS for LLM & AI Agents: ultra-persistent memory, hybrid-retrieval, and cross-task skill reuse, with 35.24% t… |
...
| [dsh-adult-tension](https://github.com/daha1216/dsh-adult-tension) | 34 | ⚪ unknown | DeepSeek Harness 成年人(18+/adult)互动叙事 Skill：NPC 活人感（有记忆/立场/底线）、自带破甲、数百项素材库、随机开局可预锁、时间推进、全维 YAML 存档。 |
...
| [dsh-meow-cachebilling](https://github.com/Phant0Meow/dsh-meow-cachebilling) | 23 | ⚪ unknown | 一个能帮你省钱的插件！缓存其实比你想象的贵！换窗口可以省缓存钱，但换窗口有顾虑，或许你懒得重新描述项目和规则，或者你还需要那个上下文。所以这个插件，就是为了告诉你，当前轮，纯粹上下文缓存的部分，到底花了你多少钱。这样你才心里有个底，判断什么时候该换窗口。 在… |
...
| [dsh-nexttavern](https://github.com/a86582751/dsh-nexttavern) | 17 | ⚪ unknown | 原生 Agent 驱动的长篇角色扮演：交互式创作、主动世界书、动态记忆、多角色推演与小说导出。创作一个世界，走进它，再把它带走。 |
...
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 1199 | ⚪ unknown | Vision toolbox & skills for text-only models: multi-image QA, UI reconstruction, GUI automation. |
...
| [dsh-gui-customization](https://github.com/LAN-TINA-WS/dsh-gui-customization) | 16 | 🟢 ok | Nous Blue theme, ambient glow and background image customization for DeepSeek Harness Web UI. DSH 界面设定插件：Nous 蓝配色 / 氛围光 / 背景图（中英双… |
...
| [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) | 231 | 🟢 ok | Unofficial DeepSeek Harness LLM provider plugin for Command Code: live model catalog, reasoning-effort support, Models-page card.… |
...
| [opencues](https://github.com/opencues/opencues) | 48 | ⚪ unknown | Turn any text field into a two-way LLM channel: it reads what you write and fills what you ask. Flags a slip as you type, answers… |
...
| [dsh-purge](https://github.com/YuJunZhiXue/dsh-purge) | 773 | 🟢 ok | DeepSeek Harness 破甲：让所有模型都能破甲，不同模型可换不同提示词；默认提示词面向国模「小码酱」。Jailbreak for every model — swap prompts per model. 求 Star 收藏 ⭐ |
...
| [ccteam](https://github.com/firstintent/ccteam) | 529 | ⚪ unknown | Orchestrates Claude Code/Codex/Grok/Kimi into one team |
...
| [Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 3280 | ⚪ unknown | VibeSkills is a general-purpose Skill that automatically routes local Skills and intelligently orchestrates harness workflows. |
...
| [dsh-Mimir-Academic-research](https://github.com/1692775560/dsh-Mimir-Academic-research) | 366 | ⚪ unknown | Mimir — 一站式科研工作台插件：LaTeX 论文边写边编译、arXiv 文献管理、实验追踪、指标图表、GPU 服务器 SSH 任务编排，管理科研全周期。An open-source research workbench plugin for the w… |
...
| [loopx](https://github.com/huangruiteng/loopx) | 5834 | ⚪ unknown | Long-horizon agent control plane for durable, governed work across Codex, Claude Code, and other harnesses. |
...
| [pi-web-ui](https://github.com/xing-shuyin/pi-web-ui) | 160 | ⚪ unknown | dsh / pi-agent web ui |
...
| [dsh-hub-cli](https://github.com/pax-beehive/dsh-hub-cli) | 305 | ⚪ unknown | Open-source CLI, schemas, resolver, and DSH agent tools for DSH Plugin Hub |
...
| [dsh-antibrow](https://github.com/antibrow/dsh-antibrow) | 225 | 🟢 ok | DeepSeek Harness plugin: give your agent a browser with a persistent identity - engine-level fingerprint spoofing, unlimited free… |
...
| [DSHana](https://github.com/Nyasers/DSHana) | 48 | ⚪ unknown | DSHana: DeepSeek Harness as a subagent for HanaAgent |
| [d.sh](https://github.com/SiriusNEO/d.sh) | 13 | ⚪ unknown | Minimal agent harness in one Bash file. One-line quick start. Bootloader agent for bare-metal servers. |
...
| [dsh-pocket](https://github.com/shaobeichen/dsh-pocket) | 1108 | 🟢 ok | 把 DeepSeek Harness 装进你的口袋：电脑上跑 dsh web，手机扫码即同步访问（局域网 + 公网，实时同屏） |
...
| [dsh-mobile](https://github.com/saya-ch/dsh-mobile) | 263 | 🟢 ok | DeepSeek Harness 移动端适配与安全局域网访问插件，支持 Android App 和手机浏览器。 |
...
| [ds-harness-remote](https://github.com/liguobao/ds-harness-remote) | 189 | 🟢 ok | 一个基于 DeepSeek Harness 插件机制构建的多端远程访问方案，通过安全、低延迟、端到端加密的 P2P 优先网络，支持从 PC、Android 和 Web 随时访问并操作远程 Harness。 (A multi-device remote acc… |
| [dsh-remote](https://github.com/SCSpotato/dsh-remote) | 95 | 🟢 ok | Native Android client to remotely control DeepSeek Harness (DSH) from your phone |
...
| [dsh-acp-interactive](https://github.com/ClickPM/dsh-acp-interactive) | 33 | ⚪ unknown | Editor-facing ACP server for Zed and other ACP clients, composed from published DeepSeek Harness plugins. Community-maintained; n… |
...
| [awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 1055 | ⚪ unknown | DSH ecosystem curation: plugins, tools, infra |
...
| [dsh-plugin-mobile-gateway](https://github.com/Clarklevis1995/dsh-plugin-mobile-gateway) | 23 | 🟢 ok | 以websocket为通信方式的dsh网关插件，支持在同一网域内移动端的接入，实现移动端的dsh app |
...
> 1897 entries total, grouped by category, sorted by ⭐ within each. Schema dictionary: [docs/catalog-schema.md](docs/catalog-schema.md).
<!-- CATALOG:END -->
