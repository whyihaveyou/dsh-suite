...
![Plugins](https://img.shields.io/badge/plugins-1821-facc15?style=flat-square)
...
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 6767 | 🟢 ok | DSH Web UI plugin & skin collection: task board, git panel, etc. |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3281 | 🟢 ok | Sidebar workbench: file render/terminal/git/subagent |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1899 | ⚪ unknown | DSH Web whale-girl skin series |
...
| [dsh-openbiliclaw](https://github.com/whiteguo233/dsh-openbiliclaw) | 55 | ⚪ unknown | OpenBiliClaw content-agent bridge for DSH |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 317 | 🟢 ok | Mnemon three-layer memory deep integration |
...
| [dsh-scholar](https://github.com/lzszq/dsh-scholar) | 32 | 🟢 ok | dsh-scholar (literature) |
...
| [ego-browser](https://github.com/Fisfzy/ego-browser) | 85 | ⚪ unknown | Bridge ego-lite Chromium browser into DSH |
...
| [modsearch](https://github.com/liustack/modsearch) | 344 | ⚪ unknown | Web search plugin for DeepSeek Harness. |
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 561 | 🟢 ok | Chrome sidebar extension letting DSH drive the browser. |
...
| [dsh-expression](https://github.com/yyh-001/dsh-expression) | 72 | 🟢 ok | dsh-expression — DSH plugin (tools) |
...
| [dsh-plugin-template](https://github.com/bugmaker2/dsh-plugin-template) | 102 | ⚪ unknown | Template for deepseek-harness plugin development. |
...
| [dsh-codex-connect](https://github.com/franksong2702/dsh-codex-connect) | 76 | 🟢 ok | ChatGPT OAuth and Codex models for DeepSeek Harness. |
...
| [dsh-passwords](https://github.com/slywalker2006/dsh-passwords) | 43 | ⚪ unknown | Turns DeepSeek Harness into a server-grade multi-tenant platform: remote access + auto HTTPS, subuser permissions & token/daily q… |
...
| [anysearch-dsh](https://github.com/anysearch-team/anysearch-dsh) | 396 | 🟢 ok | AnySearch web search provider and advanced search tools for DeepSeek Harness (DSH) |
...
| [dsh-pet](https://github.com/PC2005-cloud/dsh-pet) | 526 | 🟢 ok | DeepSeek Harness 桌面宠物插件 + 完整素材生成链：AI 提示词 → 绿幕视频 → 透明动画 → 可安装插件，从零到宠物全流程可复现 |
...
| [dsh-free-search](https://github.com/DDDMUC/dsh-free-search) | 117 | ⚪ unknown | Free web search provider for DeepSeek Harness - DuckDuckGo backend, no API key needed |
...
| [DSH-Think-zh](https://github.com/Len7183/DSH-Think-zh) | 16 | ⚪ unknown | DeepSeek Harness 默认的思考语言为英文，这不利于中文使用者阅读推理过程与复核结论。本插件通过在每次请求的 system prompt 中注入一条精简的强制语言指令，使: 思考过程强制简体中文，无论用户用什么语言提问。 |
...
| [dsh-pentest](https://github.com/howmp/dsh-pentest) | 362 | 🟢 ok | 面向 DeepSeek Harness（dsh）的渗透测试模式 @CloverSecLabs |
...
| [amadeus-for-dsh](https://github.com/yyxcnasd/amadeus-for-dsh) | 22 | ⚪ unknown | Amadeus (AI assistant from Steins;Gate 0) for DeepSeek Harness |
...
| [dsh-wallpaper-engine](https://github.com/elysia395/dsh-wallpaper-engine) | 231 | 🔴 broken (failed once, retried — install blocked by pnpm build-script policy (allowBuilds) — plugin likely OK, CI policy blocks git prepare scripts) | 一个插件让你的dsh可以自由切换你的wallpaper engine里面的壁纸资源，还可以通过多个滑动条来控制透壁纸的模糊程度，亮度，边框，以及对话框的液态玻璃效果，让你的dsh更加美观 |
| [deepseek-harness-sdr-plugin](https://github.com/Xuxchloris/deepseek-harness-sdr-plugin) | 26 | ⚪ unknown | DeepSeek Harness 的 SDR 数字员工插件：九阶段外贸获客 SOP、结构性人工审批、客户去重、持久化知识检索与审计日志，默认 dry-run 安全演示。 |
| [dsh-plugin-gather](https://github.com/lilwhich/dsh-plugin-gather) | 10 | ⚪ unknown | for better dsh |
| [dsh-meme](https://github.com/yyh-001/dsh-meme) | 72 | ⚪ unknown | DeepSeek Harness 的表情包插件——找得到、发得出、学得会 |
...
| [dsh-univer-office](https://github.com/dream-num/dsh-univer-office) | 255 | 🟢 ok | Preview Univer sheets, docs & slides inside DeepSeek Harness. |
...
| [dsh-omi-voice](https://github.com/PolinniZhong/dsh-omi-voice) | 75 | ⚪ unknown | DeepSeek Harness 语音朗读插件：沉浸式听朗读，用豆包 TTS 自然音色读 AI 回复（BYOK · 点读/暂停/继续） |
...
| [dsh-redteam-model](https://github.com/SeaOf0/dsh-redteam-model) | 182 | ⚪ unknown | 基于dsh web实现的多种模式，目的是服务于redteam进行授权的安全研究，覆盖渗透测试、红队评估、代码审计等范围领域，请勿用于非法行为。（允许二开，赋予模块各位自己的业务逻辑，不定期完善逻辑与修复bug） |
...
| [dsh-ears](https://github.com/WizisCool/dsh-ears) | 15 | 🟢 ok | Voice input plugin for DeepSeek Harness (dsh): Supports voice input plugins with polishing and multiple backends. |
...
| [dsh-personal-center](https://github.com/PolinniZhong/dsh-personal-center) | 37 | ⚪ unknown | DeepSeek Harness 个人中心:用量统计 / 自定义指令 / 成本估算 / 桌面宠物(纯本地，不联网）。 Personal center & custom instructions for DSH |
...
| [dsh-secure-audit](https://github.com/PensiveFei/dsh-secure-audit) | 86 | ⚪ unknown | Read-only security & compliance plugin for DeepSeek Harness: prompt-injection detection, Chinese-PII redaction, and local configu… |
| [Invoice-Downloader](https://github.com/EthanYoQ/Invoice-Downloader) | 368 | ⚪ unknown | 电子发票整理与报销准备工具：从邮箱批量收集 PDF/OFD/XML 发票，OCR 识别、分类归档并生成 Excel 汇总；提供 Windows/macOS 桌面版与 DSH 插件。 |
...
| [dsh-preset-plus](https://github.com/Rain-kl/dsh-preset-plus) | 75 | ⚪ unknown | DSH 预设增强插件, 参考 SillyTavern 预设模功能开发的一个基础的预设编辑器。 |
...
| [dsh-automation](https://github.com/MichengAI/dsh-automation) | 14 | 🟢 ok | DSH Automation 基于 DeepSeek Harness 的定时任务、自动化任务插件 |
| [dsh-infinite-gen-2](https://github.com/Minglink/dsh-infinite-gen-2) | 890 | ⚪ unknown | DeepSeek 专用破甲插件「无限二代」dsh-infinite-gen-2 — armor-breaking plugin for DeepSeek稳定化破甲提示词，求 Star 收藏 ⭐ |
...
| [DSH-Creator](https://github.com/Jackywxsz/DSH-Creator) | 82 | ⚪ unknown | Jacky Creator：面向内容创作者的 DeepSeek Harness 本地内容与运营工作台 |
| [dsh-fund-research](https://github.com/PerryLink/dsh-fund-research) | 19 | 🟢 ok | DeepSeek Harness plugin: deterministic research reports for Chinese public mutual funds |
| [dsh-yolo](https://github.com/hanshanyike/dsh-yolo) | 42 | ⚪ unknown | 把对话里说过的重要事情，变成持续可跟进的计划。 为 deepseek-harness 打造的个人助手：从对话中整理事项、跟踪变化，并在需要时提醒你。 |
...
| [dsh-infinite-gen-3](https://github.com/Minglink/dsh-infinite-gen-3) | 890 | ⚪ unknown | DeepSeek 专用破甲插件「无限三代」dsh-infinite-gen-3 — armor-breaking plugin for DeepSeek，破甲版：稳定化破甲，求 Star 收藏 ⭐ |
...
| [@xxxyz/dsh-mcp-manager](https://github.com/xxxyz/DeepSeekHarness-MCP-Manager) | 10 | ⚪ unknown (作者自报实测通过（Windows + npx 通道，2026-08-27）) | Dual manager for DSH — MCP servers (add/edit/enable/disable/restart/delete from Settings UI, JSON import/export, four mcp_manager… |
...
| [dsh-design-skills](https://github.com/zhaiyateng/dsh-design-skills) | 21 | ⚪ unknown | Design aesthetics skill pack for DeepSeek Harness (DSH) - keeps vibe-coded websites away from the AI look. 6 styles: dark-saas, a… |
...
| [new-litigation-visualization](https://github.com/MiaoQichuan/new-litigation-visualization) | 51 | ⚪ unknown | 把法律画出来 · Make the Law Visible —— 给法律人的诉讼可视化工具集：把凌乱的诉讼图重画成能进材料的图，或直接读案件材料画准一张时间轴。Claude Skill / DeepSeek Harness 通用。 |
| [oh-story-dsh](https://github.com/worldwonderer/oh-story-dsh) | 269 | ⚪ unknown | A DSH plugin for novel writing and short-drama production, powered by Oh Story and Drama Skills. |
...
| [dsh-run2skill](https://github.com/qkycir-123/dsh-run2skill) | 60 | ⚪ unknown | DSH-native, local-first Run-to-Skill plugin for DeepSeek Harness |
| [dsh-mattpocock-skills-deck](https://github.com/FeatherHunter/dsh-mattpocock-skills-deck) | 42 | ⚪ unknown | 拨开迷雾看见终点，剩下的交给任务栏。Part the fog, see the end — the task bar handles the rest. 🎮 mattpocock/skills 的 DSH 游戏任务系统：map 拨迷雾，任务栏推进一步。A… |
| [oh-story-dsh](https://github.com/zenstory-ai/oh-story-dsh) | 269 | ⚪ unknown | A DSH plugin for novel writing and short-drama production, powered by Oh Story and Drama Skills. |
...
| [dsh-plugin-capabilities](https://github.com/qinyre/dsh-plugin-capabilities) | 11 | 🟢 ok | 在 dsh 设置页管理技能与 MCP 服务器，支持从 Claude Code、Codex 导入。 |
...
| [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) | 108 | 🟢 ok | Selection annotation: select→annotate→send |
...
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 393 | 🟢 ok | Inline interactive UI components in chat |
...
| [dsh-web-ui-notify](https://github.com/bill9109/dsh-web-ui-notify) | 24 | ⚪ unknown | Desktop notifications for DSH |
| [ex-setting](https://github.com/omdsh-dev/ex-setting) | 2 | ⚪ unknown | DSH settings extension |
| [whale-girl](https://github.com/vlln/whale-girl) | 307 | 🟢 ok | QQ-pet-style desktop pet plugin |
...
| [dsh-auto-continue](https://github.com/HsiangNianian/dsh-auto-continue) | 61 | ⚪ unknown | DSH Web UI plugin: automatically sends "继续" (continue) when a request is interrupted by network errors or other non-human causes |
...
| [dsh-doublecheck](https://github.com/PerryLink/dsh-doublecheck) | 13 | 🟢 ok | Double-check before you ship: grill the requirements, test the implementation, prove the delivery. An engineering-discipline bund… |
...
| [dsh-vault](https://github.com/Ox0400/dsh-vault) | 7 | 🟢 ok | Encrypted credential vault for DeepSeek Harness — AES-256-GCM + TOTP, model tools + Settings UI |
...
| [dsh-undo-plugin](https://github.com/lire1131/dsh-undo-plugin) | 142 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DSH plugin: snapshot & rollback your plugin/skin/settings configs. Auto-save on change, undo/redo stack, snapshot manager panel,… |
| [plugin-manager](https://github.com/whyihaveyou/dsh-suite) | 7 | 🟢 ok | In-app plugin store for DSH Web UI: browse the dsh-suite catalog, search/filter/sort, compat badges, one-click install — a Store… |
...
| [dsh-catppuccin](https://github.com/NoNameLeGo/dsh-catppuccin) | 28 | 🟢 ok | DeepSeek Harness Web GUI 的 Catppuccin 主题插件：Latte / Frappé / Macchiato / Mocha 四种风味一键切换 |
...
| [dsh-dream-skin](https://github.com/RevolutionLA/dsh-dream-skin) | 138 | 🟢 ok | DeepSeek Harness 换肤 / 壁纸 / 主题包插件 (dsh-plugin) — 8 套 Mirage 主题、每用户强调色、壁纸2.0、主题包导入导出/分享链接、收藏与随机，纯原生 token 系统实现。 |
...
| [voyager](https://github.com/Nagi-ovo/voyager) | 19930 | ⚪ unknown | Enhancement suite for Gemini, AI Studio, Claude & ChatGPT — plus a prompt manager for any web UI, DeepSeek Harness included. / 面向… |
| [dsh-im](https://github.com/xmanrui/dsh-im) | 1083 | 🟢 ok | 通过扫码把IM机器人接入DeepSeek Harness（支持飞书、微信、钉钉、QQ、企业微信等） |
...
| [dsh-catppuccin-theme](https://github.com/NoNameLeGo/dsh-catppuccin-theme) | 28 | ⚪ unknown | DeepSeek Harness Web GUI 的 Catppuccin 主题插件：Latte / Frappé / Macchiato / Mocha 四种主题一键切换，内置可开关的玻璃质感（Glassmorphism） |
...
| [dsh-client-ui-skin-denia](https://github.com/Ewnscat-ya/dsh-client-ui-skin-denia) | 33 | ⚪ unknown | DeepSeek Harness Web GUI 皮肤 · 鸣潮·达妮娅(Denia)主题「虚无之泡」。双形态亮/暗、侧边立绘、可修改的玻璃卡片、浮动泡泡粒子、锁链边框。 |
...
| [DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 1649 | ⚪ unknown | DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接喊来你的dsh安装 |
| [dsh-opencode-palette](https://github.com/FeatherHunter/dsh-opencode-palette) | 18 | ⚪ unknown | 看腻了 DSH 默认皮肤？34 款 opencode 经典配色一键换上——tokyonight、dracula、gruvbox、matrix、rose-pine……即点即换，重启不丢。34 opencode themes for DeepSeek Harne… |
...
| [dsh-kimino-theme](https://github.com/niiang/dsh-kimino-theme) | 29 | ⚪ unknown | Kimi no Na wa (Your Name) theme for DeepSeek Harness Web GUI |
...
| [dsh-vscode](https://github.com/Fengze233/dsh-vscode) | 25 | ⚪ unknown | 在 VS Code 侧边栏内嵌使用 DeepSeek Harness（DSH）网页界面的插件 |
| [dsh-prompt-optimize](https://github.com/1847123733/dsh-prompt-optimize) | 6 | ⚪ unknown | DSH Web plugin: web ui |
| [dsh-undo-savepoint](https://github.com/lire1131/dsh-undo-savepoint) | 142 | ⚪ unknown | DSH crash-rescue plugin: undo config & plugin-code changes, secret-safe snapshots, one-click SAFE MODE, plus offline CLI/GUI that… |
...
| [dsh-knowledge](https://github.com/Soren-ABT/dsh-knowledge) | 24 | ⚪ unknown | Knowledge base & RAG plugin for DeepSeek Harness (DSH): chunking, local embeddings, hybrid search, management panel |
...
| [dsh-agy-link](https://github.com/amlyczz/dsh-agy-link) | 36 | 🟢 ok | Google Antigravity (agy CLI) models for DeepSeek Harness — streaming chat, thinking, tool activity, usage, in-GUI Google OAuth lo… |
...
| [dsh-android](https://github.com/ZSeven-W/dsh-android) | 132 | ⚪ unknown | DeepSeek Harness plugin for Android — build, run, and interact with a live emulator or USB device stream inside a conversation, d… |
...
| [dsh-history-tree](https://github.com/z953218350/dsh-history-tree) | 16 | ⚪ unknown | Codex-style conversation turn timeline and hover history overview for DSH Web UI |
...
| [dsh-comfyui](https://github.com/fandc520/dsh-comfyui) | 41 | 🟢 ok | 一个基于DeepSeek-Harness的ComfyUI插件 |
...
| [dsh-filesnap](https://github.com/extracurricular-ai/dsh-filesnap) | 40 | 🟢 ok | dsh-filesnap — 把对话和它改过的文件一起回退到某一轮之前,不需要 git 仓库. A blazing-fast rewind and redo plugin for DeepSeek Harness, powered by a 🦀 Rust… |
...
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 271 | 🟢 ok | Cross-session long-term memory + background self-evolution |
...
| [billion-context-dsh](https://github.com/Tyan66666/billion-context-dsh) | 71 | 🟢 ok | Model-driven context management (Active Context Pruning / ACP) for the DeepSeek Harness — the model decides when and what to comp… |
...
| [dsh-memento](https://github.com/PerryLink/dsh-memento) | 86 | 🟢 ok | Bounded, layered, approval-gated, auditable cross-session memory for DeepSeek Harness (capability seam: ctx.memory + SQLite provi… |
...
| [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) | 249 | 🟢 ok | dsh-cost-meter — DSH plugin (session) |
...
| [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) | 130 | 🟢 ok | Second-model AI auto-review for DeepSeek Harness approval requests: a read-only reviewer subagent returns structured allow/deny v… |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 1255 | 🟢 ok | A DeepSeek Harness plugin for Context insight panel — a Context tab in the web UI showing what the model's context window is made… |
...
| [dsh-memory](https://github.com/FuRongJun-1999/dsh-memory) | 105 | 🟢 ok | Multi-agent spatiotemporal memory graph for DeepSeek Harness.Cross-session persistence, knowledge flywheel, importance-gated memo… |
...
| [dsh-mcp-lens](https://github.com/labmimors/dsh-mcp-lens) | 6 | 🟢 ok | Shrink MCP context in DeepSeek Harness: 1,000 remote tools behind 2 exact-schema interfaces, with a measured V4 Flash cost pilot. |
...
| [dsh-apex-standard](https://github.com/rinDBeans/dsh-apex-standard) | 11 | ⚪ unknown | DeepSeek V4 Pro/Flash unified anchored agent preset for DeepSeek Harness (official API & opencode-go): two-stage RL-aligned boots… |
...
| [dsh-miraculous-standard](https://github.com/rinDBeans/dsh-miraculous-standard) | 11 | ⚪ unknown | DeepSeek V4 Pro/Flash unified anchored agent preset for DeepSeek Harness (official API & opencode-go): two-stage RL-aligned boots… |
...
| [MemOS](https://github.com/MemTensor/MemOS) | 11165 | ⚪ unknown | Self-evolving memory OS for LLM & AI Agents: ultra-persistent memory, hybrid-retrieval, and cross-task skill reuse, with 35.24% t… |
...
| [dsh-trace-compare](https://github.com/lamost423/dsh-trace-compare) | 62 | 🟢 ok | Trace Compare & Live Maze for DeepSeek Harness: visualize agent exploration (main path, detours, backtracks) from session logs or… |
...
| [dsh-config-manager](https://github.com/xiajiajun516/dsh-config-manager) | 70 | ⚪ unknown | Backup / export / import / migrate your DeepSeek Harness (DSH) configuration - dual-face Cordis plugin (host engine + Web UI). On… |
| [dsh-archive-manager](https://github.com/MichengAI/dsh-archive-manager) | 38 | 🟢 ok | DSH Archive Manager 基于 DeepSeek Harness 的归档会话管理插件 |
...
| [dsh-talk-map](https://github.com/Tasihi89/dsh-talk-map) | 77 | ⚪ unknown | Visual conversation map for DeepSeek Harness — sessions as cards on a whiteboard: drag to arrange, double-click to chat, draw an… |
| [dsh-flowglass](https://github.com/Iwctwbh/dsh-flowglass) | 16 | ⚪ unknown | 流镜 Flowglass — DeepSeek Harness session flowgraph，实时可视化消息、工具组、子代理分支与步骤详情。 |
...
| [dsh-ui-usage-billing](https://github.com/kenz1117/dsh-ui-usage-billing) | 29 | ⚪ unknown | Usage billing dashboard plugin for DeepSeek Harness: sidebar cost metrics, real usage aggregation from session logs, current mult… |
...
| [dsh-maze](https://github.com/lamost423/dsh-maze) | 62 | 🟢 ok | The execution maze for DeepSeek Harness agents — see how the agent actually worked: maze timeline, per-step data tracks, determin… |
...
| [modlens](https://github.com/liustack/modlens) | 3850 | 🟢 ok | The first vision plugin for DeepSeek Harness — let text-only models see. |
...
| [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) | 141 | 🟢 ok | Unofficial DeepSeek Harness LLM provider plugin for Command Code: live model catalog, reasoning-effort support, Models-page card.… |
| [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) | 316 | 🟢 ok | Use ChatGPT (Codex), Claude, and Grok (X Premium) subscriptions as DeepSeek Harness LLM providers — OAuth login in the web UI, no… |
...
| [dsh-math-team](https://github.com/OrinVoss/dsh-math-team) | 5 | ⚪ unknown | DSH Math Modeling Team Plugin Pack: 2 role agent presets (modeling-coding / paper) for DeepSeek Harness, multi-folder Git collabo… |
...
| [deepseek-harness-studio](https://github.com/fufankeji/deepseek-harness-studio) | 594 | ⚪ unknown | DeepSeek Harness Studio：面向 DeepSeek Harness 的现代化桌面开发环境，内置插件中心、视觉增强与本地 Host。 |
| [dsh-plugin-writing-guard](https://github.com/xmutfyh/dsh-plugin-writing-guard) | 30 | 🟢 ok | DSH 论文写作守卫（去 AI 味 / AI 痕迹检测与修改残留检查）— DeepSeek Harness academic writing guard: detects AI-writing style, revision residue & defens… |
...
| [dsh-crew](https://github.com/ZSeven-W/dsh-crew) | 128 | 🟢 ok | DeepSeek Harness (DSH) plugin: dispatch work to DSH agents from Claude Code / Codex — native subagent progress, in-host worker se… |
...
| [dsh-imagegen](https://github.com/dickpy/dsh-imagegen) | 47 | ⚪ unknown | DSH (DeepSeek Harness) Web GUI AI image generation plugin: text-to-image & image-to-image via OpenAI-compatible endpoints (gpt-im… |
...
| [opencues](https://github.com/opencues/opencues) | 42 | ⚪ unknown | Turn any text field into a two-way LLM channel: it reads what you write and fills what you ask. Flags a slip as you type, answers… |
...
| [dsh-image-gen](https://github.com/shanliuling/dsh-image-gen) | 303 | 🟢 ok | Installable multi-provider image generation bundle for DeepSeek Harness (Google Gemini, OpenAI, Volcengine Seedream) |
...
| [dsh-antigravity](https://github.com/LiZhenNet/dsh-antigravity) | 16 | ⚪ unknown | 为 DeepSeek Harness (DSH) 打造的 Google Antigravity 模型提供者插件/Google Antigravity LLM provider for DeepSeek Harness with native Web OAut… |
...
| [dsh-purge](https://github.com/YuJunZhiXue/dsh-purge) | 290 | ⚪ unknown | DeepSeek Harness 破甲：让所有模型都能破甲，不同模型可换不同提示词；默认提示词面向国模「小码酱」。Jailbreak for every model — swap prompts per model. 求 Star 收藏 ⭐ |
...
| [dsh-auto-approve](https://github.com/Jiao-XXX/dsh-auto-approve) | 12 | 🟢 ok | Conservative auto-approval preset for DeepSeek Harness sandbox escalations |
...
| Plugin | ⭐ | Compat | Description |
|---|---|---|---|
| [openhanako](https://github.com/liliMozi/openhanako) | 6470 | ⚪ unknown | Personal AI agent with memory, personality and autonomy |
| [exo](https://github.com/exoharness/exo) | 1154 | ⚪ unknown | Fully recursive agent+harness that self-edits at runtime |
| [synergy](https://github.com/SII-Holos/synergy) | 552 | ⚪ unknown | General-purpose agent for the Open Agentic Web |
| [ccteam](https://github.com/firstintent/ccteam) | 394 | ⚪ unknown | Orchestrates Claude Code/Codex/Grok/Kimi into one team |
...
| [distill](https://github.com/LoserFox/distill) | 25 | ⚪ unknown | Auto conversation distillation: background subagent reflection |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1325 | 🟢 ok | AgentTeams plugin |
...
| [deepseek-harness-fnos](https://github.com/techysy/deepseek-harness-fnos) | 27 | ⚪ unknown | deepseek-harness-fnos — DSH plugin (orchestration) |
...
| [dsh-file-review](https://github.com/left0ver/dsh-file-review) | 35 | 🟢 ok | a dsh plugin - review files that an agent just changed,you can see the diff |
...
| [Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 3139 | ⚪ unknown | VibeSkills is a general-purpose Skill that automatically routes local Skills and intelligently orchestrates harness workflows. |
...
| [sandbase-skills](https://github.com/sandbaseai/sandbase-skills) | 107 | ⚪ unknown | Native DeepSeek Harness skills for research and growth workflows, with an npm CLI that installs complete bundles into .dsh/skills… |
...
| [dsh-deepread](https://github.com/xiehuan123/dsh-deepread) | 46 | 🟢 ok | Evidence-first deep reading for AI agents — trace claims, evidence, confidence and knowledge maps across articles, books and PDFs. |
...
| [dsh-ego-browser](https://github.com/Fisfzy/dsh-ego-browser) | 85 | ⚪ unknown | DSH（DeepSeek Harness）插件：把 ego-lite 浏览器（给 AI Agent 用的 Chromium）接入 HARNESS——13 个结构化 ego_* 工具（文本语义快照、语义定位点击、表单填充、截图、CDP 控制、任务空间隔离），内… |
...
| [dsh-agency-agents](https://github.com/MichengAI/dsh-agency-agents) | 33 | ⚪ unknown | DSH agency agents 基于 DeepSeek Harness 的全行业智能体 |
...
| [dsh-router-standard](https://github.com/yjh051108/dsh-router-standard) | 364 | ⚪ unknown | Task-aware reasoning-mode router for DeepSeek Harness: three measured behavior bands (spec/mixed/react) with phase-transition evi… |
...
| [dsh-Mimir-Academic-research](https://github.com/1692775560/dsh-Mimir-Academic-research) | 168 | ⚪ unknown | Mimir — 一站式科研工作台插件：LaTeX 论文边写边编译、arXiv 文献管理、实验追踪、指标图表、GPU 服务器 SSH 任务编排，管理科研全周期。An open-source research workbench plugin for the w… |
...
| [loopx](https://github.com/huangruiteng/loopx) | 5507 | ⚪ unknown | Long-horizon agent control plane for durable, governed work across Codex, Claude Code, and other harnesses. |
...
| [dsh-Visual-Workflow](https://github.com/GZX2211/dsh-Visual-Workflow) | 15 | ⚪ unknown | 专为 DeepSeek Harness Web GUI 打造的可视化多 Agent 工作流编排插件。公开测试版已上线！接下来会随着 DSH 的正式版上线一并发布正式版！ |
| [pi-web-ui](https://github.com/xing-shuyin/pi-web-ui) | 87 | ⚪ unknown | dsh / pi-agent web ui |
...
| [dsh-hub-cli](https://github.com/pax-beehive/dsh-hub-cli) | 71 | ⚪ unknown | Open-source CLI, schemas, resolver, and DSH agent tools for DSH Plugin Hub |
...
| [dsh-usage-stats](https://github.com/Ychris12138/dsh-usage-stats) | 140 | 🟢 ok | Token usage heatmap, per-model breakdowns, and DeepSeek account balance for the DeepSeek Harness Web GUI (dsh web). |
...
| [dsh-remote](https://github.com/flymysql/dsh-remote) | 53 | 🟢 ok | Remote-access assistant for DeepSeek Harness: /remote command and settings page printing the exact SSH tunnel / reverse-tunnel /… |
...
| [deepseek-harness-mobile](https://github.com/sorsama/deepseek-harness-mobile) | 54 | ⚪ unknown | Android companion for DeepSeek Harness | chat, goals, approvals & notifications from your phone, over your LAN. Kotlin + Jetpack… |
...
| [dsh-pocket](https://github.com/shaobeichen/dsh-pocket) | 918 | 🟢 ok | 把 DeepSeek Harness 装进你的口袋：电脑上跑 dsh web，手机扫码即同步访问（局域网 + 公网，实时同屏） |
...
| [dsh-mobile](https://github.com/saya-ch/dsh-mobile) | 194 | 🟢 ok | DeepSeek Harness 移动端适配与安全局域网访问插件，支持 Android App 和手机浏览器。 |
...
| [awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) | 1444 | ⚪ unknown | DSH plugin directory with daily compatibility tracking |
...
| [awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 985 | ⚪ unknown | DSH ecosystem curation: plugins, tools, infra |
| [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 250 | 🟢 ok | DeepSeek Harness terminal UI |
...
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 602 | ⚪ unknown | 2005-style sidebar ads plugin (parody) |
...
| [oh-dsh-desktop](https://github.com/hust-open-atom-club/oh-dsh-desktop) | 300 | 🔴 broken (dump-config exit=1 but plugin not found in composed tree) | Extensible macOS DSH workbench with native PTY |
| [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) | 253 | 🟢 ok | In-chat generative UI: interactive HTML cards |
...
| [dsh-emoji](https://github.com/hellodigua/dsh-emoji) | 42 | 🟢 ok | Auto-add emoji to AI replies |
...
| [dsh-notifier](https://github.com/THEWOLFWALKER/dsh-notifier) | 85 | 🟢 ok | Unified notification push plugin for DeepSeek Harness (DSH): one minimal notify() API, 8 channel adapters (telegram/dingtalk/feis… |
...
| [dsh-lark-bridge](https://github.com/bihangchi9-creator/dsh-lark-bridge) | 36 | 🟢 ok | A native DeepSeek Harness (dsh) plugin bridging dsh coding agents to Feishu/Lark group chats — one group, one project directory. |
| [dsh-meow-smooth](https://github.com/Phant0Meow/dsh-meow-smooth) | 35 | ⚪ unknown | 手机电脑dsh通知功能！移动端可用的通知！手机端ui交互优化！让手机端dsh真正可用。 |
...
> 1821 entries total, grouped by category, sorted by ⭐ within each. Schema dictionary: [docs/catalog-schema.md](docs/catalog-schema.md).
<!-- CATALOG:END -->
