...
![Plugins](https://img.shields.io/badge/plugins-1883-facc15?style=flat-square)
...
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 7408 | 🟢 ok | DSH Web UI plugin & skin collection: task board, git panel, etc. |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3517 | 🟢 ok | Sidebar workbench: file render/terminal/git/subagent |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 2021 | ⚪ unknown | DSH Web whale-girl skin series |
...
| Plugin | ⭐ | Compat | Description |
|---|---|---|---|
| [open-managed-agents](https://github.com/openma-ai/open-managed-agents) | 272 | ⚪ unknown | Self-hosted Claude Managed Agents API platform (Cloudflare Workers) |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 361 | 🟢 ok | Mnemon three-layer memory deep integration |
...
| [modsearch](https://github.com/liustack/modsearch) | 463 | ⚪ unknown | Web search plugin for DeepSeek Harness. |
...
| [dsh-commandcode-go-provider](https://github.com/jiesou/dsh-commandcode-go-provider) | 14 | ⚪ unknown | Command Code Go API provider for dsh. Command Code 订阅 + DeekSeek Harness 兼容层 |
...
| [dsh-pentest](https://github.com/howmp/dsh-pentest) | 438 | 🟢 ok | 面向 DeepSeek Harness（dsh）的渗透测试模式 @CloverSecLabs |
...
| [dsh-redteam-model](https://github.com/SeaOf0/dsh-redteam-model) | 395 | 🟢 ok | 基于dsh web实现的多种模式，目的是服务于redteam进行授权的安全研究，覆盖渗透测试、红队评估、代码审计等范围领域，请勿用于非法行为。（允许二开，赋予模块各位自己的业务逻辑，不定期完善逻辑与修复bug） |
...
| [dsh-personal-center](https://github.com/PolinniZhong/dsh-personal-center) | 103 | 🟢 ok | DeepSeek Harness 个人中心:用量统计 / 自定义指令 / 成本估算 / 桌面宠物(纯本地，不联网）。 Personal center & custom instructions for DSH |
...
| [Invoice-Downloader](https://github.com/EthanYoQ/Invoice-Downloader) | 409 | ⚪ unknown | 电子发票整理与报销准备工具：从邮箱批量收集 PDF/OFD/XML 发票，OCR 识别、分类归档并生成 Excel 汇总；提供 Windows/macOS 桌面版与 DSH 插件。 |
...
| [dsh-infinite-gen-2](https://github.com/Minglink/dsh-infinite-gen-2) | 1319 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DeepSeek 专用破甲插件「无限二代」dsh-infinite-gen-2 — armor-breaking plugin for DeepSeek稳定化破甲提示词，求 Star 收藏 ⭐ |
...
| [dsh-research-report](https://github.com/PerryLink/dsh-research-report) | 90 | 🟢 ok | Verifiable research-report engine for DeepSeek Harness: content-addressed evidence ledger (claim-snapshot binding, tamper-evident… |
...
| [dsh-infinite-gen-3](https://github.com/Minglink/dsh-infinite-gen-3) | 1319 | 🟢 ok | DeepSeek 专用破甲插件「无限三代」dsh-infinite-gen-3 — armor-breaking plugin for DeepSeek，破甲版：稳定化破甲，求 Star 收藏 ⭐ |
...
| [dsh-plugin-shop](https://github.com/LivXue/dsh-plugin-shop) | 588 | 🟢 ok | The most comprehensive DeepSeek Harness plugin market — refreshed daily, sourced across the Internet, reviewed before publishing. |
...
| [dsh-approval-gate](https://github.com/moon09300731/dsh-approval-gate) | 60 | 🟢 ok | DeepSeek Harness 自动审批门控：Flash 预判不可回补操作，安全自动批准、危险转人工（fail-safe） |
...
| [dsh-council](https://github.com/a1exsun/dsh-council) | 30 | ⚪ unknown | Multi-model council for DeepSeek Harness: independent answers, anonymous peer reviews, and an inspectable final decision. |
...
| [dsh-fylar-office-editor](https://github.com/FylarOpen/dsh-fylar-office-editor) | 23 | ⚪ unknown | Office document preview, editing, and DOCX generation for DeepSeek Harness, powered by Fylar Office SDK. |
...
| [dsh-connect-workbuddy](https://github.com/dingminhua/dsh-connect-workbuddy) | 12 | ⚪ unknown | Connect locally signed-in WorkBuddy models to DeepSeek Harness with a read-only credits overview and model management. |
...
| [dsh-liang-skin](https://github.com/kingOfSoySauce/dsh-liang-skin) | 183 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | Liang-Stan adaptive reasoning slider skin (Jiankang Liang meme) for DeepSeek Harness |
...
| [voyager](https://github.com/Nagi-ovo/voyager) | 20035 | ⚪ unknown | Enhancement suite for Gemini, AI Studio, Claude & ChatGPT — plus a prompt manager for any web UI, DeepSeek Harness included. / 面向… |
| [dsh-im](https://github.com/xmanrui/dsh-im) | 1266 | 🟢 ok | 通过扫码把IM机器人接入DeepSeek Harness（支持飞书、微信、钉钉、QQ、企业微信等） |
...
| [DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 2157 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接喊来你的dsh安装 |
...
| [dsh-codex-ui](https://github.com/MichengAI/dsh-codex-ui) | 69 | 🟢 ok | DSH Codex UI 基于 DeepSeek Harness 的 Codex UI 插件，还原度90%，小细节拉满 |
...
| [dsh-infinite-gen-4](https://github.com/Minglink/dsh-infinite-gen-4) | 1319 | ⚪ unknown | DeepSeek v4.1 flash 网络安全红队工具（无限四代） — jailbreak prompts and test suite for DeepSeek 求 Star 收藏 ⭐ |
...
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 297 | 🟢 ok | Cross-session long-term memory + background self-evolution |
...
| [billion-context-dsh](https://github.com/Tyan66666/billion-context-dsh) | 85 | 🟢 ok | Model-driven context management (Active Context Pruning / ACP) for the DeepSeek Harness — the model decides when and what to comp… |
...
| [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) | 286 | 🟢 ok | dsh-cost-meter — DSH plugin (session) |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 1334 | 🟢 ok | A DeepSeek Harness plugin for Context insight panel — a Context tab in the web UI showing what the model's context window is made… |
...
| [dsh-memory](https://github.com/FuRongJun-1999/dsh-memory) | 162 | 🟢 ok | Multi-agent spatiotemporal memory graph for DeepSeek Harness.Cross-session persistence, knowledge flywheel, importance-gated memo… |
...
| [dsh-delete-session](https://github.com/dream12347/dsh-delete-session) | 65 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | Delete DSH conversation sessions from a Settings panel/在设置面板中增加删除会话管理以便删除无用会话 |
...
| [dsh-config-manager](https://github.com/xiajiajun516/dsh-config-manager) | 105 | 🟢 ok | Backup / export / import / migrate your DeepSeek Harness (DSH) configuration - dual-face Cordis plugin (host engine + Web UI). On… |
...
| [modlens](https://github.com/liustack/modlens) | 3946 | 🟢 ok | The first vision plugin for DeepSeek Harness — let text-only models see. |
...
| [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) | 205 | 🟢 ok | Unofficial DeepSeek Harness LLM provider plugin for Command Code: live model catalog, reasoning-effort support, Models-page card.… |
| [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) | 337 | 🟢 ok | Use ChatGPT (Codex), Claude, and Grok (X Premium) subscriptions as DeepSeek Harness LLM providers — OAuth login in the web UI, no… |
...
| [opencode2dsh](https://github.com/FishBottle7/opencode2dsh) | 55 | ⚪ unknown | DSH plugin — free OpenCode Zen models for DeepSeek Harness (DSH). Free LLM API, no API key needed. 在 DSH 中使用 OpenCode Zen 免费模型，无需… |
...
| [dsh-purge](https://github.com/YuJunZhiXue/dsh-purge) | 611 | 🟢 ok | DeepSeek Harness 破甲：让所有模型都能破甲，不同模型可换不同提示词；默认提示词面向国模「小码酱」。Jailbreak for every model — swap prompts per model. 求 Star 收藏 ⭐ |
...
| [dsh-better-display](https://github.com/aa2246740/dsh-better-display) | 27 | ⚪ unknown | A calmer reading view for DeepSeek Harness: native process details, live reasoning, and clean final answers. |
...
| [exo](https://github.com/exoharness/exo) | 1388 | ⚪ unknown | Fully recursive agent+harness that self-edits at runtime |
| [synergy](https://github.com/SII-Holos/synergy) | 490 | ⚪ unknown | General-purpose agent for the Open Agentic Web |
| [ccteam](https://github.com/firstintent/ccteam) | 508 | ⚪ unknown | Orchestrates Claude Code/Codex/Grok/Kimi into one team |
...
| [distill](https://github.com/LoserFox/distill) | 24 | ⚪ unknown | Auto conversation distillation: background subagent reflection |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1552 | 🟢 ok | AgentTeams plugin |
...
| [Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 3249 | ⚪ unknown | VibeSkills is a general-purpose Skill that automatically routes local Skills and intelligently orchestrates harness workflows. |
...
| [sandbase-skills](https://github.com/sandbaseai/sandbase-skills) | 156 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | Native DeepSeek Harness skills for research and growth workflows, with an npm CLI that installs complete bundles into .dsh/skills… |
...
| [dsh-tavern](https://github.com/flizzywine/dsh-tavern) | 261 | 🟢 ok | 基于 DeepSeek Harness（DSH）的 SillyTavern 类文字游戏 Agent，支持候选项生成、对话式人物卡编辑、剧本模式与素材抽取。 |
...
| [dsh-Mimir-Academic-research](https://github.com/1692775560/dsh-Mimir-Academic-research) | 314 | ⚪ unknown | Mimir — 一站式科研工作台插件：LaTeX 论文边写边编译、arXiv 文献管理、实验追踪、指标图表、GPU 服务器 SSH 任务编排，管理科研全周期。An open-source research workbench plugin for the w… |
...
| [dsh-watcher](https://github.com/aa2246740/dsh-watcher) | 56 | ⚪ unknown | Read-only Agent work-path observer for DeepSeek Harness |
...
| [loopx](https://github.com/huangruiteng/loopx) | 5796 | ⚪ unknown | Long-horizon agent control plane for durable, governed work across Codex, Claude Code, and other harnesses. |
...
| [dsh-hub-cli](https://github.com/pax-beehive/dsh-hub-cli) | 277 | ⚪ unknown | Open-source CLI, schemas, resolver, and DSH agent tools for DSH Plugin Hub |
...
| [dsh-pocket](https://github.com/shaobeichen/dsh-pocket) | 1072 | 🟢 ok | 把 DeepSeek Harness 装进你的口袋：电脑上跑 dsh web，手机扫码即同步访问（局域网 + 公网，实时同屏） |
...
| [dsh-web-startup-auth](https://github.com/GDWhisper/dsh-web-startup-auth) | 36 | 🟢 ok | DSH（DeepSeek Harness）远程 Web 启动 + 用户名/密码认证插件。 | DeepSeek Harness Remote‑Web‑Launch Plugin with Username/Password Auth |
...
| [ds-harness-remote](https://github.com/liguobao/ds-harness-remote) | 178 | 🟢 ok | 一个基于 DeepSeek Harness 插件机制构建的多端远程访问方案，通过安全、低延迟、端到端加密的 P2P 优先网络，支持从 PC、Android 和 Web 随时访问并操作远程 Harness。 (A multi-device remote acc… |
| [dsh-remote](https://github.com/SCSpotato/dsh-remote) | 77 | 🟢 ok | Native Android client to remotely control DeepSeek Harness (DSH) from your phone |
...
> 1883 entries total, grouped by category, sorted by ⭐ within each. Schema dictionary: [docs/catalog-schema.md](docs/catalog-schema.md).
<!-- CATALOG:END -->
