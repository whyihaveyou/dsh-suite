...
![Plugins](https://img.shields.io/badge/plugins-1599-facc15?style=flat-square)
...
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 4564 | 🟢 ok | DSH Web UI plugin & skin collection: task board, git panel, etc. |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2171 | 🟢 ok | Sidebar workbench: file render/terminal/git/subagent |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1377 | ⚪ unknown | DSH Web whale-girl skin series |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 700 | 🟢 ok | Vision for text-only models: image QA, screenshot OCR, UI reconstruction |
...
| [dsh-share](https://github.com/hellodigua/dsh-share) | 25 | 🟢 ok | DSH conversation sharing plugin |
...
| Plugin | ⭐ | Compat | Description |
|---|---|---|---|
| [open-managed-agents](https://github.com/openma-ai/open-managed-agents) | 238 | ⚪ unknown | Self-hosted Claude Managed Agents API platform (Cloudflare Workers) |
...
| [dsh-data-agent](https://github.com/omdsh-dev/dsh-data-agent) | 55 | 🟢 ok | Connect DB and write SQL plugin |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 104 | 🟢 ok | Mnemon three-layer memory deep integration |
...
| [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) | 17 | ⚪ unknown | OpenMAIC: classrooms, slides, interactive widgets |
...
| [modsearch](https://github.com/liustack/modsearch) | 148 | ⚪ unknown | Web search plugin for DeepSeek Harness. |
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 298 | 🟢 ok | Chrome sidebar extension letting DSH drive the browser. |
...
| [dsh-browser](https://github.com/ben7am1n/dsh-browser) | 3 | 🟢 ok | Playwright-powered browser automation for DeepSeek Harness |
...
| [dsh-codex](https://github.com/Yan-Zero/dsh-codex) | 33 | 🟢 ok | Use your ChatGPT subscription in DeepSeek Harness through OpenAI's Codex sign-in flow |
...
| [dsh-codex-connect](https://github.com/franksong2702/dsh-codex-connect) | 27 | ⚪ unknown | ChatGPT OAuth and Codex models for DeepSeek Harness. |
...
| [dsh-prompt-enhancer](https://github.com/Fishsb/dsh-prompt-enhancer) | 21 | ⚪ unknown | dsh-prompt-enhancer — DSH plugin (tools) |
...
| [MuseAI](https://github.com/yejiming/MuseAI) | 585 | ⚪ unknown | 创建你的 AI 角色，进入你的故事世界。和角色聊天、冒险、穿书，让每一次互动都留下羁绊（支持 DeepSeek Harness 插件，欢迎使用） |
...
| [anysearch-dsh](https://github.com/anysearch-team/anysearch-dsh) | 107 | 🟢 ok | AnySearch web search provider and advanced search tools for DeepSeek Harness (DSH) |
...
| [dsh-plugins](https://github.com/Ceelog/dsh-plugins) | 7 | ⚪ unknown | deepseek harness plugins |
...
| [dsh-stock-watch](https://github.com/Awu12277/dsh-stock-watch) | 49 | 🟢 ok | A股自选股实时行情盯盘插件 - DeepSeek Harness Web 右上角可折叠弹窗 |
...
| [dsh-pet](https://github.com/PC2005-cloud/dsh-pet) | 144 | 🟢 ok | DeepSeek Harness 桌面宠物插件 + 完整素材生成链：AI 提示词 → 绿幕视频 → 透明动画 → 可安装插件，从零到宠物全流程可复现 |
...
| [dsh-anchored-standard](https://github.com/xiaobright/dsh-anchored-standard) | 3557 | ⚪ unknown | Two-phase DeepSeek Harness preset: Minimal-aligned bootstrap, then full Standard tools (Project2 98/99) |
...
| [dsh-auto-mode](https://github.com/NanmiCoder/dsh-auto-mode) | 101 | 🟢 ok | Safe automatic permissions for DeepSeek Harness. |
...
| [dsh-free-search](https://github.com/DDDMUC/dsh-free-search) | 20 | ⚪ unknown | Free web search provider for DeepSeek Harness - DuckDuckGo backend, no API key needed |
...
| [oh-my-dsh](https://github.com/amplifthq/oh-my-dsh) | 5 | ⚪ unknown | A curated distribution of DeepSeek Harness. Overlay, not a fork. |
| [dsh-smooth-stream](https://github.com/Laplace-bit/dsh-smooth-stream) | 33 | 🟢 ok | DeepSeek Harness (dsh) plugin: silky streaming reveal, no flicker. dsh 丝滑流式渲染插件。 |
...
| [dockyard-dsh](https://github.com/AITabby/dockyard-dsh) | 68 | ⚪ unknown | A macOS-only native account-pool and provider plugin for DeepSeek Harness. |
| [deepseek-harness-workbench-plugin](https://github.com/loadingvx/deepseek-harness-workbench-plugin) | 15 | ⚪ unknown | Deepseek-harness-workbench-plugin |
| [dsh-permgate](https://github.com/MrWeiCodes/dsh-permgate) | 4 | ⚪ unknown | 为 DeepSeek Harness（DSH）提供的细粒度权限控制插件 |
| [anime-find](https://github.com/cocofhu/anime-find) | 146 | ⚪ unknown | DeepSeek Harness 搜番插件：对话内多源搜索番剧，卡片展示 Bangumi 评分与详情，支持复制磁力。 |
...
| [dsh-anchored-standard](https://github.com/Jungod1121/dsh-anchored-standard) | 16 | ⚪ unknown | Two-phase DeepSeek Harness preset: Minimal-aligned bootstrap (bash+read), then full Standard tools after the first tool call or r… |
| [dsh-pentest](https://github.com/howmp/dsh-pentest) | 51 | ⚪ unknown | 面向 DeepSeek Harness（dsh）的渗透测试模式 @CloverSecLabs |
...
| [dsh-mcp-manager](https://github.com/Js2Hou/dsh-mcp-manager) | 6 | 🔴 broken (failed once, retried — install failed (exit 1):     at runPlugin (file:///home/runner/.npm/_npx/1e7f6d9597241db0/node_modules/@deepseek-ai/dsh/lib/plugin-9h8shc) | 用于 DeepSeek Harness 的 MCP 可视化管理插件：在「设置 → MCP」中查看已安装/启用的 MCP 服务器，支持增删、启用/停用，并实时查看连接状态。 |
...
| [dsh-animation-optimization](https://github.com/kelemiao/dsh-animation-optimization) | 5 | ⚪ unknown | DSH 动画优化：输出流式动画与 Claude Code 风格外观插件 |
...
| [dsh-plugin-directory](https://github.com/alexchenzl/dsh-plugin-directory) | 18 | ⚪ unknown | Community DeekSeek Harness Plugin Directory |
| [dsh-trading](https://github.com/maddogfinance/dsh-trading) | 6 | ⚪ unknown | Trading research workbench for DeepSeek Harness (dsh): typed market-data seam, deterministic indicators, interactive chart cards,… |
...
| [dsh-wallpaper-engine](https://github.com/elysia395/dsh-wallpaper-engine) | 72 | ⚪ unknown | 一个插件让你的dsh可以自由切换你的wallpaper engine里面的壁纸资源，还可以通过多个滑动条来控制透壁纸的模糊程度，亮度，边框，以及对话框的液态玻璃效果，让你的dsh更加美观 |
...
| [dsh-wallpaper-rotator](https://github.com/liceses/dsh-wallpaper-rotator) | 5 | ⚪ unknown | DSH 壁纸轮换插件：定时轮换应用背景壁纸（交叉淡化动效）、内置壁纸集、毛玻璃/压暗/文字阴影可读性调节。dsh plugin add 一键安装。 |
...
| [dsh-plugins](https://github.com/Ephemeral-AI-Lab/dsh-plugins) | 19 | ⚪ unknown | Make Deepseek Harness Great |
| [rapid-mlx-dsh-provider](https://github.com/raullenchai/rapid-mlx-dsh-provider) | 18 | ⚪ unknown | Native Rapid-MLX provider for DeepSeek Harness (dsh) — dsh reads model facts from the server instead of your settings.yaml. |
...
| [superpowers-dsh](https://github.com/LayneChai/superpowers-dsh) | 57 | 🟢 ok | Superpowers skills for DeepSeek Harness: TDD, debugging, planning, and collaboration skills adapted from obra/superpowers |
...
| [dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill) | 36 | ⚪ unknown | Complete reverse-skill (85 SKILL.md) as a DeepSeek Harness (dsh) Cordis plugin — reverse engineering, authorized pentesting and s… |
...
| [dsh-movein](https://github.com/sjh9714/dsh-movein) | 7 | ⚪ unknown | Move your whole Claude Code setup into DeepSeek Harness (DSH) with one command. Skills, MCP, hooks, instructions. 从 Claude Code 拎… |
...
| [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) | 76 | ⚪ unknown | Selection annotation: select→annotate→send |
...
| [dsh-navbar](https://github.com/vlln/dsh-navbar) | 40 | ⚪ unknown | Conversation node navbar |
...
| [dsh-drag-and-drop](https://github.com/bill9109/dsh-drag-and-drop) | 17 | ⚪ unknown | Cross-platform file drag & drop with raw path insertion |
...
| [whale-girl](https://github.com/vlln/whale-girl) | 235 | ⚪ unknown | QQ-pet-style desktop pet plugin |
| [dsh-status-rotator](https://github.com/01Virex/dsh-status-rotator) | 32 | ⚪ unknown | Web plugin replacing the DSH status display. |
...
| [dsh-portable-tavern](https://github.com/XCNXNXNX/dsh-portable-tavern) | 17 | 🟢 ok | dsh-portable-tavern — DSH plugin (ui) |
...
| [dsh-undo-plugin](https://github.com/lire1131/dsh-undo-plugin) | 83 | ⚪ unknown | DSH plugin: snapshot & rollback your plugin/skin/settings configs. Auto-save on change, undo/redo stack, snapshot manager panel,… |
| [plugin-manager](https://github.com/whyihaveyou/dsh-suite) | 7 | 🟢 ok | In-app plugin store for DSH Web UI: browse the dsh-suite catalog, search/filter/sort, compat badges, one-click install — a Store… |
...
| [dsh-computer-use](https://github.com/ZRui-C/dsh-computer-use) | 17 | ⚪ unknown | Text-first browser & background macOS control for DeepSeek Harness (DSH): target the right process and window without taking the… |
...
| [dsh-oh-my-theme](https://github.com/zhxqc/dsh-oh-my-theme) | 5 | 🟢 ok | DeepSeek Harness (dsh) web plugin with themes, global typography, @file mentions, project file tree, and Markdown preview. |
...
| [deepseek-harness-genui](https://github.com/pengyue-polaron/deepseek-harness-genui) | 39 | ⚪ unknown | Code-first generative UI for DeepSeek Harness |
| [dsh-smooth-stream](https://github.com/Laplace-bit/dsh-smooth-stream) | 33 | 🟢 ok | Smooth streaming reveal for the DSH Web UI: typewriter following token arrival, live Markdown rendering, slide-in line breaks, no… |
| [voyager](https://github.com/Nagi-ovo/voyager) | 19649 | ⚪ unknown | Enhancement suite for Gemini, AI Studio, Claude & ChatGPT — plus a prompt manager for any web UI, DeepSeek Harness included. / 面向… |
...
| [DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 36 | ⚪ unknown | DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接喊来你的dsh安装 |
...
| [dsh-beauty-skins](https://github.com/XieRW/dsh-beauty-skins) | 12 | ⚪ unknown | 给 DeepSeek Harness 用的美女系列皮肤：设置里从 哲风壁纸 拉预览网格，点一张即应用，配色从壁纸提取。支持动态壁纸，也保留自定义选图。 |
| [open-sea-skin](https://github.com/d-dev0101/open-sea-skin) | 157 | ⚪ unknown | WebGPU ocean skin for DeepSeek Harness — DSH plugin, Harness-only Chrome/Edge extension, static installer, and native integration. |
| [dsh-mobile-hanui](https://github.com/Z-6354/dsh-mobile-hanui) | 5 | ⚪ unknown | 基于deepseek-harness（dsh）的手机网页优化插件，修复了部分网页与手机端不适配的问题； |
...
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 177 | ⚪ unknown | Cross-session long-term memory + background self-evolution |
...
| [plugin-session-export](https://github.com/whyihaveyou/dsh-suite) | 3 | 🟢 ok | Export the append-only session log as human-readable Markdown / HTML, grouped by trajectory source (system prompt / reasoning / t… |
| [dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) | 70 | 🟢 ok | Import chat history from Claude Code/Codex/Reasonix into DSH. |
...
| [context-vista](https://github.com/GooodWei/context-vista) | 9 | 🟢 ok | context-vista — DSH plugin (session) |
...
| [dsh-mneme](https://github.com/modusensus/dsh-mneme) | 27 | ⚪ unknown | dsh-mneme — DSH plugin (session) |
| [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) | 95 | ⚪ unknown | dsh-cost-meter — DSH plugin (session) |
...
| [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) | 37 | 🟢 ok | Second-model AI auto-review for DeepSeek Harness approval requests: a read-only reviewer subagent returns structured allow/deny v… |
...
| [dsh-token-monitor](https://github.com/zhangzheng25/dsh-token-monitor) | 6 | ⚪ unknown | DeepSeek Harness plugin: token usage & conversation stats as a native settings page - today / 7d / 30d totals, GitHub-style 90-da… |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 318 | 🟢 ok | A DeepSeek Harness plugin for Context insight panel — a Context tab in the web UI showing what the model's context window is made… |
...
| [deepseek-harness-wallet](https://github.com/feibi-mochi/deepseek-harness-wallet) | 38 | ⚪ unknown | Balance monitoring, per-session spend & token tracking, low-balance alerts, and an official recharge shortcut for DeepSeek Harnes… |
...
| [DSH-recall-plugin](https://github.com/limbo947/DSH-recall-plugin) | 20 | 🟢 ok | DSH 消息撤回插件：回到发送该消息时的状态 |
...
| [dsh-mermaid](https://github.com/AKS1st/dsh-mermaid) | 8 | ⚪ unknown | 在 DSH Web 会话中把 Mermaid 代码围栏渲染为 SVG 图表 | Render Mermaid code fences as SVG diagrams in DSH Web messages |
...
| [dsh-roleplay-preset](https://github.com/oliblue-evan/dsh-roleplay-preset) | 13 | ⚪ unknown | DeepSeek 深度调校的沉浸式角色扮演 Agent 预设（dsh）——零工具纯对话、酒馆式演出格式、文件记忆库 |
...
| [dsh-Remote](https://github.com/Blank-not-black/dsh-Remote) | 10 | 🟢 ok | DSH Remote · 口袋里的 DSH 控制台 会话 · 审批 · 提问 · 文件传输，局域网 / Tailscale 直连 多服务器自动选优，聊天记录离线可看 带 Token 鉴权，数据只在你的设备之间流动 |
...
| [dsh-ocgo-lite](https://github.com/OK-wx/dsh-ocgo-lite) | 8 | ⚪ unknown | OpenCode Go 用量常驻条：套餐余量圆环 + token/花费实时统计（本次会话/全部范围 + 按模型联动，官方实时定价），一键复制 API Key。OpenCode Go usage bar for DeepSeek Harness. |
...
| [deepseek-harness-control-center](https://github.com/feibi-mochi/deepseek-harness-control-center) | 38 | ⚪ unknown | DeepSeek Harness account monitoring, usage accounting, completion alerts, official recharge, flexible layout, and agent-assisted… |
...
| [modlens](https://github.com/liustack/modlens) | 3096 | 🟢 ok | The first vision plugin for DeepSeek Harness — let text-only models see. |
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 1042 | ⚪ unknown | Vision toolbox & skills for text-only models: multi-image QA, UI reconstruction, GUI automation. |
...
| [TokenLedger](https://github.com/zh667/TokenLedger) | 100 | ⚪ unknown | Token usage accounting for DeepSeek Harness, reconciled against New API and Sub2API relay-site billing |
...
| [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) | 60 | 🟢 ok | Unofficial DeepSeek Harness LLM provider plugin for Command Code: live model catalog, reasoning-effort support, Models-page card.… |
| [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) | 112 | 🟢 ok | Use ChatGPT (Codex), Claude, and Grok (X Premium) subscriptions as DeepSeek Harness LLM providers — OAuth login in the web UI, no… |
...
| [dsh-usage-stats](https://github.com/Make0209/dsh-usage-stats) | 19 | 🟢 ok | DeepSeek Harness 插件：GitHub 风格用量热力图 + Token / 缓存命中 / 账户余额看板 + 工作区别名管理。 |
...
| [dsh-reasoning-effort](https://github.com/HanaAyane/dsh-reasoning-effort) | 80 | ⚪ unknown | DSH适用的Codex风格的思考强度滑块，以及大肥鱼跑步滑块。Codex-style model and reasoning-effort slider for DeepSeek Harness |
...
| [dsh-AuthInOne](https://github.com/Stormycry-cryp/dsh-AuthInOne) | 25 | ⚪ unknown | DeepSeek Harness plugin for OpenAI Codex account login, API and custom OpenAI-compatible providers, model switching, token usage… |
...
| [dsh-read-url](https://github.com/2672243194/dsh-read-url) | 11 | ⚪ unknown | DeepSeek Harness URL reader: fetch any page and return clean main-content text/Markdown. Auto charset (GBK/GB2312/UTF-8/Big5), to… |
...
| [dsh-image-gen](https://github.com/shanliuling/dsh-image-gen) | 48 | ⚪ unknown | Installable multi-provider image generation bundle for DeepSeek Harness (Google Gemini, OpenAI, Volcengine Seedream) |
...
| [dsh-computer-use](https://github.com/988hj7tczd-oss/dsh-computer-use) | 7 | ⚪ unknown | Computer Use 插件：虚拟鼠标真人操作 for DeepSeek Harness（screen_observe + computer_click 等 11 个模型友好工具，跨平台 cua-driver 引擎） |
...
| [tongflow](https://github.com/tong-io/tongflow) | 857 | ⚪ unknown | TongFlow — multimodal AIGC workflow engine (canvas + Python plugin engine) and dsh-tongflow, the DeepSeek Harness studio plugin |
...
| [mirage-dsh](https://github.com/strukto-ai/mirage) | 3508 | 🟢 ok | Swap DSH's fs/shell providers for a mirage virtual workspace: file tools and shell commands act on mounted resources (RAM, disk,… |
...
| Plugin | ⭐ | Compat | Description |
|---|---|---|---|
| [openhanako](https://github.com/liliMozi/openhanako) | 6110 | ⚪ unknown | Personal AI agent with memory, personality and autonomy |
| [exo](https://github.com/exoharness/exo) | 786 | ⚪ unknown | Fully recursive agent+harness that self-edits at runtime |
...
| [distill](https://github.com/LoserFox/distill) | 19 | ⚪ unknown | Auto conversation distillation: background subagent reflection |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 551 | 🟢 ok | AgentTeams plugin |
| [dsh-automation](https://github.com/titanwings/dsh-automation) | 55 | ⚪ unknown | Run scheduled tasks in fresh sessions per plan |
...
| [dsh-work](https://github.com/vibeinging/dsh-work) | 395 | ⚪ unknown | Local-first AI workbench for DSH plugins |
...
| [dsh-deep-research](https://github.com/omdsh-dev/dsh-deep-research) | 17 | ⚪ unknown | Adaptive deep-research orchestrator plugin |
...
| [dsh-kun-like-pet](https://github.com/liyupi/dsh-kun-like-pet) | 63 | 🟢 ok | Kun Like 桌宠 —— DeepSeek Harness 桌面宠物插件：右下角小坤宠随 Agent 工作状态切换 9 种动作，任务完成播放「你干嘛~哎哟」 |
...
| [Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 2884 | ⚪ unknown | VibeSkills is a general-purpose Skill that automatically routes local Skills and intelligently orchestrates harness workflows. |
...
| [dsh-agent-team-gui](https://github.com/toolclub/dsh-agent-team-gui) | 60 | ⚪ unknown | Persistent multi-model agent squads for DeepSeek Harness — reusable teams, per-agent model/tool policies, and ordinary-chat colla… |
...
| [dsh-plugin-guard](https://github.com/lxzy-7/dsh-plugin-guard) | 24 | ⚪ unknown | Install safety net for DeepSeek Harness: pre-install snapshots, one-click/automatic rollback, guarded boot, and incident reports… |
| [dsh-file-upload](https://github.com/HongMing-Huang/dsh-file-upload) | 10 | 🟢 ok | DeepSeek Harness (dsh) file-message plugin: Claude-style drag-and-drop / paperclip upload, content sniffing, document-to-Markdown… |
...
| [dsh-quant](https://github.com/pengpengyi92/dsh-quant) | 12 | 🟢 ok | dsh plugin: quantitative tools for agents — market data (Binance public API), technical indicators (SMA/EMA/RSI/MACD/Bollinger/AT… |
...
| [dsh-evolve-modes](https://github.com/GraySilver/dsh-evolve-modes) | 5 | ⚪ unknown | 让 Agent 的工作方式可组合、可审查、可持续改进，最终实现 Agent Self Evoling。 DeepSeek Harness Web plugin with composable task controls and isolated, human… |
...
| [deepseek-harness-acp](https://github.com/openma-ai/deepseek-harness-acp) | 12 | ⚪ unknown | ACP server implementation for DeepSeek harness |
...
| [deepseek-harness-mobile](https://github.com/sorsama/deepseek-harness-mobile) | 19 | ⚪ unknown | Android companion for DeepSeek Harness | chat, goals, approvals & notifications from your phone, over your LAN. Kotlin + Jetpack… |
...
| [dsh-usage-chart](https://github.com/Max-Samson/dsh-usage-chart) | 7 | 🟢 ok | A DeepSeek Harness Web plugin for real-time Token usage, cost estimates, per-round charts, and DeepSeek API balance. |
...
| [dsh-better-deepseek](https://github.com/EdgeTypE/dsh-better-deepseek) | 11 | 🟢 ok | DeepSeek Harness bridge plugin for Better DeepSeek Chrome extension. |
...
| [dsh-pocket](https://github.com/shaobeichen/dsh-pocket) | 153 | 🟢 ok | 把 DeepSeek Harness 装进你的口袋：电脑上跑 dsh web，手机扫码即同步访问（局域网 + 公网，实时同屏） |
...
| [dsh-damage-pulse](https://github.com/wssfk12138/dsh-damage-pulse) | 35 | ⚪ unknown | DeepSeek Harness token balance monitor with game-style damage pulse animations |
...
| [dsh-mobile](https://github.com/saya-ch/dsh-mobile) | 31 | 🟢 ok | DeepSeek Harness 移动端适配与安全局域网访问插件，支持 Android App 和手机浏览器。 |
...
| [awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) | 1214 | ⚪ unknown | DSH plugin directory with daily compatibility tracking |
...
| [awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 727 | ⚪ unknown | DSH ecosystem curation: plugins, tools, infra |
...
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 378 | ⚪ unknown | Codex-style @file mentions for DeepSeek Harness: search workspace files in the composer and attach their contents to prompts. |
| [dsh-open-in-vscode](https://github.com/omdsh-dev/dsh-open-in-vscode) | 50 | ⚪ unknown | Open DeepSeek Harness workspace directories in VS Code directly from the web GUI. |
...
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 499 | ⚪ unknown | 2005-style sidebar ads plugin (parody) |
...
| [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) | 178 | 🟢 ok | In-chat generative UI: interactive HTML cards |
...
| [dsh-emoji](https://github.com/hellodigua/dsh-emoji) | 25 | 🟢 ok | Auto-add emoji to AI replies |
...
| [awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 226 | ⚪ unknown | Bilingual complete list of the DSH plugin ecosystem |
| [dsh-launcher](https://github.com/Ruler4396/dsh-launcher) | 148 | 🟢 ok | WebView2-based DSH launcher |
...
| [dsh-notifier](https://github.com/THEWOLFWALKER/dsh-notifier) | 42 | 🟢 ok | Unified notification push plugin for DeepSeek Harness (DSH): one minimal notify() API, 8 channel adapters (telegram/dingtalk/feis… |
| [dsh-lark](https://github.com/sugarforever/dsh-lark) | 17 | ⚪ unknown | DeepSeek Harness Plugin for Lark Integration |
...
| [dsh-feishu](https://github.com/PGZXB/dsh-feishu) | 8 | ⚪ unknown | The Feishu UI for DeepSeek Harness — a panel-driven control console: every slash command a button on the ⚙️ control-panel card, i… |

> Badges: 🟢 compatible · 🔴 broken · ⚪ unverified · ⚫ unmaintained.
> 1599 entries total, grouped by category, sorted by ⭐ within each. Schema dictionary: [docs/catalog-schema.md](docs/catalog-schema.md).
<!-- CATALOG:END -->
