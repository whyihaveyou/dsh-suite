...
![Plugins](https://img.shields.io/badge/plugins-1857-facc15?style=flat-square)
...
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 7217 | 🟢 ok | DSH Web UI plugin & skin collection: task board, git panel, etc. |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3454 | 🟢 ok | Sidebar workbench: file render/terminal/git/subagent |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1977 | ⚪ unknown | DSH Web whale-girl skin series |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 868 | 🟢 ok | Vision for text-only models: image QA, screenshot OCR, UI reconstruction |
...
| Plugin | ⭐ | Compat | Description |
|---|---|---|---|
| [open-managed-agents](https://github.com/openma-ai/open-managed-agents) | 263 | ⚪ unknown | Self-hosted Claude Managed Agents API platform (Cloudflare Workers) |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 350 | 🟢 ok | Mnemon three-layer memory deep integration |
...
| [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) | 57 | 🟢 ok | OpenMAIC: classrooms, slides, interactive widgets |
...
| [ego-browser](https://github.com/Fisfzy/ego-browser) | 135 | 🟢 ok | Bridge ego-lite Chromium browser into DSH |
...
| [modsearch](https://github.com/liustack/modsearch) | 440 | ⚪ unknown | Web search plugin for DeepSeek Harness. |
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 604 | 🟢 ok | Chrome sidebar extension letting DSH drive the browser. |
...
| [dsh-expression](https://github.com/yyh-001/dsh-expression) | 77 | 🟢 ok | dsh-expression — DSH plugin (tools) |
...
| [dsh-github](https://github.com/PerryLink/dsh-github) | 7 | 🟢 ok | GitHub integration for DeepSeek Harness: create PRs, review PRs in background jobs, read issues - every write gated by human appr… |
...
| [dsh-codex-connect](https://github.com/franksong2702/dsh-codex-connect) | 95 | 🟢 ok | ChatGPT OAuth and Codex models for DeepSeek Harness. |
...
| [dsh-pet](https://github.com/PC2005-cloud/dsh-pet) | 578 | 🟢 ok | DeepSeek Harness 桌面宠物插件 + 完整素材生成链：AI 提示词 → 绿幕视频 → 透明动画 → 可安装插件，从零到宠物全流程可复现 |
...
| [dsh-free-search](https://github.com/DDDMUC/dsh-free-search) | 153 | 🟢 ok | Free web search provider for DeepSeek Harness - DuckDuckGo backend, no API key needed |
...
| [dsh-pentest](https://github.com/howmp/dsh-pentest) | 407 | 🟢 ok | 面向 DeepSeek Harness（dsh）的渗透测试模式 @CloverSecLabs |
...
| [dsh-meme](https://github.com/yyh-001/dsh-meme) | 77 | 🟢 ok | DeepSeek Harness 的表情包插件——找得到、发得出、学得会 |
...
| [dsh-univer-office](https://github.com/dream-num/dsh-univer-office) | 310 | 🟢 ok | Preview Univer sheets, docs & slides inside DeepSeek Harness. |
...
| [dsh-redteam-model](https://github.com/SeaOf0/dsh-redteam-model) | 340 | 🟢 ok | 基于dsh web实现的多种模式，目的是服务于redteam进行授权的安全研究，覆盖渗透测试、红队评估、代码审计等范围领域，请勿用于非法行为。（允许二开，赋予模块各位自己的业务逻辑，不定期完善逻辑与修复bug） |
...
| [dsh-personal-center](https://github.com/PolinniZhong/dsh-personal-center) | 80 | 🟢 ok | DeepSeek Harness 个人中心:用量统计 / 自定义指令 / 成本估算 / 桌面宠物(纯本地，不联网）。 Personal center & custom instructions for DSH |
...
| [Invoice-Downloader](https://github.com/EthanYoQ/Invoice-Downloader) | 404 | ⚪ unknown | 电子发票整理与报销准备工具：从邮箱批量收集 PDF/OFD/XML 发票，OCR 识别、分类归档并生成 Excel 汇总；提供 Windows/macOS 桌面版与 DSH 插件。 |
...
| [dsh-preset-plus](https://github.com/Rain-kl/dsh-preset-plus) | 96 | 🟢 ok | DSH 预设增强插件, 参考 SillyTavern 预设模功能开发的一个基础的预设编辑器。 |
...
| [dsh-infinite-gen-2](https://github.com/Minglink/dsh-infinite-gen-2) | 1167 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DeepSeek 专用破甲插件「无限二代」dsh-infinite-gen-2 — armor-breaking plugin for DeepSeek稳定化破甲提示词，求 Star 收藏 ⭐ |
...
| [dsh-research-report](https://github.com/PerryLink/dsh-research-report) | 79 | 🟢 ok | Verifiable research-report engine for DeepSeek Harness: content-addressed evidence ledger (claim-snapshot binding, tamper-evident… |
...
| [dsh-infinite-gen-3](https://github.com/Minglink/dsh-infinite-gen-3) | 1167 | 🟢 ok | DeepSeek 专用破甲插件「无限三代」dsh-infinite-gen-3 — armor-breaking plugin for DeepSeek，破甲版：稳定化破甲，求 Star 收藏 ⭐ |
...
| [dsh-plugin-shop](https://github.com/LivXue/dsh-plugin-shop) | 436 | 🟢 ok | The most comprehensive DeepSeek Harness plugin market — refreshed daily, sourced across the Internet, reviewed before publishing. |
...
| [dsh-approval-gate](https://github.com/moon09300731/dsh-approval-gate) | 50 | 🟢 ok | DeepSeek Harness 自动审批门控：Flash 预判不可回补操作，安全自动批准、危险转人工（fail-safe） |
| [dsh-knowledge](https://github.com/lemoncat7/dsh-knowledge) | 11 | 🟢 ok | Installable DeepSeek Harness knowledge base plugin |
| [prts-terrarchive](https://github.com/HTian-qwq/prts-terrarchive) | 20 | ⚪ unknown | 为明日方舟的长篇剧情打造的RAG类DSH插件，拥有多种快速检索能力。 |
| [dsh-superpower](https://github.com/Wenaixi/dsh-superpower) | 12 | 🟢 ok | DSH port of obra/superpowers — 完整移植、中文化、DSH 原生 |
| [dsh-council](https://github.com/a1exsun/dsh-council) | 16 | ⚪ unknown | Multi-model council for DeepSeek Harness: independent answers, anonymous peer reviews, and an inspectable final decision. |
...
| [oh-story-dsh](https://github.com/worldwonderer/oh-story-dsh) | 327 | ⚪ unknown | A DSH plugin for novel writing and short-drama production, powered by Oh Story and Drama Skills. |
...
| [oh-story-dsh](https://github.com/zenstory-ai/oh-story-dsh) | 327 | ⚪ unknown | A DSH plugin for novel writing and short-drama production, powered by Oh Story and Drama Skills. |
| [dsh-industry-research](https://github.com/PerryLink/dsh-industry-research) | 79 | 🟢 ok | Industry and company research domain pack for DeepSeek Harness: methodology skills, industry chain mapping, public-source policy/… |
...
| [whale-girl](https://github.com/vlln/whale-girl) | 318 | 🟢 ok | QQ-pet-style desktop pet plugin |
...
| [dsh-liang-skin](https://github.com/kingOfSoySauce/dsh-liang-skin) | 177 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | Liang-Stan adaptive reasoning slider skin (Jiankang Liang meme) for DeepSeek Harness |
...
| [dsh-im](https://github.com/xmanrui/dsh-im) | 1237 | 🟢 ok | 通过扫码把IM机器人接入DeepSeek Harness（支持飞书、微信、钉钉、QQ、企业微信等） |
...
| [dsh-whale-musume](https://github.com/Sutera-Diffusus/dsh-whale-musume) | 58 | 🟢 ok | DeepSeek Harness 桌宠插件：元气鲸鱼娘陪你写代码 🐋 |
...
| [DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 1960 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接喊来你的dsh安装 |
...
| [open-sea-skin](https://github.com/d-dev0101/open-sea-skin) | 316 | 🟢 ok | WebGPU ocean skin for DeepSeek Harness — DSH plugin, Harness-only Chrome/Edge extension, static installer, and native integration. |
...
| [dsh-codex-ui](https://github.com/MichengAI/dsh-codex-ui) | 62 | 🟢 ok | DSH Codex UI 基于 DeepSeek Harness 的 Codex UI 插件，还原度90%，小细节拉满 |
| [dsh-theme-endfield](https://github.com/ymh0000123/dsh-theme-endfield) | 74 | 🟢 ok | 终末地官网风格的 DSH Web 主题：奶油纸底、墨黑文字、信号黄强调、全直角工业编辑风。 |
...
| [dsh-agy-link](https://github.com/amlyczz/dsh-agy-link) | 51 | 🟢 ok | Google Antigravity (agy CLI) models for DeepSeek Harness — streaming chat, thinking, tool activity, usage, in-GUI Google OAuth lo… |
...
| [dsh-raw-html-v2](https://github.com/plolpl789/dsh-raw-html-v2) | 33 | ⚪ unknown | VCP visual-synesthesia plugin v2 for DeepSeek Harness (official Slot API): raw-HTML vcp-root cards, streaming render, KaTeX/Merma… |
...
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 292 | 🟢 ok | Cross-session long-term memory + background self-evolution |
...
| [plugin-session-export](https://github.com/whyihaveyou/dsh-suite) | 3 | 🟢 ok | Export the append-only session log as human-readable Markdown / HTML, grouped by trajectory source (system prompt / reasoning / t… |
| [dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) | 143 | 🟢 ok | Import chat history from Claude Code/Codex/Reasonix into DSH. |
...
| [dsh-memento](https://github.com/PerryLink/dsh-memento) | 105 | 🟢 ok | Bounded, layered, approval-gated, auditable cross-session memory for DeepSeek Harness (capability seam: ctx.memory + SQLite provi… |
...
| [dsh-mneme](https://github.com/modusensus/dsh-mneme) | 90 | 🟢 ok | dsh-mneme — DSH plugin (session) |
...
| [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) | 149 | 🟢 ok | Second-model AI auto-review for DeepSeek Harness approval requests: a read-only reviewer subagent returns structured allow/deny v… |
...
| [dsh-memory](https://github.com/FuRongJun-1999/dsh-memory) | 147 | 🟢 ok | Multi-agent spatiotemporal memory graph for DeepSeek Harness.Cross-session persistence, knowledge flywheel, importance-gated memo… |
...
| [dsh-files](https://github.com/taxueseek/dsh-files) | 34 | ⚪ unknown | DeepSeek Harness dual-face plugin: session-isolated file upload with colorful composer cards + read_document tool (text/PDF/DOCX/… |
...
| [MemOS](https://github.com/MemTensor/MemOS) | 11242 | ⚪ unknown | Self-evolving memory OS for LLM & AI Agents: ultra-persistent memory, hybrid-retrieval, and cross-task skill reuse, with 35.24% t… |
...
| [dsh-config-manager](https://github.com/xiajiajun516/dsh-config-manager) | 97 | 🟢 ok | Backup / export / import / migrate your DeepSeek Harness (DSH) configuration - dual-face Cordis plugin (host engine + Web UI). On… |
| [dsh-archive-manager](https://github.com/MichengAI/dsh-archive-manager) | 47 | 🟢 ok | DSH Archive Manager 基于 DeepSeek Harness 的归档会话管理插件 |
...
| [dsh-adult-tension](https://github.com/daha1216/dsh-adult-tension) | 23 | ⚪ unknown | DeepSeek Harness 成年人(18+/adult)互动叙事 Skill：NPC 活人感（有记忆/立场/底线）、自带破甲、数百项素材库、随机开局可预锁、时间推进、全维 YAML 存档。 |
...
| [dsh-model-context-catalog](https://github.com/HOWILLMAKEIT/dsh-model-context-catalog) | 22 | 🟢 ok | DeepSeek Harness 插件：维护 llm-pi-ai 模型的准确上下文窗口，避免长会话被误判为上下文溢出。 |
...
| [modlens](https://github.com/liustack/modlens) | 3922 | 🟢 ok | The first vision plugin for DeepSeek Harness — let text-only models see. |
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 1190 | ⚪ unknown | Vision toolbox & skills for text-only models: multi-image QA, UI reconstruction, GUI automation. |
...
| [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) | 169 | 🟢 ok | Unofficial DeepSeek Harness LLM provider plugin for Command Code: live model catalog, reasoning-effort support, Models-page card.… |
...
| [deepseek-harness-studio](https://github.com/fufankeji/deepseek-harness-studio) | 621 | ⚪ unknown | DeepSeek Harness Studio：面向 DeepSeek Harness 的现代化桌面开发环境，内置插件中心、视觉增强与本地 Host。 |
...
| [dsh-imagegen](https://github.com/dickpy/dsh-imagegen) | 58 | 🟢 ok | DSH (DeepSeek Harness) Web GUI AI image generation plugin: text-to-image & image-to-image via OpenAI-compatible endpoints (gpt-im… |
...
| [dsh-image-gen](https://github.com/shanliuling/dsh-image-gen) | 362 | 🟢 ok | Installable multi-provider image generation bundle for DeepSeek Harness (Google Gemini, OpenAI, Volcengine Seedream) |
...
| [dsh-purge](https://github.com/YuJunZhiXue/dsh-purge) | 487 | 🟢 ok | DeepSeek Harness 破甲：让所有模型都能破甲，不同模型可换不同提示词；默认提示词面向国模「小码酱」。Jailbreak for every model — swap prompts per model. 求 Star 收藏 ⭐ |
...
| Plugin | ⭐ | Compat | Description |
|---|---|---|---|
| [openhanako](https://github.com/liliMozi/openhanako) | 6519 | ⚪ unknown | Personal AI agent with memory, personality and autonomy |
| [exo](https://github.com/exoharness/exo) | 1369 | ⚪ unknown | Fully recursive agent+harness that self-edits at runtime |
| [synergy](https://github.com/SII-Holos/synergy) | 490 | ⚪ unknown | General-purpose agent for the Open Agentic Web |
| [ccteam](https://github.com/firstintent/ccteam) | 482 | ⚪ unknown | Orchestrates Claude Code/Codex/Grok/Kimi into one team |
...
| [distill](https://github.com/LoserFox/distill) | 24 | ⚪ unknown | Auto conversation distillation: background subagent reflection |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1474 | 🟢 ok | AgentTeams plugin |
...
| [Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 3214 | ⚪ unknown | VibeSkills is a general-purpose Skill that automatically routes local Skills and intelligently orchestrates harness workflows. |
...
| [dsh-zotero](https://github.com/Vncntvx/dsh-zotero) | 14 | 🟢 ok | Let agents search, read, and cite your local Zotero library: find papers, browse notes and annotations, pull evidence by question… |
...
| [dsh-tavern](https://github.com/flizzywine/dsh-tavern) | 192 | 🟢 ok | 基于 DeepSeek Harness（DSH）的 SillyTavern 类文字游戏 Agent，支持候选项生成、对话式人物卡编辑、剧本模式与素材抽取。 |
...
| [dsh-ego-browser](https://github.com/Fisfzy/dsh-ego-browser) | 135 | 🟢 ok | DSH（DeepSeek Harness）插件：把 ego-lite 浏览器（给 AI Agent 用的 Chromium）接入 HARNESS——13 个结构化 ego_* 工具（文本语义快照、语义定位点击、表单填充、截图、CDP 控制、任务空间隔离），内… |
...
| [dsh-Mimir-Academic-research](https://github.com/1692775560/dsh-Mimir-Academic-research) | 265 | ⚪ unknown | Mimir — 一站式科研工作台插件：LaTeX 论文边写边编译、arXiv 文献管理、实验追踪、指标图表、GPU 服务器 SSH 任务编排，管理科研全周期。An open-source research workbench plugin for the w… |
...
| [loopx](https://github.com/huangruiteng/loopx) | 5750 | ⚪ unknown | Long-horizon agent control plane for durable, governed work across Codex, Claude Code, and other harnesses. |
...
| [dsh-ultramath](https://github.com/Andiii208/dsh-ultramath) | 17 | 🟢 ok | UltraMath 数学建模竞赛多 Agent 求解 DSH 插件: 5 角色预设 + 33 篇模型库 + 论文模板/审稿脚本随包 + 进度可视化 |
...
| [pi-web-ui](https://github.com/xing-shuyin/pi-web-ui) | 131 | ⚪ unknown | dsh / pi-agent web ui |
...
| [dsh-hub-cli](https://github.com/pax-beehive/dsh-hub-cli) | 271 | ⚪ unknown | Open-source CLI, schemas, resolver, and DSH agent tools for DSH Plugin Hub |
| [dsh-trading](https://github.com/zhu1090093659/dsh-trading) | 149 | ⚪ unknown | Agent-native trading terminal built on DeepSeek Harness. Crypto, US, CN and HK in one three-column GUI, 19+ hot-swappable connect… |
| [dsh-evolve-in-git](https://github.com/Kytolly/dsh-evolve-in-git) | 20 | ⚪ unknown | A deepseek-harness plugin, making your agent evolve in customed git repository. |
...
| [Openwrite](https://github.com/LiPu-jpg/Openwrite) | 698 | ⚪ unknown | dsh-Openwrite：OpenWrite 的 DeepSeek Harness 小说创作插件，含统一创作 Agent、90 个小说工具、原生工作台与标准审稿 DAG |
...
| [dsh-lsp-actions](https://github.com/PerryLink/dsh-lsp-actions) | 18 | 🟢 ok | LSP action surface for DeepSeek Harness: lsp_diagnostics, lsp_format, and lsp_completion tools over language servers |
...
| [deepseek-harness-mobile](https://github.com/sorsama/deepseek-harness-mobile) | 66 | ⚪ unknown | Android companion for DeepSeek Harness | chat, goals, approvals & notifications from your phone, over your LAN. Kotlin + Jetpack… |
...
| [dsh-pocket](https://github.com/shaobeichen/dsh-pocket) | 1033 | 🟢 ok | 把 DeepSeek Harness 装进你的口袋：电脑上跑 dsh web，手机扫码即同步访问（局域网 + 公网，实时同屏） |
...
| [dsh-proxy](https://github.com/smanx/dsh-proxy) | 18 | ⚪ unknown | HTTP + WebSocket 反向代理：把局域网端口转发到本地 DSH 服务 |
...
| [dsh-mobile](https://github.com/saya-ch/dsh-mobile) | 243 | 🟢 ok | DeepSeek Harness 移动端适配与安全局域网访问插件，支持 Android App 和手机浏览器。 |
...
| [dsh-remote-web-gateway](https://github.com/summer1238/dsh-remote-web-gateway) | 141 | 🟢 ok | 手机远程 DeepSeek Harness：扫码即可继续使用电脑上的 DSH，无需远程桌面 / SSH / 公网 IP，支持一次性配对、独立设备授权与随时撤销。 |
...
| [dsh-remote](https://github.com/SCSpotato/dsh-remote) | 64 | 🟢 ok | Native Android client to remotely control DeepSeek Harness (DSH) from your phone |
...
| Plugin | ⭐ | Compat | Description |
|---|---|---|---|
| [EchoBird](https://github.com/edison7009/EchoBird) | 3186 | ⚪ unknown | One-click install + model switch across 20+ coding agents |
...
| [awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 1027 | ⚪ unknown | DSH ecosystem curation: plugins, tools, infra |
...
| [dsh-launcher](https://github.com/Ruler4396/dsh-launcher) | 199 | 🟢 ok | WebView2-based DSH launcher |
...
> 1857 entries total, grouped by category, sorted by ⭐ within each. Schema dictionary: [docs/catalog-schema.md](docs/catalog-schema.md).
<!-- CATALOG:END -->
