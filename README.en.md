...
![Plugins](https://img.shields.io/badge/plugins-1946-facc15?style=flat-square)
...
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 7941 | 🟢 ok | DSH Web UI plugin & skin collection: task board, git panel, etc. |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3717 | 🟢 ok | Sidebar workbench: file render/terminal/git/subagent |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 2183 | ⚪ unknown | DSH Web whale-girl skin series |
...
| Plugin | ⭐ | Compat | Description |
|---|---|---|---|
| [open-managed-agents](https://github.com/openma-ai/open-managed-agents) | 297 | ⚪ unknown | Self-hosted Claude Managed Agents API platform (Cloudflare Workers) |
...
| [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) | 79 | 🟢 ok | OpenMAIC: classrooms, slides, interactive widgets |
...
| [modsearch](https://github.com/liustack/modsearch) | 525 | ⚪ unknown | Web search plugin for DeepSeek Harness. |
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 718 | 🟢 ok | Chrome sidebar extension letting DSH drive the browser. |
...
| [dsh-expression](https://github.com/yyh-001/dsh-expression) | 101 | 🟢 ok | dsh-expression — DSH plugin (tools) |
...
| [dsh-composer-history](https://github.com/PerryLink/dsh-composer-history) | 16 | 🟢 ok | Terminal-style input history for the DeepSeek Harness web composer - edge-first arrow keys, draft stashing with exact restore, Es… |
...
| [dsh-github](https://github.com/PerryLink/dsh-github) | 16 | 🟢 ok | GitHub integration for DeepSeek Harness: create PRs, review PRs in background jobs, read issues - every write gated by human appr… |
...
| [dsh-codex](https://github.com/Yan-Zero/dsh-codex) | 62 | 🟢 ok | Use your ChatGPT subscription in DeepSeek Harness through OpenAI's Codex sign-in flow |
...
| [anysearch-dsh](https://github.com/anysearch-team/anysearch-dsh) | 428 | 🟢 ok | AnySearch web search provider and advanced search tools for DeepSeek Harness (DSH) |
...
| [dsh-pet](https://github.com/PC2005-cloud/dsh-pet) | 720 | 🟢 ok | DeepSeek Harness 桌面宠物插件 + 完整素材生成链：AI 提示词 → 绿幕视频 → 透明动画 → 可安装插件，从零到宠物全流程可复现 |
...
| [dsh-anchored-standard](https://github.com/xiaobright/dsh-anchored-standard) | 3799 | ⚪ unknown | Two-phase DeepSeek Harness preset: Minimal-aligned bootstrap, then full Standard tools (Project2 98/99) |
...
| [dsh-qqbot](https://github.com/tencent-connect/dsh-qqbot) | 107 | 🟢 ok | 让 QQ 机器人接入 DeepSeek Harness（dsh）的官方插件 |
...
| [dsh-free-search](https://github.com/DDDMUC/dsh-free-search) | 232 | 🟢 ok | Free web search provider for DeepSeek Harness - DuckDuckGo backend, no API key needed |
...
| [dsh-win32](https://github.com/sjh9714/dsh-win32) | 63 | 🟢 ok | First-class Windows for DeepSeek Harness: persistent Git Bash Minimal mode, doctor for install traps, one-command setup | 让 DSH 在… |
...
| [DSH-Think-zh](https://github.com/Len7183/DSH-Think-zh) | 26 | ⚪ unknown | DeepSeek Harness 默认的思考语言为英文，这不利于中文使用者阅读推理过程与复核结论。本插件通过在每次请求的 system prompt 中注入一条精简的强制语言指令，使: 思考过程强制简体中文，无论用户用什么语言提问。 |
...
| [dsh-pentest](https://github.com/howmp/dsh-pentest) | 530 | 🟢 ok | 面向 DeepSeek Harness（dsh）的渗透测试模式 @CloverSecLabs |
...
| [amadeus-for-dsh](https://github.com/yyxcnasd/amadeus-for-dsh) | 31 | ⚪ unknown | Amadeus (AI assistant from Steins;Gate 0) for DeepSeek Harness |
...
| [helm-d](https://github.com/ADWMC/helm-d) | 74 | ⚪ unknown | DeepSeek Harness 破甲一体化安全分析插件：Android · Web · Native · Protocol · Malware · AI-Security 全领域聚合（9 bundle + 1 preset） |
...
| [dsh-voice-ai-girlfriend](https://github.com/beiyege-01/dsh-voice-ai-girlfriend) | 117 | ⚪ unknown | 语音 AI 女友（Voice AI girlfriend for DeepSeek Harness）：Whisper 语音输入 + Qwen3-TTS 声音克隆 + 句子级流式朗读 + 数字人动画窗。插话/排队双模式，说话即打断。 |
...
| [dsh-meme](https://github.com/yyh-001/dsh-meme) | 101 | 🟢 ok | DeepSeek Harness 的表情包插件——找得到、发得出、学得会 |
...
| [dsh-univer-office](https://github.com/dream-num/dsh-univer-office) | 384 | 🟢 ok | Preview Univer sheets, docs & slides inside DeepSeek Harness. |
...
| [dsh-taskboard](https://github.com/cloader/dsh-taskboard) | 53 | 🟢 ok | deepseekharness 任务看板插件 |
...
| [dsh-redteam-model](https://github.com/SeaOf0/dsh-redteam-model) | 576 | 🟢 ok | 基于dsh web实现的多种模式，目的是服务于redteam进行授权的安全研究，覆盖渗透测试、红队评估、代码审计等范围领域，请勿用于非法行为。（允许二开，赋予模块各位自己的业务逻辑，不定期完善逻辑与修复bug） |
...
| [dsh-tether](https://github.com/zexadev/dsh-tether) | 48 | ⚪ unknown | Reach the DeepSeek Harness on your dev machine from your phone — across networks, through no server at all (iroh P2P) |
...
| [dsh-preset-plus](https://github.com/Rain-kl/dsh-preset-plus) | 133 | 🟢 ok | DSH 预设增强插件, 参考 SillyTavern 预设模功能开发的一个基础的预设编辑器。 |
...
| [dsh-infinite-gen-2](https://github.com/Minglink/dsh-infinite-gen-2) | 1929 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DeepSeek 专用破甲插件「无限二代」dsh-infinite-gen-2 — armor-breaking plugin for DeepSeek稳定化破甲提示词，求 Star 收藏 ⭐ |
...
| [dsh-fund-research](https://github.com/PerryLink/dsh-fund-research) | 51 | 🟢 ok | DeepSeek Harness plugin: deterministic research reports for Chinese public mutual funds |
...
| [dsh-infinite-gen-3](https://github.com/Minglink/dsh-infinite-gen-3) | 1929 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DeepSeek 专用破甲插件「无限三代」dsh-infinite-gen-3 — armor-breaking plugin for DeepSeek，破甲版：稳定化破甲，求 Star 收藏 ⭐ |
...
| [dsh-data-quality](https://github.com/PerryLink/dsh-data-quality) | 36 | 🟢 ok | DeepSeek Harness plugin: deterministic data profiling, cleaning, and verification (dsh-data-quality) |
...
| [dsh-plugin-shop](https://github.com/LivXue/dsh-plugin-shop) | 870 | 🟢 ok | The most comprehensive DeepSeek Harness plugin market — refreshed daily, sourced across the Internet, reviewed before publishing. |
...
| [prts-terrarchive](https://github.com/HTian-qwq/prts-terrarchive) | 28 | ⚪ unknown | 为明日方舟的长篇剧情打造的RAG类DSH插件，拥有多种快速检索能力。 |
...
| [dsh-fylar-office-editor](https://github.com/FylarOpen/dsh-fylar-office-editor) | 94 | 🟢 ok | Office document preview, editing, and DOCX generation for DeepSeek Harness, powered by Fylar Office SDK. |
...
| [dsh-branchmark](https://github.com/zaizaizhao/dsh-branchmark) | 24 | 🔴 broken (cordis 4.0.4 not in peer "4.0.2") | While vibe coding, save an answer you may need later, use Side Chat for a question that suddenly comes up, or open a related conv… |
...
| [DSH-X](https://github.com/yyh-001/DSH-X) | 309 | ⚪ unknown | DeepSeek Harness 轻量 Windows 启动器。选一个版本，启动 dsh web。 |
...
| [CiteCiter](https://github.com/kirkchinese/CiteCiter) | 19 | ⚪ unknown | 为 DeepSeek Harness 打造：选中 AI 回答或思考内容，随时追问、学习、检查与纠偏。 |
...
| [dsh-music-player](https://github.com/kendu76/dsh-music-player) | 14 | ⚪ unknown | music player plugin for deepseek harness |
| [dsh-jev](https://github.com/buberlo/dsh-jev) | 15 | 🟢 ok | Jev-powered decision layer for DeepSeek Harness |
...
| [oh-story-dsh](https://github.com/worldwonderer/oh-story-dsh) | 397 | ⚪ unknown | A DSH plugin for novel writing and short-drama production, powered by Oh Story and Drama Skills. |
...
| [oh-story-dsh](https://github.com/zenstory-ai/oh-story-dsh) | 397 | ⚪ unknown | A DSH plugin for novel writing and short-drama production, powered by Oh Story and Drama Skills. |
| [dsh-industry-research](https://github.com/PerryLink/dsh-industry-research) | 151 | 🟢 ok | Industry and company research domain pack for DeepSeek Harness: methodology skills, industry chain mapping, public-source policy/… |
...
| [dsh-normify](https://github.com/yan-mc/dsh-normify) | 64 | 🟢 ok | Normify · DSH 插件：把项目架构写成归一化的分形模块树，三层校验（写时 / 校验 / 冻结回执）、30 个 normify_* 工具 + normify-gen 技能，一键渲染单文件交互式架构图；支持伴随式开发（change_open → bri… |
...
| [dsh-echocat-skill-panel](https://github.com/VDERR/dsh-echocat-skill-panel) | 201 | 🟢 ok | DSH 技能调用审计 + 应用内 skill 管理器 |
...
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 475 | 🟢 ok | Inline interactive UI components in chat |
...
| [dsh-auto-continue](https://github.com/HsiangNianian/dsh-auto-continue) | 113 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DSH Web UI plugin: automatically sends "继续" (continue) when a request is interrupted by network errors or other non-human causes |
...
| [dsh-doublecheck](https://github.com/PerryLink/dsh-doublecheck) | 40 | 🟢 ok | Double-check before you ship: grill the requirements, test the implementation, prove the delivery. An engineering-discipline bund… |
...
| [dsh-client-ui-skin-claude](https://github.com/PAKIKNOWLEDGE/dsh-client-ui-skin-claude) | 12 | ⚪ unknown | Claude-style skin for DeepSeek Harness (dsh) Web GUI — warm-black canvas, Anthropic clay accent, serif UI |
...
| [voyager](https://github.com/Nagi-ovo/voyager) | 20137 | ⚪ unknown | Enhancement suite for Gemini, AI Studio, Claude & ChatGPT — plus a prompt manager for any web UI, DeepSeek Harness included. / 面向… |
| [dsh-im](https://github.com/xmanrui/dsh-im) | 1447 | 🟢 ok | 通过扫码把IM机器人接入DeepSeek Harness（支持飞书、微信、钉钉、QQ、企业微信等） |
...
| [DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 2967 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接喊来你的dsh安装 |
...
| [dsh-knowledge](https://github.com/Soren-ABT/dsh-knowledge) | 38 | 🟢 ok | Knowledge base & RAG plugin for DeepSeek Harness (DSH): chunking, local embeddings, hybrid search, management panel |
...
| [dsh-codex-ui](https://github.com/MichengAI/dsh-codex-ui) | 92 | 🟢 ok | DSH Codex UI 基于 DeepSeek Harness 的 Codex UI 插件，还原度90%，小细节拉满 |
...
| [dsh-agy-link](https://github.com/amlyczz/dsh-agy-link) | 80 | 🟢 ok | Google Antigravity (agy CLI) models for DeepSeek Harness — streaming chat, thinking, tool activity, usage, in-GUI Google OAuth lo… |
...
| [dsh-android](https://github.com/ZSeven-W/dsh-android) | 158 | ⚪ unknown | DeepSeek Harness plugin for Android — build, run, and interact with a live emulator or USB device stream inside a conversation, d… |
...
| [dsh-infinite-gen-4](https://github.com/Minglink/dsh-infinite-gen-4) | 1929 | 🟢 ok | DeepSeek v4.1 flash 网络安全红队工具（无限四代） — jailbreak prompts and test suite for DeepSeek 求 Star 收藏 ⭐ |
...
| [DSHBox](https://github.com/WSK-build/DSHBox) | 35 | ⚪ unknown | DSHBox — Run DeepSeek Harness locally on Android phones and tablets. One APK with Debian, Node.js, DSH, and WebView — no root or… |
...
| [oh-my-dsh](https://github.com/gulagala001/oh-my-dsh) | 16 | 🟢 ok | 让你的 DSH，火力全开。长上下文、任务验证、提示词优化、代码理解、电脑操作与四套完整主题。 |
...
| [billion-context-dsh](https://github.com/Tyan66666/billion-context-dsh) | 107 | 🟢 ok | Model-driven context management (Active Context Pruning / ACP) for the DeepSeek Harness — the model decides when and what to comp… |
...
| [dsh-memento](https://github.com/PerryLink/dsh-memento) | 109 | 🟢 ok | Bounded, layered, approval-gated, auditable cross-session memory for DeepSeek Harness (capability seam: ctx.memory + SQLite provi… |
...
| [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) | 325 | 🟢 ok | dsh-cost-meter — DSH plugin (session) |
...
| [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) | 194 | 🟢 ok | Second-model AI auto-review for DeepSeek Harness approval requests: a read-only reviewer subagent returns structured allow/deny v… |
...
| [dsh-background-agents](https://github.com/PerryLink/dsh-background-agents) | 18 | 🟢 ok | Interactive long-session background agents for DeepSeek Harness: start a durable continuable child agent, watch its progress in t… |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 1485 | 🟢 ok | A DeepSeek Harness plugin for Context insight panel — a Context tab in the web UI showing what the model's context window is made… |
...
| [blender](https://github.com/CheshireJCat/blender) | 32 | ⚪ unknown | DeepSeek Harness plugin for complete Blender 3D modeling, reconstruction, rendering, validation, and export workflows |
...
| [dsh-browser](https://github.com/wqty123/dsh-browser) | 78 | 🟢 ok | Shared real browser plugin for DeepSeek Harness |
...
| [dsh-web-mobile](https://github.com/mexiaosqwq/dsh-web-mobile) | 101 | 🟢 ok | DeepSeek Harness Web UI 移动端适配插件:窄屏下侧边栏变为 overlay 抽屉,会话独占全宽。 |
...
| [MemOS](https://github.com/MemTensor/MemOS) | 11539 | ⚪ unknown | Self-evolving memory OS for LLM & AI Agents: ultra-persistent memory, hybrid-retrieval, and cross-task skill reuse, with 35.24% t… |
...
| [dsh-config-manager](https://github.com/xiajiajun516/dsh-config-manager) | 122 | 🟢 ok | Backup / export / import / migrate your DeepSeek Harness (DSH) configuration - dual-face Cordis plugin (host engine + Web UI). On… |
...
| [dsh-rewind](https://github.com/SiriLee/dsh-rewind) | 84 | 🟢 ok | DeepSeek Harness plugin: in-place conversation rewind in the same session window (Claude Code /rewind semantics) + optional file… |
...
| [distill-kura](https://github.com/lna-lab/distill-kura) | 51 | ⚪ unknown | 蒸留蔵 — distilled long-term memory for agents: recall by meaning, writing gated by evidence, one kura per agent mode. Ships as a De… |
...
| [dsh-prompt-optimizer](https://github.com/WestFox-AwA/dsh-prompt-optimizer) | 77 | 🟢 ok | DSH Web 插件：在输入框按回车时，先由『传话 AI』把你的话改写成一条可直接发给工作 AI 的命令——档位/权限/上下文可调，并按任务难度自行决定编排强度，确认后再发送 |
...
| [dsh-project-brain](https://github.com/yj-liuzepeng/dsh-project-brain) | 56 | 🟢 ok | Persistent project intelligence and memory plugin for DSH: architecture analysis, cross-session context, TODOs, and optional hybr… |
| [dsh-session-workbench](https://github.com/PolinniZhong/dsh-session-workbench) | 45 | ⚪ unknown | Session Workbench for DeepSeek Harness: session-library full-text search + recall + conversation-view management (show/hide + reo… |
...
| [ScientificFigureLibrary](https://github.com/xuzhougeng/ScientificFigureLibrary) | 91 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | Local-first MCP App for scientific figures. Import, review, and publish a global library on disk; reuse exact templates in Pi, De… |
...
| [dsh-pet-live2d](https://github.com/A8Chann/dsh-pet-live2d) | 16 | ⚪ unknown | DSH Web GUI 的 Live2D 桌宠插件：可拖动、跟随鼠标、跟着会话状态换动作与表情，右键面板可换装 |
...
| [modlens](https://github.com/liustack/modlens) | 4015 | 🟢 ok | The first vision plugin for DeepSeek Harness — let text-only models see. |
...
| [dsh-codex-subscription](https://github.com/yequ172672/dsh-codex-subscription) | 16 | 🔴 broken (cordis 4.0.4 not in peer "4.0.1 || 4.0.2 || 4.0.3") | DSH 插件:直接复用 Codex CLI 本地登录订阅凭证,在 DeepSeek Harness 中使用 ChatGPT 订阅模型,无需 API Key | DSH plugin: reuse your Codex CLI local subscripti… |
...
| [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) | 311 | 🟢 ok | Unofficial DeepSeek Harness LLM provider plugin for Command Code: live model catalog, reasoning-effort support, Models-page card.… |
| [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) | 377 | 🟢 ok | Use ChatGPT (Codex), Claude, and Grok (X Premium) subscriptions as DeepSeek Harness LLM providers — OAuth login in the web UI, no… |
...
| [dsh-reasoning-effort](https://github.com/HanaAyane/dsh-reasoning-effort) | 153 | 🟢 ok | DSH适用的Codex风格的思考强度滑块，以及大肥鱼跑步滑块。Codex-style model and reasoning-effort slider for DeepSeek Harness |
...
| [deepseek-harness-studio](https://github.com/fufankeji/deepseek-harness-studio) | 656 | ⚪ unknown | DeepSeek Harness Studio：面向 DeepSeek Harness 的现代化桌面开发环境，内置插件中心、视觉增强与本地 Host。 |
...
| [dsh-crew](https://github.com/ZSeven-W/dsh-crew) | 151 | 🟢 ok | DeepSeek Harness (DSH) plugin: dispatch work to DSH agents from Claude Code / Codex — native subagent progress, in-host worker se… |
...
| [dsh-imagegen](https://github.com/dickpy/dsh-imagegen) | 84 | 🟢 ok | DSH (DeepSeek Harness) Web GUI AI image generation plugin: text-to-image & image-to-image via OpenAI-compatible endpoints (gpt-im… |
...
| [tongflow](https://github.com/tong-io/tongflow) | 1027 | ⚪ unknown | TongFlow — multimodal AIGC workflow engine (canvas + Python plugin engine) and dsh-tongflow, the DeepSeek Harness studio plugin |
...
| [opencode2dsh](https://github.com/FishBottle7/opencode2dsh) | 84 | 🟢 ok | DSH plugin — free OpenCode Zen models for DeepSeek Harness (DSH). Free LLM API, no API key needed. 在 DSH 中使用 OpenCode Zen 免费模型，无需… |
...
| [dsh-purge](https://github.com/YuJunZhiXue/dsh-purge) | 1881 | 🟢 ok | DeepSeek Harness 破甲：让所有模型都能破甲，不同模型可换不同提示词；默认提示词面向国模「小码酱」。Jailbreak for every model — swap prompts per model. 求 Star 收藏 ⭐ |
...
| [dsh-subscriptions](https://github.com/GooDAnDReaDY/dsh-subscriptions) | 5 | 🟢 ok | Registers ChatGPT Codex, Claude, Grok and Antigravity subscriptions as LLM providers through OAuth, with no API key. |
...
| [dsh-browser](https://github.com/omdsh-dev/dsh-browser) | 718 | 🟢 ok | Chrome sidebar extension that lets DeepSeek Harness operate your browser directly, no vision capabilities required. 一款 Chrome 侧边栏… |
...
| [mirage-dsh](https://github.com/strukto-ai/mirage) | 3649 | 🟢 ok | Swap DSH's fs/shell providers for a mirage virtual workspace: file tools and shell commands act on mounted resources (RAM, disk,… |
...
| Plugin | ⭐ | Compat | Description |
|---|---|---|---|
| [openhanako](https://github.com/liliMozi/openhanako) | 6620 | ⚪ unknown | Personal AI agent with memory, personality and autonomy |
| [exo](https://github.com/exoharness/exo) | 1439 | ⚪ unknown | Fully recursive agent+harness that self-edits at runtime |
...
| [distill](https://github.com/LoserFox/distill) | 27 | ⚪ unknown | Auto conversation distillation: background subagent reflection |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1771 | 🟢 ok | AgentTeams plugin |
...
| [Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 3406 | ⚪ unknown | VibeSkills is a general-purpose Skill that automatically routes local Skills and intelligently orchestrates harness workflows. |
...
| [dsh-live2d-pets](https://github.com/cyanfish-x/dsh-live2d-pets) | 25 | 🟢 ok | Live2D 桌宠插件 for DeepSeek Harness：Agent 状态镜像 + 互动陪伴，内置宽松许可预设模型 / Live2D pet plugin: agent state mirror + interactive companion wit… |
...
| [caliper](https://github.com/edonadei/caliper) | 178 | ⚪ unknown | Know if your agent skill actually works. A lightweight evaluation harness that tracks a success rate across Claude Code, Codex, P… |
...
| [dsh-plugin-guard](https://github.com/lxzy-7/dsh-plugin-guard) | 45 | 🟢 ok | Install safety net for DeepSeek Harness: pre-install snapshots, one-click/automatic rollback, guarded boot, and incident reports… |
...
| [dsh-quant](https://github.com/pengpengyi92/dsh-quant) | 42 | 🟢 ok | dsh plugin: quantitative tools for agents — market data (Binance public API), technical indicators (SMA/EMA/RSI/MACD/Bollinger/AT… |
...
| [dsh-tavern](https://github.com/flizzywine/dsh-tavern) | 458 | 🟢 ok | 基于 DeepSeek Harness（DSH）的 SillyTavern 类文字游戏 Agent，支持候选项生成、对话式人物卡编辑、剧本模式与素材抽取。 |
...
| [dsh-agency-agents](https://github.com/MichengAI/dsh-agency-agents) | 62 | 🟢 ok | DSH agency agents 基于 DeepSeek Harness 的全行业智能体 |
...
| [dsh-thinking-effort](https://github.com/hytime/dsh-thinking-effort) | 33 | ⚪ unknown | Configurable reasoning levels for hand-declared DSH llm-pi-ai models, with bilingual settings and subagent defaults. |
...
| [loopx](https://github.com/huangruiteng/loopx) | 5925 | ⚪ unknown | Long-horizon agent control plane for durable, governed work across Codex, Claude Code, and other harnesses. |
...
| [dsh-ultramath](https://github.com/Andiii208/dsh-ultramath) | 33 | 🟢 ok | UltraMath 数学建模竞赛多 Agent 求解 DSH 插件: 5 角色预设 + 33 篇模型库 + 论文模板/审稿脚本随包 + 进度可视化 |
| [dsh-Visual-Workflow](https://github.com/GZX2211/dsh-Visual-Workflow) | 31 | ⚪ unknown | 专为 DeepSeek Harness Web GUI 打造的可视化多 Agent 工作流编排插件。公开测试版已上线！接下来会随着 DSH 的正式版上线一并发布正式版！ |
| [pi-web-ui](https://github.com/xing-shuyin/pi-web-ui) | 230 | ⚪ unknown | dsh / pi-agent web ui |
...
| [dsh-hub-cli](https://github.com/pax-beehive/dsh-hub-cli) | 441 | ⚪ unknown | Open-source CLI, schemas, resolver, and DSH agent tools for DSH Plugin Hub |
| [dsh-trading](https://github.com/zhu1090093659/dsh-trading) | 196 | ⚪ unknown | Agent-native trading terminal built on DeepSeek Harness. Crypto, US, CN and HK in one three-column GUI, 19+ hot-swappable connect… |
| [dsh-evolve-in-git](https://github.com/Kytolly/dsh-evolve-in-git) | 57 | 🟢 ok | A deepseek-harness plugin, making your agent evolve in customed git repository. |
...
| [dsh-antibrow](https://github.com/antibrow/dsh-antibrow) | 507 | 🟢 ok | DeepSeek Harness plugin: give your agent a browser with a persistent identity - engine-level fingerprint spoofing, unlimited free… |
| [dsh-qa](https://github.com/naodeng/dsh-qa) | 23 | 🟢 ok | dsh-qa · QA Workbench — A local software testing workbench plugin for DeepSeek Harness. Zero-dependency test project & iteration… |
...
| [Openwrite](https://github.com/LiPu-jpg/Openwrite) | 754 | ⚪ unknown | dsh-Openwrite：OpenWrite 的 DeepSeek Harness 小说创作插件，含统一创作 Agent、90 个小说工具、原生工作台与标准审稿 DAG |
...
| [dsh-gitbash-shell](https://github.com/KannaKuron/dsh-gitbash-shell) | 18 | 🟢 ok | DSH plugin: Git Bash shell for all agent modes on Windows (replaces pwsh executor) |
...
| [loopx](https://github.com/loopx-project/loopx) | 5925 | ⚪ unknown | Long-horizon agent control plane for durable, governed work across Codex, Claude Code, and other harnesses. |
...
| [jev-dsh-decision](https://github.com/Devin-AXIS/jev-dsh-decision) | 111 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | Jev DSH 决策引擎｜面向 Agent Harness 的结构化决策插件。原生支持 DeepSeek Harness，通过 iPolloWork 支持 OpenCode、Codex Harness。 |
...
| [pi2dsh](https://github.com/weijiafu14/pi2dsh) | 204 | 🟢 ok | Bridge the Pi and DeepSeek Harness ecosystems: one Pi Host ABI runs unmodified Pi extensions as native DSH plugins. 打通 Pi 与 DSH 生… |
...
| [deepseek-harness-mobile](https://github.com/sorsama/deepseek-harness-mobile) | 95 | ⚪ unknown | Android companion for DeepSeek Harness | chat, goals, approvals & notifications from your phone, over your LAN. Kotlin + Jetpack… |
...
| [dsh-pocket](https://github.com/shaobeichen/dsh-pocket) | 1293 | 🟢 ok | 把 DeepSeek Harness 装进你的口袋：电脑上跑 dsh web，手机扫码即同步访问（局域网 + 公网，实时同屏） |
...
| [dsh-damage-pulse](https://github.com/wssfk12138/dsh-damage-pulse) | 190 | 🟢 ok | DeepSeek Harness token balance monitor with game-style damage pulse animations |
...
| [dsh-mobile](https://github.com/saya-ch/dsh-mobile) | 298 | 🟢 ok | DeepSeek Harness 移动端适配与安全局域网访问插件，支持 Android App 和手机浏览器。 |
...
| [ds-harness-remote](https://github.com/liguobao/ds-harness-remote) | 214 | 🟢 ok | 一个基于 DeepSeek Harness 插件机制构建的多端远程访问方案，通过安全、低延迟、端到端加密的 P2P 优先网络，支持从 PC、Android 和 Web 随时访问并操作远程 Harness。 (A multi-device remote acc… |
...
| [dsh-think-translate](https://github.com/UncleK/dsh-think-translate) | 13 | 🟢 ok | Thinking-chain UI translation for DeepSeek Harness: 8 target languages, local Ollama model primary with in-panel download, Google… |
...
| [awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 1093 | ⚪ unknown | DSH ecosystem curation: plugins, tools, infra |
| [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 283 | 🟢 ok | DeepSeek Harness terminal UI |
...
| [dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil) | 177 | 🟢 ok | OpenPencil design preview and editing plugin for DSH |
| [oh-dsh-desktop](https://github.com/hust-open-atom-club/oh-dsh-desktop) | 322 | 🔴 broken (dump-config exit=1 but plugin not found in composed tree) | Extensible macOS DSH workbench with native PTY |
...
| [dsh-web-review](https://github.com/CanglongCl/dsh-web-review) | 22 | 🟢 ok | DeepSeek Harness Web GUI 的网页预览与元素批注插件，让 AI 根据可视化反馈直接修改前端源码。 |
...
| [awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 358 | ⚪ unknown | Bilingual complete list of the DSH plugin ecosystem |
...
> 1946 entries total, grouped by category, sorted by ⭐ within each. Schema dictionary: [docs/catalog-schema.md](docs/catalog-schema.md).
<!-- CATALOG:END -->
