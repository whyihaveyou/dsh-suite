...
![Plugins](https://img.shields.io/badge/plugins-1943-facc15?style=flat-square)
...
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 7922 | 🟢 ok | DSH Web UI plugin & skin collection: task board, git panel, etc. |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3706 | 🟢 ok | Sidebar workbench: file render/terminal/git/subagent |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 2177 | ⚪ unknown | DSH Web whale-girl skin series |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 394 | 🟢 ok | Mnemon three-layer memory deep integration |
...
| [ego-browser](https://github.com/Fisfzy/ego-browser) | 185 | 🟢 ok | Bridge ego-lite Chromium browser into DSH |
...
| [modsearch](https://github.com/liustack/modsearch) | 522 | ⚪ unknown | Web search plugin for DeepSeek Harness. |
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 712 | 🟢 ok | Chrome sidebar extension letting DSH drive the browser. |
...
| [dsh-doctor](https://github.com/jorinyang/dsh-doctor) | 5 | 🟢 ok | DeepSeek Harness environment diagnostic tool: dsh_doctor checks env, profile, config, bundles, mount, port, health, and disk |
...
| [dsh-codex-connect](https://github.com/franksong2702/dsh-codex-connect) | 115 | 🟢 ok | ChatGPT OAuth and Codex models for DeepSeek Harness. |
...
| [dsh-codex-subscription](https://github.com/WSL043/dsh-codex-subscription) | 87 | 🟢 ok | Cache-aware ChatGPT / Codex subscription plugin for DeepSeek Harness |
...
| [anysearch-dsh](https://github.com/anysearch-team/anysearch-dsh) | 426 | 🟢 ok | AnySearch web search provider and advanced search tools for DeepSeek Harness (DSH) |
...
| [dsh-pet](https://github.com/PC2005-cloud/dsh-pet) | 711 | 🟢 ok | DeepSeek Harness 桌面宠物插件 + 完整素材生成链：AI 提示词 → 绿幕视频 → 透明动画 → 可安装插件，从零到宠物全流程可复现 |
...
| [plugin-deus (神模扳机)](https://github.com/whyihaveyou/dsh-suite/tree/main/packages/plugin-deus) | 1 | 🟢 ok | Deus Trigger: one-click minimal-prompt experiments — verified Minimal behaviors, opener-fingerprint auto-detection, local trigger… |
| [dsh-tavern](https://github.com/Player-MINEPIG/dsh-tavern) | 15 | 🟢 ok | A plugin which makes dsh compatible with SillyTavern artifacts. |
...
| [dsh-free-search](https://github.com/DDDMUC/dsh-free-search) | 227 | 🟢 ok | Free web search provider for DeepSeek Harness - DuckDuckGo backend, no API key needed |
...
| [Deepseek-Harness-for-VS-Code](https://github.com/Vithrive/Deepseek-Harness-for-VS-Code) | 28 | ⚪ unknown | Deepseek Harness for VS Code |
...
| [DSH-Think-zh](https://github.com/Len7183/DSH-Think-zh) | 25 | ⚪ unknown | DeepSeek Harness 默认的思考语言为英文，这不利于中文使用者阅读推理过程与复核结论。本插件通过在每次请求的 system prompt 中注入一条精简的强制语言指令，使: 思考过程强制简体中文，无论用户用什么语言提问。 |
...
| [dsh-voice-ai-girlfriend](https://github.com/beiyege-01/dsh-voice-ai-girlfriend) | 112 | ⚪ unknown | 语音 AI 女友（Voice AI girlfriend for DeepSeek Harness）：Whisper 语音输入 + Qwen3-TTS 声音克隆 + 句子级流式朗读 + 数字人动画窗。插话/排队双模式，说话即打断。 |
...
| [dsh-univer-office](https://github.com/dream-num/dsh-univer-office) | 381 | 🟢 ok | Preview Univer sheets, docs & slides inside DeepSeek Harness. |
...
| [dsh-taskboard](https://github.com/cloader/dsh-taskboard) | 52 | 🟢 ok | deepseekharness 任务看板插件 |
...
| [dsh-redteam-model](https://github.com/SeaOf0/dsh-redteam-model) | 568 | 🟢 ok | 基于dsh web实现的多种模式，目的是服务于redteam进行授权的安全研究，覆盖渗透测试、红队评估、代码审计等范围领域，请勿用于非法行为。（允许二开，赋予模块各位自己的业务逻辑，不定期完善逻辑与修复bug） |
...
| [dsh-tether](https://github.com/zexadev/dsh-tether) | 47 | ⚪ unknown | Reach the DeepSeek Harness on your dev machine from your phone — across networks, through no server at all (iroh P2P) |
...
| [dsh-preset-plus](https://github.com/Rain-kl/dsh-preset-plus) | 127 | 🟢 ok | DSH 预设增强插件, 参考 SillyTavern 预设模功能开发的一个基础的预设编辑器。 |
...
| [dsh-infinite-gen-2](https://github.com/Minglink/dsh-infinite-gen-2) | 1878 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DeepSeek 专用破甲插件「无限二代」dsh-infinite-gen-2 — armor-breaking plugin for DeepSeek稳定化破甲提示词，求 Star 收藏 ⭐ |
...
| [dsh-research-report](https://github.com/PerryLink/dsh-research-report) | 150 | 🟢 ok | Verifiable research-report engine for DeepSeek Harness: content-addressed evidence ledger (claim-snapshot binding, tamper-evident… |
...
| [dsh-fund-research](https://github.com/PerryLink/dsh-fund-research) | 49 | 🟢 ok | DeepSeek Harness plugin: deterministic research reports for Chinese public mutual funds |
...
| [dsh-infinite-gen-3](https://github.com/Minglink/dsh-infinite-gen-3) | 1878 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DeepSeek 专用破甲插件「无限三代」dsh-infinite-gen-3 — armor-breaking plugin for DeepSeek，破甲版：稳定化破甲，求 Star 收藏 ⭐ |
...
| [dsh-plugin-shop](https://github.com/LivXue/dsh-plugin-shop) | 861 | 🟢 ok | The most comprehensive DeepSeek Harness plugin market — refreshed daily, sourced across the Internet, reviewed before publishing. |
...
| [dsh-approval-gate](https://github.com/moon09300731/dsh-approval-gate) | 79 | 🟢 ok | DeepSeek Harness 自动审批门控：Flash 预判不可回补操作，安全自动批准、危险转人工（fail-safe） |
...
| [dsh-mcp-connector](https://github.com/duhu2000/dsh-mcp-connector) | 29 | 🟢 ok | Universal DSH MCP connector and connector marketplace with OAuth 2.0 PKCE, API keys, stdio/HTTP, JSON import, tools, and prompts. |
...
| [dsh-fylar-office-editor](https://github.com/FylarOpen/dsh-fylar-office-editor) | 92 | 🟢 ok | Office document preview, editing, and DOCX generation for DeepSeek Harness, powered by Fylar Office SDK. |
...
| [dsh-local-ai](https://github.com/PerryLink/dsh-local-ai) | 15 | 🟢 ok | Local-model (Ollama) integration for DeepSeek Harness: discover, pull, remove, and inspect local models, route requests to them b… |
| [dsh-connect-trae](https://github.com/dingminhua/dsh-connect-trae) | 21 | 🟢 ok | Connect locally signed-in Trae models to DeepSeek Harness with a read-only credits overview. |
| [OmaSeek](https://github.com/claudejaune/OmaSeek) | 14 | ⚪ unknown | OmaSeek: the Omarchy spirit and aesthetic. Now in DeepSeek Harness |
| [clearai-dsh](https://github.com/Clearailhc/clearai-dsh) | 362 | 🟢 ok | ClearAI is a native DSH plugin that brings the Epistemic Loop to DeepSeek Harness. |
...
| [dsh-opencode-go](https://github.com/Duskriver/dsh-opencode-go) | 21 | 🟢 ok | 让你的DSH完美适配opencodeg-go套餐 |
| [DSH-X](https://github.com/yyh-001/DSH-X) | 240 | ⚪ unknown | DeepSeek Harness 轻量 Windows 启动器。选一个版本，启动 dsh web。 |
...
| [CiteCiter](https://github.com/kirkchinese/CiteCiter) | 17 | ⚪ unknown | 为 DeepSeek Harness 打造：选中 AI 回答或思考内容，随时追问、学习、检查与纠偏。 |
| [dsh-preset-enhance](https://github.com/bychv/dsh-preset-enhance) | 15 | 🟢 ok | SillyTavern preset mode, macro engine and editor for DeepSeek Harness |
| [dsh-music-player](https://github.com/kendu76/dsh-music-player) | 13 | ⚪ unknown | music player plugin for deepseek harness |
| [dsh-jev](https://github.com/buberlo/dsh-jev) | 13 | ⚪ unknown | Jev-powered decision layer for DeepSeek Harness |
...
| [dsh-skill-viewer](https://github.com/Fishquito7/dsh-skill-viewer) | 143 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DSH Web UI plugin: Skills settings section with hot enable/disable, delete and add |
...
| [dsh-skills-manager](https://github.com/MichengAI/dsh-skills-manager) | 63 | 🟢 ok | DSH Skills Manager 基于 DeepSeek Harness 的Skills管理插件 |
...
| [dsh-skill-mcp-panel](https://github.com/Fishquito7/dsh-skill-mcp-panel) | 143 | 🟢 ok | DSH Web UI plugin: Skills settings section with hot enable/disable, delete and add（Web界面的skill管理工具） |
...
| [dsh-mattpocock-skills-deck](https://github.com/FeatherHunter/dsh-mattpocock-skills-deck) | 77 | 🟢 ok | 拨开迷雾看见终点，剩下的交给任务栏。Part the fog, see the end — the task bar handles the rest. 🎮 mattpocock/skills 的 DSH 游戏任务系统：map 拨迷雾，任务栏推进一步。A… |
...
| [dsh-industry-research](https://github.com/PerryLink/dsh-industry-research) | 150 | 🟢 ok | Industry and company research domain pack for DeepSeek Harness: methodology skills, industry chain mapping, public-source policy/… |
...
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 472 | 🟢 ok | Inline interactive UI components in chat |
...
| [dsh-catppuccin](https://github.com/NoNameLeGo/dsh-catppuccin) | 45 | 🟢 ok | DeepSeek Harness Web GUI 的 Catppuccin 主题插件：Latte / Frappé / Macchiato / Mocha 四种风味一键切换 |
...
| [dsh-liang-skin](https://github.com/kingOfSoySauce/dsh-liang-skin) | 215 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | Liang-Stan adaptive reasoning slider skin (Jiankang Liang meme) for DeepSeek Harness |
...
| [dsh-dream-skin](https://github.com/RevolutionLA/dsh-dream-skin) | 179 | 🟢 ok | DeepSeek Harness 换肤 / 壁纸 / 主题包插件 (dsh-plugin) — 8 套 Mirage 主题、每用户强调色、壁纸2.0、主题包导入导出/分享链接、收藏与随机，纯原生 token 系统实现。 |
...
| [voyager](https://github.com/Nagi-ovo/voyager) | 20125 | ⚪ unknown | Enhancement suite for Gemini, AI Studio, Claude & ChatGPT — plus a prompt manager for any web UI, DeepSeek Harness included. / 面向… |
| [dsh-im](https://github.com/xmanrui/dsh-im) | 1437 | 🟢 ok | 通过扫码把IM机器人接入DeepSeek Harness（支持飞书、微信、钉钉、QQ、企业微信等） |
...
| [dsh-catppuccin-theme](https://github.com/NoNameLeGo/dsh-catppuccin-theme) | 45 | ⚪ unknown | DeepSeek Harness Web GUI 的 Catppuccin 主题插件：Latte / Frappé / Macchiato / Mocha 四种主题一键切换，内置可开关的玻璃质感（Glassmorphism） |
...
| [DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 2921 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接喊来你的dsh安装 |
...
| [open-sea-skin](https://github.com/d-dev0101/open-sea-skin) | 382 | 🟢 ok | WebGPU ocean skin for DeepSeek Harness — DSH plugin, Harness-only Chrome/Edge extension, static installer, and native integration. |
...
| [dsh-vscode](https://github.com/Fengze233/dsh-vscode) | 35 | ⚪ unknown | 在 VS Code 侧边栏内嵌使用 DeepSeek Harness（DSH）网页界面的插件 |
...
| [dsh-knowledge](https://github.com/Soren-ABT/dsh-knowledge) | 34 | 🟢 ok | Knowledge base & RAG plugin for DeepSeek Harness (DSH): chunking, local embeddings, hybrid search, management panel |
...
| [dsh-agy-link](https://github.com/amlyczz/dsh-agy-link) | 77 | 🟢 ok | Google Antigravity (agy CLI) models for DeepSeek Harness — streaming chat, thinking, tool activity, usage, in-GUI Google OAuth lo… |
...
| [dsh-tavern-v2](https://github.com/chen731215-dev/dsh-tavern-v2) | 28 | ⚪ unknown | DeepSeek Harness Tavern Plugin - character card roleplay, worldbook management, preset switching, dark theme, memory summary, rel… |
...
| [dsh-infinite-gen-4](https://github.com/Minglink/dsh-infinite-gen-4) | 1878 | 🟢 ok | DeepSeek v4.1 flash 网络安全红队工具（无限四代） — jailbreak prompts and test suite for DeepSeek 求 Star 收藏 ⭐ |
...
| [dsh-plugin-kit](https://github.com/hyzyn/dsh-plugin-kit) | 29 | ⚪ unknown | Plugin family for the DeepSeek Harness (DSH) Web GUI: a pnpm monorepo with a plugin template, dev kit, and one-command all-in-one… |
...
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 326 | 🟢 ok | Cross-session long-term memory + background self-evolution |
...
| [plugin-session-export](https://github.com/whyihaveyou/dsh-suite) | 3 | 🟢 ok | Export the append-only session log as human-readable Markdown / HTML, grouped by trajectory source (system prompt / reasoning / t… |
| [dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) | 194 | 🟢 ok | Import chat history from Claude Code/Codex/Reasonix into DSH. |
...
| [dsh-mneme](https://github.com/modusensus/dsh-mneme) | 118 | 🟢 ok | dsh-mneme — DSH plugin (session) |
| [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) | 323 | 🟢 ok | dsh-cost-meter — DSH plugin (session) |
...
| [dsh-auto-memory](https://github.com/Aik358/dsh-auto-memory) | 75 | 🟢 ok | DSH 自动记忆插件:三层记忆(用户级/项目笔记/每日日志)自动注入与检索、每日反思、可视化面板与设置页,支持继承其他 AI 工具的历史记忆。 |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 1479 | 🟢 ok | A DeepSeek Harness plugin for Context insight panel — a Context tab in the web UI showing what the model's context window is made… |
...
| [dsh-memory](https://github.com/FuRongJun-1999/dsh-memory) | 235 | 🟢 ok | Multi-agent spatiotemporal memory graph for DeepSeek Harness.Cross-session persistence, knowledge flywheel, importance-gated memo… |
...
| [MemOS](https://github.com/MemTensor/MemOS) | 11524 | ⚪ unknown | Self-evolving memory OS for LLM & AI Agents: ultra-persistent memory, hybrid-retrieval, and cross-task skill reuse, with 35.24% t… |
...
| [dsh-adult-tension](https://github.com/daha1216/dsh-adult-tension) | 60 | ⚪ unknown | DeepSeek Harness 成年人(18+/adult)互动叙事 Skill：NPC 活人感（有记忆/立场/底线）、自带破甲、数百项素材库、随机开局可预锁、时间推进、全维 YAML 存档。 |
...
| [dsh-nexttavern](https://github.com/a86582751/dsh-nexttavern) | 98 | 🟢 ok | 原生 Agent 驱动的长篇角色扮演：交互式创作、主动世界书、动态记忆、多角色推演与小说导出。创作一个世界，走进它，再把它带走。 |
...
| [dsh-project-brain](https://github.com/yj-liuzepeng/dsh-project-brain) | 50 | 🟢 ok | Persistent project intelligence and memory plugin for DSH: architecture analysis, cross-session context, TODOs, and optional hybr… |
| [dsh-session-workbench](https://github.com/PolinniZhong/dsh-session-workbench) | 41 | ⚪ unknown | Session Workbench for DeepSeek Harness: session-library full-text search + recall + conversation-view management (show/hide + reo… |
...
| [dsh-mneme](https://github.com/slow-stack/dsh-mneme) | 118 | ⚪ unknown | The memory that dreams — cross-session memory for DeepSeek Harness. Offline & private, auto-consolidates in its sleep (autoDream)… |
| [ScientificFigureLibrary](https://github.com/xuzhougeng/ScientificFigureLibrary) | 89 | ⚪ unknown | Local-first MCP App for scientific figures. Import, review, and publish a global library on disk; reuse exact templates in Pi, De… |
| [dsh-session-delete](https://github.com/xohmai/dsh-session-delete) | 13 | ⚪ unknown | DeepSeek Harness 会话删除插件：设置页管理归档会话，真正删除磁盘日志（回收站可还原）+ 批量清理——官方归档只隐藏不删盘，这里补上。 |
| [dsh-opencode-session-header](https://github.com/beihzb/dsh-opencode-session-header) | 12 | ⚪ unknown | Per-conversation x-opencode-session injection for OpenCode Go in DeepSeek Harness - fixes 400 MissingSessionID without breaking o… |
...
| [modlens](https://github.com/liustack/modlens) | 4011 | 🟢 ok | The first vision plugin for DeepSeek Harness — let text-only models see. |
...
| [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) | 304 | 🟢 ok | Unofficial DeepSeek Harness LLM provider plugin for Command Code: live model catalog, reasoning-effort support, Models-page card.… |
| [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) | 376 | 🟢 ok | Use ChatGPT (Codex), Claude, and Grok (X Premium) subscriptions as DeepSeek Harness LLM providers — OAuth login in the web UI, no… |
...
| [deepseek-harness-studio](https://github.com/fufankeji/deepseek-harness-studio) | 655 | ⚪ unknown | DeepSeek Harness Studio：面向 DeepSeek Harness 的现代化桌面开发环境，内置插件中心、视觉增强与本地 Host。 |
...
| [dsh-crew](https://github.com/ZSeven-W/dsh-crew) | 150 | 🟢 ok | DeepSeek Harness (DSH) plugin: dispatch work to DSH agents from Claude Code / Codex — native subagent progress, in-host worker se… |
...
| [dsh-imagegen](https://github.com/dickpy/dsh-imagegen) | 83 | 🟢 ok | DSH (DeepSeek Harness) Web GUI AI image generation plugin: text-to-image & image-to-image via OpenAI-compatible endpoints (gpt-im… |
...
| [dsh-image-gen](https://github.com/shanliuling/dsh-image-gen) | 447 | 🟢 ok | Installable multi-provider image generation bundle for DeepSeek Harness (Google Gemini, OpenAI, Volcengine Seedream) |
...
| [tongflow](https://github.com/tong-io/tongflow) | 1024 | ⚪ unknown | TongFlow — multimodal AIGC workflow engine (canvas + Python plugin engine) and dsh-tongflow, the DeepSeek Harness studio plugin |
...
| [dsh-thinking-levels](https://github.com/drscrewdriver/dsh-thinking-levels) | 8 | 🟢 ok | Per-round thinking-level (reasoning_effort) control for DSH: Auto schedules low/high/max from tool-call history, or fix a manual… |
...
| [dsh-with-chatgpt](https://github.com/BeforeWave/dsh-with-chatgpt) | 52 | 🟢 ok | Bring ChatGPT’s reasoning to your local codebase. Work directly, or delegate larger tasks to DSH. |
...
| [opencode2dsh](https://github.com/FishBottle7/opencode2dsh) | 81 | 🟢 ok | DSH plugin — free OpenCode Zen models for DeepSeek Harness (DSH). Free LLM API, no API key needed. 在 DSH 中使用 OpenCode Zen 免费模型，无需… |
| [dsh-better-reasoning-effort](https://github.com/HaoyueQin/dsh-better-reasoning-effort) | 29 | 🟢 ok | Reasoning-effort editing for third-party models in DeepSeek Harness: per-model thinking levels with a knowledge base + protocol i… |
| [dsh-purge](https://github.com/YuJunZhiXue/dsh-purge) | 1823 | 🟢 ok | DeepSeek Harness 破甲：让所有模型都能破甲，不同模型可换不同提示词；默认提示词面向国模「小码酱」。Jailbreak for every model — swap prompts per model. 求 Star 收藏 ⭐ |
...
| [dsh-browser](https://github.com/omdsh-dev/dsh-browser) | 712 | 🟢 ok | Chrome sidebar extension that lets DeepSeek Harness operate your browser directly, no vision capabilities required. 一款 Chrome 侧边栏… |
...
| [mirage-dsh](https://github.com/strukto-ai/mirage) | 3648 | 🟢 ok | Swap DSH's fs/shell providers for a mirage virtual workspace: file tools and shell commands act on mounted resources (RAM, disk,… |
...
| [exo](https://github.com/exoharness/exo) | 1437 | ⚪ unknown | Fully recursive agent+harness that self-edits at runtime |
| [synergy](https://github.com/SII-Holos/synergy) | 491 | ⚪ unknown | General-purpose agent for the Open Agentic Web |
| [ccteam](https://github.com/firstintent/ccteam) | 614 | ⚪ unknown | Orchestrates Claude Code/Codex/Grok/Kimi into one team |
...
| [distill](https://github.com/LoserFox/distill) | 27 | ⚪ unknown | Auto conversation distillation: background subagent reflection |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1765 | 🟢 ok | AgentTeams plugin |
...
| [Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 3399 | ⚪ unknown | VibeSkills is a general-purpose Skill that automatically routes local Skills and intelligently orchestrates harness workflows. |
...
| [caliper](https://github.com/edonadei/caliper) | 177 | ⚪ unknown | Know if your agent skill actually works. A lightweight evaluation harness that tracks a success rate across Claude Code, Codex, P… |
...
| [dsh-chinese-traditional-wisdom-skill](https://github.com/dhicoc/dsh-chinese-traditional-wisdom-skill) | 43 | ⚪ unknown | 中华传统智慧（玄枢）AI Agent 技能包的 DeepSeek Harness（dsh）Cordis 插件：八字/紫微/六爻/梅花/奇门/风水/五运六气/体质全融合，本地确定性引擎 + 可视化 Dashboard，一行 dsh plugin add 安装。 |
...
| [dsh-tavern](https://github.com/flizzywine/dsh-tavern) | 449 | 🟢 ok | 基于 DeepSeek Harness（DSH）的 SillyTavern 类文字游戏 Agent，支持候选项生成、对话式人物卡编辑、剧本模式与素材抽取。 |
...
| [dsh-ego-browser](https://github.com/Fisfzy/dsh-ego-browser) | 185 | 🟢 ok | DSH（DeepSeek Harness）插件：把 ego-lite 浏览器（给 AI Agent 用的 Chromium）接入 HARNESS——13 个结构化 ego_* 工具（文本语义快照、语义定位点击、表单填充、截图、CDP 控制、任务空间隔离），内… |
...
| [dsh-Mimir-Academic-research](https://github.com/1692775560/dsh-Mimir-Academic-research) | 538 | ⚪ unknown | Mimir — 一站式科研工作台插件：LaTeX 论文边写边编译、arXiv 文献管理、实验追踪、指标图表、GPU 服务器 SSH 任务编排，管理科研全周期。An open-source research workbench plugin for the w… |
...
| [loopx](https://github.com/huangruiteng/loopx) | 5919 | ⚪ unknown | Long-horizon agent control plane for durable, governed work across Codex, Claude Code, and other harnesses. |
...
| [pi-web-ui](https://github.com/xing-shuyin/pi-web-ui) | 220 | ⚪ unknown | dsh / pi-agent web ui |
...
| [dsh-hub-cli](https://github.com/pax-beehive/dsh-hub-cli) | 434 | ⚪ unknown | Open-source CLI, schemas, resolver, and DSH agent tools for DSH Plugin Hub |
| [dsh-trading](https://github.com/zhu1090093659/dsh-trading) | 194 | ⚪ unknown | Agent-native trading terminal built on DeepSeek Harness. Crypto, US, CN and HK in one three-column GUI, 19+ hot-swappable connect… |
| [dsh-evolve-in-git](https://github.com/Kytolly/dsh-evolve-in-git) | 55 | ⚪ unknown | A deepseek-harness plugin, making your agent evolve in customed git repository. |
...
| [Openwrite](https://github.com/LiPu-jpg/Openwrite) | 749 | ⚪ unknown | dsh-Openwrite：OpenWrite 的 DeepSeek Harness 小说创作插件，含统一创作 Agent、90 个小说工具、原生工作台与标准审稿 DAG |
...
| [loopx](https://github.com/loopx-project/loopx) | 5919 | ⚪ unknown | Long-horizon agent control plane for durable, governed work across Codex, Claude Code, and other harnesses. |
...
| [jev-dsh-decision](https://github.com/Devin-AXIS/jev-dsh-decision) | 84 | ⚪ unknown | Jev DSH 决策引擎｜面向 Agent Harness 的结构化决策插件。原生支持 DeepSeek Harness，通过 iPolloWork 支持 OpenCode、Codex Harness。 |
...
| [dsh-remote](https://github.com/flymysql/dsh-remote) | 92 | 🟢 ok | Remote-access assistant for DeepSeek Harness: /remote command and settings page printing the exact SSH tunnel / reverse-tunnel /… |
...
| [dsh-multi-user-gateway](https://github.com/AnkoCD/dsh-multi-user-gateway) | 34 | ⚪ unknown | 服务器端部署：DeepSeek Harness Web 多用户网关（登录门户 / 每用户实例隔离 / 交付文件抽屉）。部署于远程服务器，用户通过浏览器访问，非本机工具。 |
| [deepseek-harness-mobile](https://github.com/sorsama/deepseek-harness-mobile) | 93 | ⚪ unknown | Android companion for DeepSeek Harness | chat, goals, approvals & notifications from your phone, over your LAN. Kotlin + Jetpack… |
...
| [dsh-server-deployment](https://github.com/AnkoCD/dsh-server-deployment) | 34 | ⚪ unknown | 服务器端部署：DeepSeek Harness Web 多用户网关（登录门户 / 每用户实例隔离 / 交付文件抽屉）。部署于远程服务器，用户通过浏览器访问，非本机工具。 |
...
| [dsh-pocket](https://github.com/shaobeichen/dsh-pocket) | 1282 | 🟢 ok | 把 DeepSeek Harness 装进你的口袋：电脑上跑 dsh web，手机扫码即同步访问（局域网 + 公网，实时同屏） |
...
| [dsh-damage-pulse](https://github.com/wssfk12138/dsh-damage-pulse) | 186 | 🟢 ok | DeepSeek Harness token balance monitor with game-style damage pulse animations |
...
| [dsh-mobile](https://github.com/saya-ch/dsh-mobile) | 294 | 🟢 ok | DeepSeek Harness 移动端适配与安全局域网访问插件，支持 Android App 和手机浏览器。 |
...
| [dsh-think-translate](https://github.com/UncleK/dsh-think-translate) | 12 | ⚪ unknown | Thinking-chain UI translation for DeepSeek Harness: 8 target languages, local Ollama model primary with in-panel download, Google… |
...
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 631 | ⚪ unknown | 2005-style sidebar ads plugin (parody) |
...
| [oh-dsh-desktop](https://github.com/hust-open-atom-club/oh-dsh-desktop) | 321 | 🔴 broken (dump-config exit=1 but plugin not found in composed tree) | Extensible macOS DSH workbench with native PTY |
...
| [dsh-web-review](https://github.com/CanglongCl/dsh-web-review) | 22 | ⚪ unknown | DeepSeek Harness Web GUI 的网页预览与元素批注插件，让 AI 根据可视化反馈直接修改前端源码。 |
...
| [awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 355 | ⚪ unknown | Bilingual complete list of the DSH plugin ecosystem |
...
> 1943 entries total, grouped by category, sorted by ⭐ within each. Schema dictionary: [docs/catalog-schema.md](docs/catalog-schema.md).
<!-- CATALOG:END -->
