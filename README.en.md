...
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 1933 | ⚪ unknown | DSH Web UI plugin & skin collection: task board, git panel, etc. |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 768 | ⚪ unknown | Sidebar workbench: file render/terminal/git/subagent |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 595 | ⚪ unknown | DSH Web whale-girl skin series |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 330 | ⚪ unknown | Vision for text-only models: image QA, screenshot OCR, UI reconstruction |
...
| [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) | 41 | ⚪ unknown | Rewind conversation and workspace state |
...
| [modsearch](https://github.com/liustack/modsearch) | 92 | ⚪ unknown | Web search plugin for DeepSeek Harness. |
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 95 | ⚪ unknown | Chrome sidebar extension letting DSH drive the browser. |
...
| [dsh-terminal](https://github.com/ZgblKylin/dsh-terminal) | 2 | ⚪ unknown | Integrate terminal plugin for DeepSeek Harness |
...
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 74 | ⚪ unknown | Inline interactive UI components in chat |
...
| [dsh-web-ui-notify](https://github.com/bill9109/dsh-web-ui-notify) | 10 | ⚪ unknown | Desktop notifications for DSH |
| [ex-setting](https://github.com/omdsh-dev/ex-setting) | 2 | ⚪ unknown | DSH settings extension |
| [whale-girl](https://github.com/vlln/whale-girl) | 128 | ⚪ unknown | QQ-pet-style desktop pet plugin |
...
| [dsh-pet](https://github.com/FlytoMAYDAY80/dsh-pet) | 6 | ⚪ unknown | dsh-pet — DSH plugin (ui) |
...
| [dsh-black-whale](https://github.com/147228/dsh-black-whale) | 2 | ⚪ unknown | dsh-black-whale — DSH plugin (ui) |
...
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 58 | ⚪ unknown | Cross-session long-term memory + background self-evolution |
...
| [dsh-plugin-session-import](https://github.com/huguangyu666/dsh-plugin-session-import) | 2 | ⚪ unknown | DeepSeek Harness plugin: import claude-code / codex / reasonix / zcode sessions |
...
| [dsh-continual-evolve](https://github.com/ZK-Andy/dsh-continual-evolve) | 2 | ⚪ unknown | Continual self-evolution plugin for DeepSeek Harness: versioned, auditable, rollback-safe harness state refined from session traj… |
...
| [modlens](https://github.com/liustack/modlens) | 1291 | ⚪ unknown | The first vision plugin for DeepSeek Harness — let text-only models see. |
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 835 | ⚪ unknown | Vision toolbox & skills for text-only models: multi-image QA, UI reconstruction, GUI automation. |
...
| [dsh-bash-win](https://github.com/zimzaza4/dsh-bash-win) | 1 | ⚪ unknown | dsh-bash-win — DSH plugin (sandbox) |
...
| [distill](https://github.com/LoserFox/distill) | 15 | ⚪ unknown | Auto conversation distillation: background subagent reflection |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 247 | ⚪ unknown | AgentTeams plugin |
...
| [dsh-clawrouter](https://github.com/BlockRunAI/dsh-clawrouter) | 8 | ⚪ unknown | A second brain for your DeepSeek Harness agent — strong-model review before risky tool calls, plus 70 models from one wallet. |
...
| [awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) | 825 | ⚪ unknown | DSH plugin directory with daily compatibility tracking |
...
| [awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 398 | ⚪ unknown | DSH ecosystem curation: plugins, tools, infra |
...
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 336 | ⚪ unknown | 2005-style sidebar ads plugin (parody) |
...
| [oh-dsh-desktop](https://github.com/hust-open-atom-club/oh-dsh-desktop) | 166 | ⚪ unknown | Extensible macOS DSH workbench with native PTY |
...
| [dsh-emoji](https://github.com/hellodigua/dsh-emoji) | 12 | ⚪ unknown | Auto-add emoji to AI replies |
...
| [awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 98 | ⚪ unknown | Bilingual complete list of the DSH plugin ecosystem |
| [dsh-launcher](https://github.com/Ruler4396/dsh-launcher) | 76 | ⚪ unknown | WebView2-based DSH launcher |
...
> 1190 entries total, grouped by category, sorted by ⭐ within each. Schema dictionary: [docs/catalog-schema.md](docs/catalog-schema.md).
<!-- CATALOG:END -->
