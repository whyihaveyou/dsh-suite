...
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 7417 | 🟢 ok | DSH Web UI plugin & skin collection: task board, git panel, etc. |
...
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 2029 | ⚪ unknown | DSH Web whale-girl skin series |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 874 | 🟢 ok | Vision for text-only models: image QA, screenshot OCR, UI reconstruction |
| [dsh_workflow](https://github.com/icetomoyo/dsh_workflow) | 121 | 🟢 ok | Bring Claude Code's UltraCode mode to DSH with governable multi-agent orchestration |
| [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) | 113 | 🟢 ok | Rewind conversation and workspace state |
| [mstar-harness](https://github.com/btspoony/mstar-harness) | 57 | ⚪ unknown | Skill-driven harness/loop engineering workflow plugin |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 364 | 🟢 ok | Mnemon three-layer memory deep integration |
...
| [modsearch](https://github.com/liustack/modsearch) | 465 | ⚪ unknown | Web search plugin for DeepSeek Harness. |
...
| [graycode-for-dsh](https://github.com/Komeiji-Shiki/graycode-for-dsh) | 4 | ⚪ unknown | graycode encoding tool. |
...
| [dsh-codex-connect](https://github.com/franksong2702/dsh-codex-connect) | 102 | 🟢 ok | ChatGPT OAuth and Codex models for DeepSeek Harness. |
...
| [MuseAI](https://github.com/yejiming/MuseAI) | 642 | ⚪ unknown | 创建你的 AI 角色，进入你的故事世界。和角色聊天、冒险、穿书，让每一次互动都留下羁绊（支持 DeepSeek Harness 插件，欢迎使用） |
...
| [dsh-pet](https://github.com/Vulcan626/dsh-pet) | 2 | 🟢 ok | A community DeepSeek Pet client plugin for DeepSeek Harness |
...
| [dsh-qqbot](https://github.com/tencent-connect/dsh-qqbot) | 95 | 🟢 ok | 让 QQ 机器人接入 DeepSeek Harness（dsh）的官方插件 |
...
| [dsh-auto-mode](https://github.com/NanmiCoder/dsh-auto-mode) | 156 | 🟢 ok | Safe automatic permissions for DeepSeek Harness. |
...
| [dsh-guardian](https://github.com/akira399/dsh-guardian) | 1 | 🟢 ok | DeepSeek Harness task-protection plugin: preflight scanner (catches missing inject declarations that crash the host), loop detect… |
...
| [dsh-win32](https://github.com/sjh9714/dsh-win32) | 40 | 🟢 ok | First-class Windows for DeepSeek Harness: persistent Git Bash Minimal mode, doctor for install traps, one-command setup | 让 DSH 在… |
| [dsh-plugin-store](https://github.com/0xKcyzz/dsh-plugin-store) | 6 | 🟢 ok | DeepSeek Harness 插件商店：浏览、搜索、筛选并一键安装 dsh-plugin 生态插件 |
| [dsh-backup](https://github.com/xiaoyuyu6420/dsh-backup) | 19 | 🟢 ok | Backup DeepSeek Harness user data with one command: /backup, scheduled auto-backup, sha256 checksums and rotation. 一键备份 DSH 数据，支持… |
...
| [DSH-Think-zh](https://github.com/Len7183/DSH-Think-zh) | 18 | ⚪ unknown | DeepSeek Harness 默认的思考语言为英文，这不利于中文使用者阅读推理过程与复核结论。本插件通过在每次请求的 system prompt 中注入一条精简的强制语言指令，使: 思考过程强制简体中文，无论用户用什么语言提问。 |
...
| [dsh-plugin-codex](https://github.com/wss534857356/dsh-plugin-codex) | 7 | 🟢 ok | Codex App Server model provider for DeepSeek Harness using your local Codex login. |
...
| [dsh-rust-sdk](https://github.com/42ch-dev/dsh-rust-sdk) | 7 | ⚪ unknown | Rust SDK for DSH(Deepseek Harness) |
...
| [webdsh](https://github.com/futrime/webdsh) | 29 | ⚪ unknown | Running DeepSeek Harness on web |
...
| [custom-first-control-prompt](https://github.com/WM-CODER/custom-first-control-prompt) | 71 | 🟢 ok | DeepSeek Harness plugin for insert custom prompt |
...
| [dsh-personal-center](https://github.com/PolinniZhong/dsh-personal-center) | 108 | 🟢 ok | DeepSeek Harness 个人中心:用量统计 / 自定义指令 / 成本估算 / 桌面宠物(纯本地，不联网）。 Personal center & custom instructions for DSH |
...
| [dsh-plugin-shop](https://github.com/LivXue/dsh-plugin-shop) | 623 | 🟢 ok | The most comprehensive DeepSeek Harness plugin market — refreshed daily, sourced across the Internet, reviewed before publishing. |
...
| [dsh-council](https://github.com/a1exsun/dsh-council) | 38 | ⚪ unknown | Multi-model council for DeepSeek Harness: independent answers, anonymous peer reviews, and an inspectable final decision. |
...
| [dsh-auto-continue](https://github.com/HsiangNianian/dsh-auto-continue) | 88 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DSH Web UI plugin: automatically sends "继续" (continue) when a request is interrupted by network errors or other non-human causes |
...
| [dsh-dream-skin](https://github.com/RevolutionLA/dsh-dream-skin) | 160 | 🟢 ok | DeepSeek Harness 换肤 / 壁纸 / 主题包插件 (dsh-plugin) — 8 套 Mirage 主题、每用户强调色、壁纸2.0、主题包导入导出/分享链接、收藏与随机，纯原生 token 系统实现。 |
...
| [voyager](https://github.com/Nagi-ovo/voyager) | 20037 | ⚪ unknown | Enhancement suite for Gemini, AI Studio, Claude & ChatGPT — plus a prompt manager for any web UI, DeepSeek Harness included. / 面向… |
| [dsh-im](https://github.com/xmanrui/dsh-im) | 1269 | 🟢 ok | 通过扫码把IM机器人接入DeepSeek Harness（支持飞书、微信、钉钉、QQ、企业微信等） |
...
| [DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 2173 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接喊来你的dsh安装 |
...
| [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) | 156 | 🟢 ok | Second-model AI auto-review for DeepSeek Harness approval requests: a read-only reviewer subagent returns structured allow/deny v… |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 1340 | 🟢 ok | A DeepSeek Harness plugin for Context insight panel — a Context tab in the web UI showing what the model's context window is made… |
...
| [dsh-memory](https://github.com/FuRongJun-1999/dsh-memory) | 164 | 🟢 ok | Multi-agent spatiotemporal memory graph for DeepSeek Harness.Cross-session persistence, knowledge flywheel, importance-gated memo… |
...
| [DSH-update-check](https://github.com/knlght/DSH-update-check) | 1 | 🟢 ok | 让 DeepSeek Harness 拥有版本可见性：dsh_check_updates 模型工具 + Settings 更新检查页 + 周期复查，只报告不升级 |
...
| [dsh-computer-use](https://github.com/988hj7tczd-oss/dsh-computer-use) | 31 | 🟢 ok | Computer Use 插件：虚拟鼠标真人操作 for DeepSeek Harness（screen_observe + computer_click 等 11 个模型友好工具，跨平台 cua-driver 引擎） |
...
| Plugin | ⭐ | Compat | Description |
|---|---|---|---|
| [openhanako](https://github.com/liliMozi/openhanako) | 6538 | ⚪ unknown | Personal AI agent with memory, personality and autonomy |
...
| [ccteam](https://github.com/firstintent/ccteam) | 512 | ⚪ unknown | Orchestrates Claude Code/Codex/Grok/Kimi into one team |
...
| [dsh-plannotator](https://github.com/titanwings/dsh-plannotator) | 10 | 🟢 ok | Plan annotator: annotate plan text line-by-line |
...
| [dsh_workflow](https://github.com/omdsh-dev/dsh_workflow) | 121 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | 把Claude Code的UltraCode模式带给DSH，把 DSH 的一次性多 Agent 调度，升级为可生成、可保存、可治理、可观察、可恢复的 Workflow 层 |
...
| [dsh-tavern](https://github.com/flizzywine/dsh-tavern) | 269 | 🟢 ok | 基于 DeepSeek Harness（DSH）的 SillyTavern 类文字游戏 Agent，支持候选项生成、对话式人物卡编辑、剧本模式与素材抽取。 |
...
| [dsh-Mimir-Academic-research](https://github.com/1692775560/dsh-Mimir-Academic-research) | 322 | ⚪ unknown | Mimir — 一站式科研工作台插件：LaTeX 论文边写边编译、arXiv 文献管理、实验追踪、指标图表、GPU 服务器 SSH 任务编排，管理科研全周期。An open-source research workbench plugin for the w… |
...
| [dsh-watcher](https://github.com/aa2246740/dsh-watcher) | 58 | ⚪ unknown | Read-only Agent work-path observer for DeepSeek Harness |
...
| [sofagent](https://github.com/KongFangXun/sofagent) | 44 | ⚪ unknown | Open-source FDE Harness layer for enterprise AI: 24-rule git-diff audit, auto snapshot rollback, rule injection, self-evolution.… |
...
| [dsh-hub-cli](https://github.com/pax-beehive/dsh-hub-cli) | 279 | ⚪ unknown | Open-source CLI, schemas, resolver, and DSH agent tools for DSH Plugin Hub |
| [dsh-trading](https://github.com/zhu1090093659/dsh-trading) | 160 | ⚪ unknown | Agent-native trading terminal built on DeepSeek Harness. Crypto, US, CN and HK in one three-column GUI, 19+ hot-swappable connect… |
...
| [dsh-pocket](https://github.com/shaobeichen/dsh-pocket) | 1077 | 🟢 ok | 把 DeepSeek Harness 装进你的口袋：电脑上跑 dsh web，手机扫码即同步访问（局域网 + 公网，实时同屏） |
...
| Plugin | ⭐ | Compat | Description |
|---|---|---|---|
| [EchoBird](https://github.com/edison7009/EchoBird) | 3212 | ⚪ unknown | One-click install + model switch across 20+ coding agents |
...
| [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 271 | 🟢 ok | DeepSeek Harness terminal UI |
...
| [dsh-plugin-notify](https://github.com/huguangyu666/dsh-plugin-notify) | 3 | 🟢 ok | DeepSeek Harness 插件：通知出口——agent 通过桌面通知 / 中文语音播报 / 提示音主动联系用户（长任务完成、出错、呼叫用户回来）。Windows 本机零依赖。 |
