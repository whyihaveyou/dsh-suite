...
![Plugins](https://img.shields.io/badge/plugins-1936-facc15?style=flat-square)
...
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 7874 | 🟢 ok | DSH Web UI plugin & skin collection: task board, git panel, etc. |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3694 | 🟢 ok | Sidebar workbench: file render/terminal/git/subagent |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 2162 | ⚪ unknown | DSH Web whale-girl skin series |
...
| Plugin | ⭐ | Compat | Description |
|---|---|---|---|
| [open-managed-agents](https://github.com/openma-ai/open-managed-agents) | 291 | ⚪ unknown | Self-hosted Claude Managed Agents API platform (Cloudflare Workers) |
...
| [dsh-interconnect](https://github.com/Chinesezjc/dsh-interconnect) | 33 | 🟢 ok | Cross-instance message/event handoff |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 390 | 🟢 ok | Mnemon three-layer memory deep integration |
...
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 706 | 🟢 ok | Chrome sidebar extension letting DSH drive the browser. |
...
| [anysearch-dsh](https://github.com/anysearch-team/anysearch-dsh) | 423 | 🟢 ok | AnySearch web search provider and advanced search tools for DeepSeek Harness (DSH) |
...
| [dsh-pet](https://github.com/PC2005-cloud/dsh-pet) | 701 | 🟢 ok | DeepSeek Harness 桌面宠物插件 + 完整素材生成链：AI 提示词 → 绿幕视频 → 透明动画 → 可安装插件，从零到宠物全流程可复现 |
...
| [dsh-agy](https://github.com/chaos-03x/dsh-agy) | 42 | 🟢 ok | Google Antigravity (agy) OAuth auth + model access plugin for DeepSeek Harness: multi-account pool, 429 rotation, device fingerpr… |
...
| [dsh-anchored-standard](https://github.com/xiaobright/dsh-anchored-standard) | 3803 | ⚪ unknown | Two-phase DeepSeek Harness preset: Minimal-aligned bootstrap, then full Standard tools (Project2 98/99) |
...
| [dsh-auto-mode](https://github.com/NanmiCoder/dsh-auto-mode) | 159 | 🟢 ok | Safe automatic permissions for DeepSeek Harness. |
...
| [dsh-free-search](https://github.com/DDDMUC/dsh-free-search) | 216 | 🟢 ok | Free web search provider for DeepSeek Harness - DuckDuckGo backend, no API key needed |
...
| [dsh-pentest](https://github.com/howmp/dsh-pentest) | 524 | 🟢 ok | 面向 DeepSeek Harness（dsh）的渗透测试模式 @CloverSecLabs |
...
| [helm-d](https://github.com/ADWMC/helm-d) | 70 | ⚪ unknown | DeepSeek Harness 破甲一体化安全分析插件：Android · Web · Native · Protocol · Malware · AI-Security 全领域聚合（9 bundle + 1 preset） |
...
| [dsh-univer-office](https://github.com/dream-num/dsh-univer-office) | 379 | 🟢 ok | Preview Univer sheets, docs & slides inside DeepSeek Harness. |
...
| [dsh-redteam-model](https://github.com/SeaOf0/dsh-redteam-model) | 549 | 🟢 ok | 基于dsh web实现的多种模式，目的是服务于redteam进行授权的安全研究，覆盖渗透测试、红队评估、代码审计等范围领域，请勿用于非法行为。（允许二开，赋予模块各位自己的业务逻辑，不定期完善逻辑与修复bug） |
...
| [garmin-connect-plugin-for-dsh](https://github.com/Likenttt/garmin-connect-plugin-for-dsh) | 20 | ⚪ unknown | DeepSeek Harness plugin for Garmin Connect — AI-powered fitness data access |
...
| [Invoice-Downloader](https://github.com/EthanYoQ/Invoice-Downloader) | 434 | ⚪ unknown | 电子发票整理与报销准备工具：从邮箱批量收集 PDF/OFD/XML 发票，OCR 识别、分类归档并生成 Excel 汇总；提供 Windows/macOS 桌面版与 DSH 插件。 |
...
| [dsh-infinite-gen-2](https://github.com/Minglink/dsh-infinite-gen-2) | 1836 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DeepSeek 专用破甲插件「无限二代」dsh-infinite-gen-2 — armor-breaking plugin for DeepSeek稳定化破甲提示词，求 Star 收藏 ⭐ |
...
| [dsh-research-report](https://github.com/PerryLink/dsh-research-report) | 141 | 🟢 ok | Verifiable research-report engine for DeepSeek Harness: content-addressed evidence ledger (claim-snapshot binding, tamper-evident… |
...
| [dsh-infinite-gen-3](https://github.com/Minglink/dsh-infinite-gen-3) | 1836 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DeepSeek 专用破甲插件「无限三代」dsh-infinite-gen-3 — armor-breaking plugin for DeepSeek，破甲版：稳定化破甲，求 Star 收藏 ⭐ |
...
| [dsh-plugin-shop](https://github.com/LivXue/dsh-plugin-shop) | 849 | 🟢 ok | The most comprehensive DeepSeek Harness plugin market — refreshed daily, sourced across the Internet, reviewed before publishing. |
...
| [dsh-mcp-connector](https://github.com/duhu2000/dsh-mcp-connector) | 27 | 🟢 ok | Universal DSH MCP connector and connector marketplace with OAuth 2.0 PKCE, API keys, stdio/HTTP, JSON import, tools, and prompts. |
...
| [dsh-fylar-office-editor](https://github.com/FylarOpen/dsh-fylar-office-editor) | 85 | 🟢 ok | Office document preview, editing, and DOCX generation for DeepSeek Harness, powered by Fylar Office SDK. |
...
| [dsh-connect-workbuddy](https://github.com/dingminhua/dsh-connect-workbuddy) | 30 | 🟢 ok | Connect locally signed-in WorkBuddy models to DeepSeek Harness with a read-only credits overview and model management. |
...
| [dsh-local-ai](https://github.com/PerryLink/dsh-local-ai) | 14 | 🟢 ok | Local-model (Ollama) integration for DeepSeek Harness: discover, pull, remove, and inspect local models, route requests to them b… |
...
| [clearai-dsh](https://github.com/Clearailhc/clearai-dsh) | 308 | 🟢 ok | ClearAI is a native DSH plugin that brings the Epistemic Loop to DeepSeek Harness. |
...
| [DSH-X](https://github.com/yyh-001/DSH-X) | 98 | ⚪ unknown | DeepSeek Harness 轻量 Windows 启动器。选一个版本，启动 dsh web。 |
...
| [CiteCiter](https://github.com/kirkchinese/CiteCiter) | 13 | ⚪ unknown | 为 DeepSeek Harness 打造：选中 AI 回答或思考内容，随时追问、学习、检查与纠偏。 |
...
| [dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill) | 161 | 🟢 ok | Complete reverse-skill (85 SKILL.md) as a DeepSeek Harness (dsh) Cordis plugin — reverse engineering, authorized pentesting and s… |
...
| [dsh-skills-manager](https://github.com/MichengAI/dsh-skills-manager) | 60 | 🟢 ok | DSH Skills Manager 基于 DeepSeek Harness 的Skills管理插件 |
...
| [oh-story-dsh](https://github.com/worldwonderer/oh-story-dsh) | 389 | ⚪ unknown | A DSH plugin for novel writing and short-drama production, powered by Oh Story and Drama Skills. |
...
| [dsh-mattpocock-skills-deck](https://github.com/FeatherHunter/dsh-mattpocock-skills-deck) | 74 | 🟢 ok | 拨开迷雾看见终点，剩下的交给任务栏。Part the fog, see the end — the task bar handles the rest. 🎮 mattpocock/skills 的 DSH 游戏任务系统：map 拨迷雾，任务栏推进一步。A… |
| [oh-story-dsh](https://github.com/zenstory-ai/oh-story-dsh) | 389 | ⚪ unknown | A DSH plugin for novel writing and short-drama production, powered by Oh Story and Drama Skills. |
| [dsh-industry-research](https://github.com/PerryLink/dsh-industry-research) | 142 | 🟢 ok | Industry and company research domain pack for DeepSeek Harness: methodology skills, industry chain mapping, public-source policy/… |
...
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 470 | 🟢 ok | Inline interactive UI components in chat |
...
| [whale-girl](https://github.com/vlln/whale-girl) | 328 | 🟢 ok | QQ-pet-style desktop pet plugin |
| [dsh-status-rotator](https://github.com/01Virex/dsh-status-rotator) | 88 | 🟢 ok | Web plugin replacing the DSH status display. |
...
| [dsh-doublecheck](https://github.com/PerryLink/dsh-doublecheck) | 38 | 🟢 ok | Double-check before you ship: grill the requirements, test the implementation, prove the delivery. An engineering-discipline bund… |
...
| [dsh-liang-skin](https://github.com/kingOfSoySauce/dsh-liang-skin) | 213 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | Liang-Stan adaptive reasoning slider skin (Jiankang Liang meme) for DeepSeek Harness |
...
| [voyager](https://github.com/Nagi-ovo/voyager) | 20112 | ⚪ unknown | Enhancement suite for Gemini, AI Studio, Claude & ChatGPT — plus a prompt manager for any web UI, DeepSeek Harness included. / 面向… |
| [dsh-im](https://github.com/xmanrui/dsh-im) | 1424 | 🟢 ok | 通过扫码把IM机器人接入DeepSeek Harness（支持飞书、微信、钉钉、QQ、企业微信等） |
...
| [Better_Deepseek_Harness](https://github.com/silencieuxzero/Better_Deepseek_Harness) | 2 | ⚪ unknown | Better Deepseek Harness, with some functional extensions to webui and Deepseek Harness·更好的deepseek harness，对webui和deepseek harnes… |
...
| [dsh-whale-musume](https://github.com/Sutera-Diffusus/dsh-whale-musume) | 76 | 🟢 ok | DeepSeek Harness 桌宠插件：元气鲸鱼娘陪你写代码 🐋 |
...
| [DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 2828 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DeepSeek Harness（DSH）一只住在 DSH 界面右下角的小鲸鱼娘，帮你盯着DeepSeek账户余额。QQ弹弹，支持拖拽吸附、左吸附翻转、数字滚动动画，随界面自动启用，建议直接喊来你的dsh安装 |
...
| [dsh-codex-ui](https://github.com/MichengAI/dsh-codex-ui) | 88 | 🟢 ok | DSH Codex UI 基于 DeepSeek Harness 的 Codex UI 插件，还原度90%，小细节拉满 |
...
| [dsh-agy-link](https://github.com/amlyczz/dsh-agy-link) | 74 | 🟢 ok | Google Antigravity (agy CLI) models for DeepSeek Harness — streaming chat, thinking, tool activity, usage, in-GUI Google OAuth lo… |
...
| [dsh-comfyui](https://github.com/fandc520/dsh-comfyui) | 78 | 🟢 ok | 一个基于DeepSeek-Harness的ComfyUI插件 |
| [dsh-uiskin-theme](https://github.com/chouxiaohuai/dsh-uiskin-theme) | 30 | ⚪ unknown | Blue Glass Theme (ocean fantasy) for DeepSeek Harness Web — static profile bundle. 海洋幻想主题:海洋背景、玻璃气泡、海洋侧边栏、鲸鱼设置按钮、炫彩模型文字。安装: dsh p… |
...
| [dsh-tavern-v2](https://github.com/chen731215-dev/dsh-tavern-v2) | 27 | ⚪ unknown | DeepSeek Harness Tavern Plugin - character card roleplay, worldbook management, preset switching, dark theme, memory summary, rel… |
...
| [dsh-infinite-gen-4](https://github.com/Minglink/dsh-infinite-gen-4) | 1836 | 🟢 ok | DeepSeek v4.1 flash 网络安全红队工具（无限四代） — jailbreak prompts and test suite for DeepSeek 求 Star 收藏 ⭐ |
...
| [dsh-plugin-kit](https://github.com/hyzyn/dsh-plugin-kit) | 26 | ⚪ unknown | Plugin family for the DeepSeek Harness (DSH) Web GUI: a pnpm monorepo with a plugin template, dev kit, and one-command all-in-one… |
| [oh-my-dsh](https://github.com/gulagala001/oh-my-dsh) | 13 | ⚪ unknown | 让你的 DSH，火力全开。长上下文、任务验证、提示词优化、代码理解、电脑操作与四套完整主题。 |
...
| [dsh-claude-move](https://github.com/PerryLink/dsh-claude-move) | 26 | 🟢 ok | DeepSeek Harness (dsh) plugin: migrate Claude Code sessions, memory, skills and CLAUDE.md into DSH with seamless resume (claude_s… |
...
| [billion-context-dsh](https://github.com/Tyan66666/billion-context-dsh) | 104 | 🟢 ok | Model-driven context management (Active Context Pruning / ACP) for the DeepSeek Harness — the model decides when and what to comp… |
...
| [dsh-mneme](https://github.com/modusensus/dsh-mneme) | 114 | 🟢 ok | dsh-mneme — DSH plugin (session) |
...
| [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) | 189 | 🟢 ok | Second-model AI auto-review for DeepSeek Harness approval requests: a read-only reviewer subagent returns structured allow/deny v… |
...
| [dsh-multi-tenant](https://github.com/GuoMonth/dsh-multi-tenant) | 11 | 🟢 ok | Multi-tenant SaaS extension for DeepSeek Harness (DSH): tenant identity, session isolation, authorization, tenant-aware MCP, and… |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 1459 | 🟢 ok | A DeepSeek Harness plugin for Context insight panel — a Context tab in the web UI showing what the model's context window is made… |
...
| [dsh-memory](https://github.com/FuRongJun-1999/dsh-memory) | 230 | 🟢 ok | Multi-agent spatiotemporal memory graph for DeepSeek Harness.Cross-session persistence, knowledge flywheel, importance-gated memo… |
...
| [dsh-browser](https://github.com/wqty123/dsh-browser) | 72 | 🟢 ok | Shared real browser plugin for DeepSeek Harness |
...
| [dsh-web-mobile](https://github.com/mexiaosqwq/dsh-web-mobile) | 98 | 🟢 ok | DeepSeek Harness Web UI 移动端适配插件:窄屏下侧边栏变为 overlay 抽屉,会话独占全宽。 |
...
| [MemOS](https://github.com/MemTensor/MemOS) | 11496 | ⚪ unknown | Self-evolving memory OS for LLM & AI Agents: ultra-persistent memory, hybrid-retrieval, and cross-task skill reuse, with 35.24% t… |
...
| [dsh-rewind](https://github.com/SiriLee/dsh-rewind) | 83 | 🟢 ok | DeepSeek Harness plugin: in-place conversation rewind in the same session window (Claude Code /rewind semantics) + optional file… |
...
| [dsh-adult-tension](https://github.com/daha1216/dsh-adult-tension) | 56 | ⚪ unknown | DeepSeek Harness 成年人(18+/adult)互动叙事 Skill：NPC 活人感（有记忆/立场/底线）、自带破甲、数百项素材库、随机开局可预锁、时间推进、全维 YAML 存档。 |
...
| [dsh-sessions-manager](https://github.com/TOBYCAI/dsh-sessions-manager) | 14 | 🟢 ok | Session manager in DSH settings: archive/restore/hard-delete/move to other workspace, with workspace tags and session dates. |
...
| [dsh-nexttavern](https://github.com/a86582751/dsh-nexttavern) | 92 | 🟢 ok | 原生 Agent 驱动的长篇角色扮演：交互式创作、主动世界书、动态记忆、多角色推演与小说导出。创作一个世界，走进它，再把它带走。 |
...
| [dsh-project-brain](https://github.com/yj-liuzepeng/dsh-project-brain) | 40 | 🟢 ok | Persistent project intelligence and memory plugin for DSH: architecture analysis, cross-session context, TODOs, and optional hybr… |
| [dsh-session-workbench](https://github.com/PolinniZhong/dsh-session-workbench) | 26 | ⚪ unknown | Session Workbench for DeepSeek Harness: session-library full-text search + recall + conversation-view management (show/hide + reo… |
...
| [dsh-mneme](https://github.com/slow-stack/dsh-mneme) | 114 | ⚪ unknown | The memory that dreams — cross-session memory for DeepSeek Harness. Offline & private, auto-consolidates in its sleep (autoDream)… |
...
| [dsh-vision](https://github.com/william-jin-cmu/dsh-vision) | 31 | 🟢 ok | view_image tool bridging any OpenAI-compatible VLM |
...
| [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) | 299 | 🟢 ok | Unofficial DeepSeek Harness LLM provider plugin for Command Code: live model catalog, reasoning-effort support, Models-page card.… |
| [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) | 374 | 🟢 ok | Use ChatGPT (Codex), Claude, and Grok (X Premium) subscriptions as DeepSeek Harness LLM providers — OAuth login in the web UI, no… |
...
| [dsh-reasoning-effort](https://github.com/HanaAyane/dsh-reasoning-effort) | 149 | 🟢 ok | DSH适用的Codex风格的思考强度滑块，以及大肥鱼跑步滑块。Codex-style model and reasoning-effort slider for DeepSeek Harness |
...
| [dsh-image-gen](https://github.com/shanliuling/dsh-image-gen) | 445 | 🟢 ok | Installable multi-provider image generation bundle for DeepSeek Harness (Google Gemini, OpenAI, Volcengine Seedream) |
...
| [tongflow](https://github.com/tong-io/tongflow) | 1023 | ⚪ unknown | TongFlow — multimodal AIGC workflow engine (canvas + Python plugin engine) and dsh-tongflow, the DeepSeek Harness studio plugin |
...
| [dsh-purge](https://github.com/YuJunZhiXue/dsh-purge) | 1684 | 🟢 ok | DeepSeek Harness 破甲：让所有模型都能破甲，不同模型可换不同提示词；默认提示词面向国模「小码酱」。Jailbreak for every model — swap prompts per model. 求 Star 收藏 ⭐ |
...
| [dsh-browser](https://github.com/omdsh-dev/dsh-browser) | 706 | 🟢 ok | Chrome sidebar extension that lets DeepSeek Harness operate your browser directly, no vision capabilities required. 一款 Chrome 侧边栏… |
...
| [mirage-dsh](https://github.com/strukto-ai/mirage) | 3645 | 🟢 ok | Swap DSH's fs/shell providers for a mirage virtual workspace: file tools and shell commands act on mounted resources (RAM, disk,… |
...
| Plugin | ⭐ | Compat | Description |
|---|---|---|---|
| [openhanako](https://github.com/liliMozi/openhanako) | 6608 | ⚪ unknown | Personal AI agent with memory, personality and autonomy |
...
| [ccteam](https://github.com/firstintent/ccteam) | 604 | ⚪ unknown | Orchestrates Claude Code/Codex/Grok/Kimi into one team |
...
| [distill](https://github.com/LoserFox/distill) | 27 | ⚪ unknown | Auto conversation distillation: background subagent reflection |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1754 | 🟢 ok | AgentTeams plugin |
| [dsh-automation](https://github.com/titanwings/dsh-automation) | 98 | 🟢 ok | Run scheduled tasks in fresh sessions per plan |
...
| [dsh-milestone](https://github.com/SnowCrescenter-tech/dsh-milestone) | 26 | 🟢 ok | Git-style milestone timeline plugin. |
...
| [Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 3385 | ⚪ unknown | VibeSkills is a general-purpose Skill that automatically routes local Skills and intelligently orchestrates harness workflows. |
...
| [dsh-chinese-traditional-wisdom-skill](https://github.com/dhicoc/dsh-chinese-traditional-wisdom-skill) | 41 | ⚪ unknown | 中华传统智慧（玄枢）AI Agent 技能包的 DeepSeek Harness（dsh）Cordis 插件：八字/紫微/六爻/梅花/奇门/风水/五运六气/体质全融合，本地确定性引擎 + 可视化 Dashboard，一行 dsh plugin add 安装。 |
...
| [dsh-tavern](https://github.com/flizzywine/dsh-tavern) | 426 | 🟢 ok | 基于 DeepSeek Harness（DSH）的 SillyTavern 类文字游戏 Agent，支持候选项生成、对话式人物卡编辑、剧本模式与素材抽取。 |
...
| [dsh-Mimir-Academic-research](https://github.com/1692775560/dsh-Mimir-Academic-research) | 519 | ⚪ unknown | Mimir — 一站式科研工作台插件：LaTeX 论文边写边编译、arXiv 文献管理、实验追踪、指标图表、GPU 服务器 SSH 任务编排，管理科研全周期。An open-source research workbench plugin for the w… |
...
| [loopx](https://github.com/huangruiteng/loopx) | 5911 | ⚪ unknown | Long-horizon agent control plane for durable, governed work across Codex, Claude Code, and other harnesses. |
...
| [pi-web-ui](https://github.com/xing-shuyin/pi-web-ui) | 215 | ⚪ unknown | dsh / pi-agent web ui |
...
| [dsh-hub-cli](https://github.com/pax-beehive/dsh-hub-cli) | 415 | ⚪ unknown | Open-source CLI, schemas, resolver, and DSH agent tools for DSH Plugin Hub |
...
| [dsh-browser-control](https://github.com/caob23/dsh-browser-control) | 17 | 🟢 ok | Chrome 浏览器扩展 + DeepSeek Harness 插件，让 AI Agent 直接操控你的真实浏览器。 |
| [Openwrite](https://github.com/LiPu-jpg/Openwrite) | 744 | ⚪ unknown | dsh-Openwrite：OpenWrite 的 DeepSeek Harness 小说创作插件，含统一创作 Agent、90 个小说工具、原生工作台与标准审稿 DAG |
...
| [dsh-ontology](https://github.com/tancheng33/dsh-ontology) | 13 | 🟢 ok | A typed, inference-capable ontology (TBox + ABox) plugin for DeepSeek Harness — durable domain knowledge the agent declares, asse… |
| [loopx](https://github.com/loopx-project/loopx) | 5911 | ⚪ unknown | Long-horizon agent control plane for durable, governed work across Codex, Claude Code, and other harnesses. |
...
| [jev-dsh-decision](https://github.com/Devin-AXIS/jev-dsh-decision) | 43 | ⚪ unknown | Jev DSH 决策引擎｜面向 Agent Harness 的结构化决策插件。原生支持 DeepSeek Harness，通过 iPolloWork 支持 OpenCode、Codex Harness。 |
...
| [dsh-remote](https://github.com/flymysql/dsh-remote) | 89 | 🟢 ok | Remote-access assistant for DeepSeek Harness: /remote command and settings page printing the exact SSH tunnel / reverse-tunnel /… |
...
| [deepseek-harness-mobile](https://github.com/sorsama/deepseek-harness-mobile) | 90 | ⚪ unknown | Android companion for DeepSeek Harness | chat, goals, approvals & notifications from your phone, over your LAN. Kotlin + Jetpack… |
...
| [dsh-IDE](https://github.com/chenw2759-wq/dsh-IDE) | 38 | 🟢 ok | 这是一个ssh前端程序，可以让UI体现类似lab的功能！用于远程ssh快速相应，同时可以直接在前端操作/查看远程服务器上的信息与代码。 |
...
| [dsh-pocket](https://github.com/shaobeichen/dsh-pocket) | 1260 | 🟢 ok | 把 DeepSeek Harness 装进你的口袋：电脑上跑 dsh web，手机扫码即同步访问（局域网 + 公网，实时同屏） |
...
| [dsh-web-startup-auth](https://github.com/GDWhisper/dsh-web-startup-auth) | 48 | 🟢 ok | DSH（DeepSeek Harness）远程 Web 启动 + 用户名/密码认证插件。 | DeepSeek Harness Remote‑Web‑Launch Plugin with Username/Password Auth |
...
| Plugin | ⭐ | Compat | Description |
|---|---|---|---|
| [EchoBird](https://github.com/edison7009/EchoBird) | 3265 | ⚪ unknown | One-click install + model switch across 20+ coding agents |
...
| [awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 1086 | ⚪ unknown | DSH ecosystem curation: plugins, tools, infra |
| [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 281 | 🟢 ok | DeepSeek Harness terminal UI |
...
| [awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 350 | ⚪ unknown | Bilingual complete list of the DSH plugin ecosystem |
...
> 1936 entries total, grouped by category, sorted by ⭐ within each. Schema dictionary: [docs/catalog-schema.md](docs/catalog-schema.md).
<!-- CATALOG:END -->
