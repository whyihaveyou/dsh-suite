...
![Plugins](https://img.shields.io/badge/plugins-983-facc15?style=flat-square)
...
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 1689 | ⚪ unknown | DSH Web UI plugin & skin collection: task board, git panel, etc. |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 681 | ⚪ unknown | Sidebar workbench: file render/terminal/git/subagent |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 504 | ⚪ unknown | DSH Web whale-girl skin series |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 301 | ⚪ unknown | Vision for text-only models: image QA, screenshot OCR, UI reconstruction |
...
| [ui-status-label](https://github.com/alingalingling/ui-status-label) | 28 | ⚪ unknown | Customize the whale-girl thinking-status label |
...
| [dsh-harness-ops](https://github.com/fakechris/dsh-harness-ops) | 7 | ⚪ unknown | Ops toolkit: daily snapshot A/B slots, one-click rollback |
| [dsh-inspect](https://github.com/omdsh-dev/dsh-inspect) | 3 | ⚪ unknown | Adversarial checkup→fix→review loop plugin |
| [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) | 5 | ⚪ unknown | OpenMAIC: classrooms, slides, interactive widgets |
| [dsh-plugin-mineru](https://github.com/HuanLinOTO/dsh-plugin-mineru) | 9 | ⚪ unknown | MineRU document parsing tools |
...
| [ego-browser](https://github.com/Fisfzy/ego-browser) | 11 | ⚪ unknown | Bridge ego-lite Chromium browser into DSH |
...
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 78 | ⚪ unknown | Chrome sidebar extension letting DSH drive the browser. |
| [dsh-openapi](https://github.com/Degurechaff57/dsh-openapi) | 4 | ⚪ unknown | Safe OpenAPI 3.x discovery & API calling tools. |
| [dsh-better-browser](https://github.com/titanwings/dsh-better-browser) | 4 | ⚪ unknown | Let agents drive the logged-in browser via Kimi WebBridge. |
...
| [deepseek-pet](https://github.com/keleus/deepseek-pet) | 6 | ⚪ unknown | deepseek-pet — DSH plugin (tools) |
...
| [dsh-annotate](https://github.com/BrambleXu/dsh-annotate) | 4 | ⚪ unknown | Visual browser element annotation for DeepSeek Harness, capturing DOM, styles, accessibility data, comments, and viewport screens… |
| [dsh-codex-connect](https://github.com/franksong2702/dsh-codex-connect) | 3 | ⚪ unknown | ChatGPT OAuth and Codex models for DeepSeek Harness. |
| [DSH-Decktop](https://github.com/JustGenius-s/DSH-Decktop) | 17 | ⚪ unknown | DSH-Decktop |
...
| [dsh-robotic-harness](https://github.com/dingkaihu63/dsh-robotic-harness) | 10 | ⚪ unknown | Robotic Harness: embodied-intelligence research tools for DeepSeek Harness - robot asset inspection, MuJoCo pick-place simulation… |
...
| [dsh-user-experience](https://github.com/DietCokewithSugar/dsh-user-experience) | 15 | ⚪ unknown | Persona-driven UX walkthrough plugin for DeepSeek Harness (DSH) - scans React + TypeScript source code for UX issues, pinpoints t… |
...
| [dsh-toy](https://github.com/c3ll256/dsh-toy) | 17 | ⚪ unknown | Toy Control Protocol for DSH |
...
| [dsh-mindmap](https://github.com/chenw2759-wq/dsh-mindmap) | 2 | ⚪ unknown | DSH 思维导图模式插件：课件(PPT/PDF/Word)+电子书 → 打印级复习思维导图 HTML（A3 横向、每主干一页、大括号式横向、宋体、右栏笔记区、封面总览 + 交互式测试题） |
...
| [dsh-pet](https://github.com/PC2005-cloud/dsh-pet) | 3 | ⚪ unknown | DeepSeek Harness 桌面宠物插件 + 完整素材生成链：AI 提示词 → 绿幕视频 → 透明动画 → 可安装插件，从零到宠物全流程可复现 |
...
| [dsh-agy](https://github.com/chaos-03x/dsh-agy) | 1 | ⚪ unknown | Google Antigravity (agy) OAuth auth + model access plugin for DeepSeek Harness: multi-account pool, 429 rotation, device fingerpr… |
...
| [superpowers-dsh](https://github.com/LayneChai/superpowers-dsh) | 13 | ⚪ unknown | Superpowers skills for DeepSeek Harness: TDD, debugging, planning, and collaboration skills adapted from obra/superpowers |
| [dsh-skill-viewer](https://github.com/Fishquito7/dsh-skill-viewer) | 12 | ⚪ unknown | DSH Web UI plugin: Skills settings section with hot enable/disable, delete and add |
...
| [ui-status-label](https://github.com/alingalingling/ui-status-label) | 28 | ⚪ unknown | Customize the whale-girl thinking-status label |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 504 | ⚪ unknown | DSH Web whale-girl skin series |
| [dsh-focus-chat](https://github.com/dingyi222666/dsh-focus-chat) | 12 | ⚪ unknown | Focused-chat minimal session view |
| [dsh-side-panel](https://github.com/ccq1/dsh-side-panel) | 18 | ⚪ unknown | DSH side panel: file browser, terminal, git review |
...
| [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) | 38 | ⚪ unknown | Selection annotation: select→annotate→send |
...
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 71 | ⚪ unknown | Inline interactive UI components in chat |
| [dsh-input-history](https://github.com/lhh010/dsh-input-history) | 4 | ⚪ unknown | Input history: Ctrl+Up/Down to recall sent messages |
| [dsh-navbar](https://github.com/vlln/dsh-navbar) | 13 | ⚪ unknown | Conversation node navbar |
...
| [dsh-qq2006](https://github.com/LaplaceYoung/dsh-qq2006) | 7 | ⚪ unknown | QQ2006 skin plugin |
...
| [dsh-web-ui-notify](https://github.com/bill9109/dsh-web-ui-notify) | 7 | ⚪ unknown | Desktop notifications for DSH |
| [ex-setting](https://github.com/omdsh-dev/ex-setting) | 2 | ⚪ unknown | DSH settings extension |
| [whale-girl](https://github.com/vlln/whale-girl) | 118 | ⚪ unknown | QQ-pet-style desktop pet plugin |
| [dsh-status-rotator](https://github.com/01Virex/dsh-status-rotator) | 5 | ⚪ unknown | Web plugin replacing the DSH status display. |
...
| [deepseek-harness-skin](https://github.com/HeiGeAi/deepseek-harness-skin) | 18 | ⚪ unknown | deepseek-harness-skin — DSH plugin (ui) |
...
| [dsh-pet](https://github.com/FlytoMAYDAY80/dsh-pet) | 3 | ⚪ unknown | dsh-pet — DSH plugin (ui) |
...
| [dsh-web-attention-badge](https://github.com/Luaphes/dsh-web-attention-badge) | 2 | ⚪ unknown | Attention reminders for the DeepSeek Harness Web UI: frame badge, (N) tab title and whale-favicon recolor for sessions waiting fo… |
...
| [dsh-plugin-workshop](https://github.com/yyyyukari/dsh-plugin-workshop) | 9 | ⚪ unknown | Steam Workshop-style in-app plugin browser for DeepSeek Harness (DSH) Web UI - zero-server: search, trending windows, Chinese sea… |
| [dsh-funpack](https://github.com/lvyuchuiyi/dsh-funpack) | 3 | ⚪ unknown | ??????????????????????? DeepSeek Harness ?? |
...
| [dsh-meme-hub](https://github.com/the-beating-light-of-the-nail/dsh-meme-hub) | 8 | ⚪ unknown | The meme side of DeepSeek Harness — 贪玩蓝鲸/QQ2006/whale girls/mini-games · A curated tour of the wildest dsh plugins |
...
| [dsh-undo-plugin](https://github.com/lire1131/dsh-undo-plugin) | 3 | ⚪ unknown | DSH plugin: snapshot & rollback your plugin/skin/settings configs. Auto-save on change, undo/redo stack, snapshot manager panel,… |
| [plugin-manager](https://github.com/whyihaveyou/dsh-suite) | 7 | 🟢 ok | In-app plugin store for DSH Web UI: browse the dsh-suite catalog, search/filter/sort, compat badges, one-click install — a Store… |
...
| [dsh-whale-report](https://github.com/SenmuuuuW/dsh-whale-report) | 4 | ⚪ unknown | 鲸鱼记事本 — 你的 Agent 年度报告：从会话事件日志生成日报/周报/月报/年报，任意区间、只读不改写 |
...
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 47 | ⚪ unknown | Cross-session long-term memory + background self-evolution |
...
| [plugin-session-export](https://github.com/whyihaveyou/dsh-suite) | 3 | 🟢 ok | Export the append-only session log as human-readable Markdown / HTML, grouped by trajectory source (system prompt / reasoning / t… |
| [dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) | 20 | ⚪ unknown | Import chat history from Claude Code/Codex/Reasonix into DSH. |
| [dsh-stream-rules](https://github.com/jiesou/dsh-stream-rules) | 3 | ⚪ unknown | Inject rules on demand without wasting context. |
| [dsh-compaction-instant](https://github.com/KitDoesIt/dsh-compaction-instant) | 6 | ⚪ unknown | LLM-free lossless compaction engine. |
...
| [dsh-model-config-sync](https://github.com/LiangYin233/dsh-model-config-sync) | 8 | ⚪ unknown | dsh-model-config-sync — DSH plugin (session) |
...
| [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) | 7 | ⚪ unknown | dsh-cost-meter — DSH plugin (session) |
...
| [dsh-token-panel](https://github.com/juhe291/dsh-token-panel) | 2 | ⚪ unknown | Real-time token consumption HUD plugin for DeepSeek Harness. Live token usage monitor, context pressure, cost estimation, history… |
...
| [dsh-token-monitor](https://github.com/zhangzheng25/dsh-token-monitor) | 2 | ⚪ unknown | DeepSeek Harness plugin: token usage & conversation stats as a native settings page - today / 7d / 30d totals, GitHub-style 90-da… |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 18 | ⚪ unknown | A DeepSeek Harness plugin for Context insight panel — a Context tab in the web UI showing what the model's context window is made… |
...
| [dsh-provider-model-configurator](https://github.com/LiangYin233/dsh-provider-model-configurator) | 8 | ⚪ unknown | DSH 高级模型配置器：为 DeepSeek Harness 提供将 pi-ai 预设模型的上下文、输出上限、推理挡位一键应用到自定义提供商的能力。 |
...
| [dsh-billing](https://github.com/TheTianzz/dsh-billing) | 3 | ⚪ unknown | DeepSeek Harness plugin: 账户余额 + 会话费用（/balance /cost 命令、deepseek_billing 工具、Web UI 双胶囊），官方价格每 12 小时自动同步 |
...
| [dsh-client-pricing](https://github.com/Miyazawai/dsh-client-pricing) | 3 | ⚪ unknown | 会话顶栏实时显示 DeepSeek API 价格（峰谷定价 / 现行一口价，flash / pro 自动切换） | DeepSeek Harness client plugin: live DeepSeek API pricing badge (peak/o… |
...
| [blender](https://github.com/CheshireJCat/blender) | 2 | ⚪ unknown | DeepSeek Harness plugin for complete Blender 3D modeling, reconstruction, rendering, validation, and export workflows |
...
| [dsh-task-planner](https://github.com/ztl34245881-commits/dsh-task-planner) | 1 | ⚪ unknown | Task planning with experience muscle-memory for DeepSeek Harness: condition-reflex recall + LLM capability matching + auto-persis… |
...
| [dsh-vision](https://github.com/william-jin-cmu/dsh-vision) | 16 | ⚪ unknown | view_image tool bridging any OpenAI-compatible VLM |
| [modlens](https://github.com/liustack/modlens) | 1148 | ⚪ unknown | The first vision plugin for DeepSeek Harness — let text-only models see. |
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 800 | ⚪ unknown | Vision toolbox & skills for text-only models: multi-image QA, UI reconstruction, GUI automation. |
...
| [dsh-recommend](https://github.com/zp-home/dsh-recommend) | 9 | ⚪ unknown | dsh-recommend — DSH plugin (llm) |
...
| [dsh-vision](https://github.com/oil-oil/dsh-vision) | 10 | ⚪ unknown | Near-native image understanding for DeepSeek Harness |
...
| [dsh-llm-codebuddy](https://github.com/Axiaohungry/dsh-llm-codebuddy) | 4 | ⚪ unknown | 在deepseek harness中使用workbuddy api，因为公司只提供workbuddy积分 |
...
| [dsh-vision](https://github.com/linenxi-ctrl/dsh-vision) | 8 | ⚪ unknown | 为 DeepSeek Harness 增加外挂识图模型：圆形鲸鱼按钮、发送图片识图自动回传、模型自主截图+识图工具、多协议自动适配、小白一键安装（未装 Node.js 自动下载） |
...
| Plugin | ⭐ | Compat | Description |
|---|---|---|---|
| [openhanako](https://github.com/liliMozi/openhanako) | 6040 | ⚪ unknown | Personal AI agent with memory, personality and autonomy |
| [exo](https://github.com/exoharness/exo) | 645 | ⚪ unknown | Fully recursive agent+harness that self-edits at runtime |
| [synergy](https://github.com/SII-Holos/synergy) | 542 | ⚪ unknown | General-purpose agent for the Open Agentic Web |
| [ccteam](https://github.com/firstintent/ccteam) | 153 | ⚪ unknown | Orchestrates Claude Code/Codex/Grok/Kimi into one team |
...
| [distill](https://github.com/LoserFox/distill) | 15 | ⚪ unknown | Auto conversation distillation: background subagent reflection |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 222 | ⚪ unknown | AgentTeams plugin |
| [dsh-automation](https://github.com/titanwings/dsh-automation) | 27 | ⚪ unknown | Run scheduled tasks in fresh sessions per plan |
| [dsh-loop](https://github.com/vlln/dsh-loop) | 3 | ⚪ unknown | Scheduled loop (/loop command + tool) |
| [dsh-plannotator](https://github.com/titanwings/dsh-plannotator) | 3 | ⚪ unknown | Plan annotator: annotate plan text line-by-line |
...
| [deepseek-harness-fnos](https://github.com/techysy/deepseek-harness-fnos) | 3 | ⚪ unknown | deepseek-harness-fnos — DSH plugin (orchestration) |
...
| [dsh-phone](https://github.com/railgun0325/dsh-phone) | 1 | ⚪ unknown | 让 DeepSeek Harness 的 agent 跑在手机里，通过 Magisk root 原生操作安卓系统（截图/点击/滑动/开应用）+ 移动端布局 + WebView APK |
...
| [dsh-kun-like-pet](https://github.com/liyupi/dsh-kun-like-pet) | 11 | ⚪ unknown | Kun Like 桌宠 —— DeepSeek Harness 桌面宠物插件：右下角小坤宠随 Agent 工作状态切换 9 种动作，任务完成播放「你干嘛~哎哟」 |
| [dsh-file-review](https://github.com/left0ver/dsh-file-review) | 2 | ⚪ unknown | a dsh plugin - review files that an agent just changed,you can see the diff |
...
| [Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 2727 | ⚪ unknown | VibeSkills is a general-purpose Skill that automatically routes local Skills and intelligently orchestrates harness workflows. |
...
| [dsh-file-explorer](https://github.com/Zalpha263/dsh-file-explorer) | 1 | ⚪ unknown | 可以像其他agent一样查看当前工作区的文件夹，并且可以预览文件 |
...
| [dsh-balance](https://github.com/crazywoola/dsh-balance) | 5 | ⚪ unknown | DeepSeek Harness balance plugin for the Settings page |
...
| [awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) | 749 | ⚪ unknown | DSH plugin directory with daily compatibility tracking |
| [deepseek-harness-applicants](https://github.com/Octo-o-o-o/deepseek-harness-applicants) | 49 | ⚪ unknown | DSH internal-test applicants list |
| [awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 357 | ⚪ unknown | DSH ecosystem curation: plugins, tools, infra |
| [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 124 | ⚪ unknown | DeepSeek Harness terminal UI |
| [agent-skills](https://github.com/GitHubxsy/agent-skills) | 20 | ⚪ unknown | Reusable skills for AI coding agents |
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 116 | ⚪ unknown | Codex-style @file mentions for DeepSeek Harness: search workspace files in the composer and attach their contents to prompts. |
...
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 306 | ⚪ unknown | 2005-style sidebar ads plugin (parody) |
...
| [oh-dsh-desktop](https://github.com/hust-open-atom-club/oh-dsh-desktop) | 157 | ⚪ unknown | Extensible macOS DSH workbench with native PTY |
| [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) | 74 | ⚪ unknown | In-chat generative UI: interactive HTML cards |
| [awesome-DSH-plugin](https://github.com/Alex-Yanggg/awesome-DSH-plugin) | 47 | ⚪ unknown | Curated list of DSH plugins, extensions and tools |
| [oh-my-dsh](https://github.com/LaplaceYoung/oh-my-dsh) | 43 | ⚪ unknown | DSH plugin ecosystem (700+ plugins) |
| [dsh-gomoku](https://github.com/omdsh-dev/dsh-gomoku) | 11 | ⚪ unknown | Play Gomoku against AI in DSH |
...
| [dsh-stock-market](https://github.com/AnacondaKC/dsh-stock-market) | 10 | ⚪ unknown | Parody: lose money while coding |
| [Top](https://github.com/xiaohai-78/Top) | 5 | ⚪ unknown | Daily leaderboard for the dsh-external plugin ecosystem |
| [awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 85 | ⚪ unknown | Bilingual complete list of the DSH plugin ecosystem |
| [dsh-launcher](https://github.com/Ruler4396/dsh-launcher) | 64 | ⚪ unknown | WebView2-based DSH launcher |
...
| [plugin-registry](https://github.com/vlln/plugin-registry) | 31 | ⚪ unknown | DSH plugin registry infra: browser panel for official repository plugins |
| [create-dsh-plugin](https://github.com/whyihaveyou/dsh-suite) | 3 | 🟢 ok | Scaffold a DeepSeek Harness (DSH) plugin in seconds — tool / events / webui templates, next-tag version pinning, and a built-in -… |
...
> 983 entries total, grouped by category, sorted by ⭐ within each. Schema dictionary: [docs/catalog-schema.md](docs/catalog-schema.md).
<!-- CATALOG:END -->
