...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 7932 | 🟢 ok | DSH Web UI 插件与皮肤合集：任务板、Git 面板等 |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3712 | 🟢 ok | 侧边栏完整工作台：文件渲染/终端/Git/子代理 |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 2180 | ⚪ unknown | DSH Web 鲸鱼娘皮肤系列（深海女仆工坊） |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 395 | 🟢 ok | Mnemon 三层记忆体深度集成 |
...
| [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) | 78 | 🟢 ok | OpenMAIC：课堂/幻灯片/交互式组件 |
...
| [ego-browser](https://github.com/Fisfzy/ego-browser) | 187 | 🟢 ok | 把 ego-lite 浏览器接入 DSH（给 Agent 用的 Chromium） |
...
| [modsearch](https://github.com/liustack/modsearch) | 524 | ⚪ unknown | DeepSeek Harness 的联网搜索插件。 |
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 715 | 🟢 ok | Chrome 侧边栏扩展，让 DSH 操控浏览器。 |
...
| [dsh-expression](https://github.com/yyh-001/dsh-expression) | 100 | 🟢 ok | 找得到、发得出 —— DSH 表情包插件：语义搜图，只发真实文件，走 companion QQ 通道 |
...
| [dsh-codex-subscription](https://github.com/WSL043/dsh-codex-subscription) | 88 | 🟢 ok | dsh-codex-subscription — DSH 插件（工具） |
...
| [anysearch-dsh](https://github.com/anysearch-team/anysearch-dsh) | 427 | 🟢 ok | AnySearch 联网搜索接入：给 DSH 配上 AnySearch 的搜索 provider 和进阶搜索工具。 |
...
| [dsh-agy](https://github.com/chaos-03x/dsh-agy) | 43 | 🟢 ok | Google Antigravity (agy) 接入：OAuth 授权 + 多账号池 + 429 自动轮换 + 设备指纹。 |
...
| [dsh-anchored-standard](https://github.com/xiaobright/dsh-anchored-standard) | 3800 | ⚪ unknown | 两段式 Agent 预设：先用精简配置快速启动，再切换到完整 Standard 工具集，兼顾启动速度与全功能。 |
...
| [Deepseek-Harness-for-VS-Code](https://github.com/Vithrive/Deepseek-Harness-for-VS-Code) | 29 | ⚪ unknown | untranslated |
...
| [dsh-pentest](https://github.com/howmp/dsh-pentest) | 529 | 🟢 ok | untranslated |
...
| [helm-d](https://github.com/ADWMC/helm-d) | 73 | ⚪ unknown | untranslated |
...
| [dsh-voice-ai-girlfriend](https://github.com/beiyege-01/dsh-voice-ai-girlfriend) | 114 | ⚪ unknown | untranslated |
...
| [dsh-wallpaper-engine](https://github.com/elysia395/dsh-wallpaper-engine) | 326 | 🔴 broken (failed once, retried — install blocked by pnpm build-script policy (allowBuilds) — plugin likely OK, CI policy blocks git prepare scripts) | untranslated |
...
| [dsh-meme](https://github.com/yyh-001/dsh-meme) | 100 | 🟢 ok | untranslated |
...
| [dsh-univer-office](https://github.com/dream-num/dsh-univer-office) | 382 | 🟢 ok | untranslated |
...
| [dsh-redteam-model](https://github.com/SeaOf0/dsh-redteam-model) | 571 | 🟢 ok | untranslated |
...
| [dsh-preset-plus](https://github.com/Rain-kl/dsh-preset-plus) | 132 | 🟢 ok | untranslated |
...
| [dsh-infinite-gen-2](https://github.com/Minglink/dsh-infinite-gen-2) | 1892 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | untranslated |
...
| [dsh-research-report](https://github.com/PerryLink/dsh-research-report) | 152 | 🟢 ok | untranslated |
...
| [dsh-infinite-gen-3](https://github.com/Minglink/dsh-infinite-gen-3) | 1892 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | untranslated |
| [dsh-diagram](https://github.com/hanzhangzzz/dsh-diagram) | 13 | 🟢 ok | untranslated |
| [@xxxyz/dsh-mcp-manager](https://github.com/xxxyz/DeepSeekHarness-MCP-Manager) | 20 | 🟢 ok | DSH 双管理器——MCP 服务管理（设置页新增/编辑/启停/重启/删除、JSON 导入导出、4 个 mcp_manager_* 模型工具、带闸门的本地 HTTP API）+ Skills 技能管理（启停面板、持久化、HMR 即时生效）。 |
...
| [dsh-plugin-shop](https://github.com/LivXue/dsh-plugin-shop) | 863 | 🟢 ok | untranslated |
...
| [dsh-image-gen-goodandready](https://github.com/GooDAnDReaDY/dsh-image-gen) | 5 | 🟢 ok | generate_image 图像生成工具：走 FAL 队列 / 任意 OpenAI 兼容图像 API / ChatGPT·Grok 订阅，结果内联显示在会话里。 |
...
| [dsh-connect-workbuddy](https://github.com/dingminhua/dsh-connect-workbuddy) | 33 | 🟢 ok | untranslated |
...
| [clearai-dsh](https://github.com/Clearailhc/clearai-dsh) | 366 | 🟢 ok | untranslated |
...
| [dsh-opencode-go](https://github.com/Duskriver/dsh-opencode-go) | 24 | 🟢 ok | untranslated |
| [DSH-X](https://github.com/yyh-001/DSH-X) | 280 | ⚪ unknown | untranslated |
...
| [dsh-preset-enhance](https://github.com/bychv/dsh-preset-enhance) | 16 | 🟢 ok | untranslated |
...
| [dsh-skill-viewer](https://github.com/Fishquito7/dsh-skill-viewer) | 144 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | 技能管理面板：在设置页直接启用/停用、删除、添加 Skills，不用改配置文件。 |
...
| [dsh-skill-mcp-panel](https://github.com/Fishquito7/dsh-skill-mcp-panel) | 144 | 🟢 ok | untranslated |
...
| [new-litigation-visualization](https://github.com/MiaoQichuan/new-litigation-visualization) | 61 | ⚪ unknown | untranslated |
| [oh-story-dsh](https://github.com/worldwonderer/oh-story-dsh) | 395 | ⚪ unknown | untranslated |
...
| [oh-story-dsh](https://github.com/zenstory-ai/oh-story-dsh) | 395 | ⚪ unknown | untranslated |
...
| [dsh-normify](https://github.com/yan-mc/dsh-normify) | 61 | 🟢 ok | untranslated |
...
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 473 | 🟢 ok | 会话内联渲染交互式 UI 组件 |
...
| [dsh-doublecheck](https://github.com/PerryLink/dsh-doublecheck) | 39 | 🟢 ok | 发布前双重检查：拷问需求、测试实现、防翻车。 |
...
| [voyager](https://github.com/Nagi-ovo/voyager) | 20127 | ⚪ unknown | untranslated |
| [dsh-im](https://github.com/xmanrui/dsh-im) | 1441 | 🟢 ok | untranslated |
...
| [DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 2949 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | untranslated |
...
| [dsh-knowledge](https://github.com/Soren-ABT/dsh-knowledge) | 35 | 🟢 ok | untranslated |
...
| [dsh-codex-ui](https://github.com/MichengAI/dsh-codex-ui) | 91 | 🟢 ok | untranslated |
...
| [dsh-agy-link](https://github.com/amlyczz/dsh-agy-link) | 79 | 🟢 ok | untranslated |
...
| [dsh-infinite-gen-4](https://github.com/Minglink/dsh-infinite-gen-4) | 1892 | 🟢 ok | untranslated |
...
| [dsh-plugin-kit](https://github.com/hyzyn/dsh-plugin-kit) | 30 | ⚪ unknown | untranslated |
| [oh-my-dsh](https://github.com/gulagala001/oh-my-dsh) | 15 | ⚪ unknown | untranslated |
...
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 327 | 🟢 ok | 跨会话长期记忆 + 后台自我进化（纯插件） |
...
| [billion-context-dsh](https://github.com/Tyan66666/billion-context-dsh) | 106 | 🟢 ok | billion-context-dsh — DSH 插件（会话） |
...
| [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) | 193 | 🟢 ok | dsh-auto-review — DSH 插件（会话） |
...
| [dsh-background-agents](https://github.com/PerryLink/dsh-background-agents) | 17 | 🟢 ok | 后台长任务 agent：启动可续跑的子 agent，Web 界面实时看进度。 |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 1481 | 🟢 ok | 上下文洞察面板：Web 界面加一个 Context 标签页，直观看到模型上下文窗口里装了什么、怎么变化的。 |
...
| [dsh-memory](https://github.com/FuRongJun-1999/dsh-memory) | 236 | 🟢 ok | 多 agent 时空记忆图谱：跨会话持久记忆。 |
...
| [dsh-browser](https://github.com/wqty123/dsh-browser) | 77 | 🟢 ok | 共享真实浏览器插件：多个 agent 共用一个浏览器。 |
...
| [MemOS](https://github.com/MemTensor/MemOS) | 11532 | ⚪ unknown | untranslated |
...
| [dsh-config-manager](https://github.com/xiajiajun516/dsh-config-manager) | 119 | 🟢 ok | untranslated |
...
| [dsh-adult-tension](https://github.com/daha1216/dsh-adult-tension) | 61 | ⚪ unknown | untranslated |
| [dsh-novel-writer](https://github.com/siweina/dsh-novel-writer) | 17 | 🟢 ok | untranslated |
| [dsh-sessions-manager](https://github.com/TOBYCAI/dsh-sessions-manager) | 15 | 🟢 ok | DSH 设置面板会话管理器：归档/恢复/彻底删除/移动到其他工作区，带工作区标签与会话日期 |
...
| [dsh-nexttavern](https://github.com/a86582751/dsh-nexttavern) | 100 | 🟢 ok | untranslated |
...
| [dsh-prompt-optimizer](https://github.com/WestFox-AwA/dsh-prompt-optimizer) | 75 | 🟢 ok | untranslated |
...
| [dsh-project-brain](https://github.com/yj-liuzepeng/dsh-project-brain) | 51 | 🟢 ok | untranslated |
...
| [dsh-novel-forge](https://github.com/huangziyuan-general/dsh-novel-forge) | 12 | ⚪ unknown | untranslated |
...
| [modlens](https://github.com/liustack/modlens) | 4016 | 🟢 ok | DeepSeek Harness 首个视觉插件，纯文本模型看图。 |
...
| [dsh-ui-appearance](https://github.com/TQSY114514/dsh-ui-appearance) | 15 | 🟢 ok | 外观自定义：主题色板、壁纸背景、透明度/模糊、毛玻璃效果，实时预览自动保存。 |
...
| [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) | 308 | 🟢 ok | Command Code 的 LLM provider（非官方）：实时模型目录、推理强度支持，Models 页有卡片。 |
...
| [dsh-plugin-writing-guard](https://github.com/xmutfyh/dsh-plugin-writing-guard) | 41 | 🟢 ok | untranslated |
...
| [opencues](https://github.com/opencues/opencues) | 54 | ⚪ unknown | untranslated |
| [dsh-live2d-mygo](https://github.com/U1s1-king/dsh-live2d-mygo) | 9 | ⚪ unknown | untranslated |
| [dsh-image-gen](https://github.com/shanliuling/dsh-image-gen) | 448 | 🟢 ok | untranslated |
...
| [tongflow](https://github.com/tong-io/tongflow) | 1025 | ⚪ unknown | untranslated |
...
| [opencode2dsh](https://github.com/FishBottle7/opencode2dsh) | 83 | 🟢 ok | untranslated |
| [dsh-better-reasoning-effort](https://github.com/HaoyueQin/dsh-better-reasoning-effort) | 29 | 🟢 ok | untranslated |
| [dsh-purge](https://github.com/YuJunZhiXue/dsh-purge) | 1860 | 🟢 ok | untranslated |
| [dsh-design-qa](https://github.com/sunxin-ai/dsh-design-qa) | 44 | 🟢 ok | untranslated |
| [dsh-llm-workbuddy](https://github.com/Axiaohungry/dsh-llm-workbuddy) | 45 | 🟢 ok | untranslated |
...
| [dsh-key-rotation](https://github.com/GooDAnDReaDY/dsh-key-rotation) | 5 | 🟢 ok | 每服务商一个 API key 池：配额/限流错误自动切下一个 key，冷却后探测恢复，可在 Settings 里编辑。 |
| [dsh-subscriptions](https://github.com/GooDAnDReaDY/dsh-subscriptions) | 4 | 🟢 ok | 把 ChatGPT Codex/Claude/Grok/Antigravity 订阅通过 OAuth 注册成 LLM 提供者，免 API key。 |
...
| [dsh-browser](https://github.com/omdsh-dev/dsh-browser) | 715 | 🟢 ok | untranslated |
...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [openhanako](https://github.com/liliMozi/openhanako) | 6616 | ⚪ unknown | 带记忆、人格与自主性的个人 AI 智能体 |
...
| [distill](https://github.com/LoserFox/distill) | 27 | ⚪ unknown | 自动对话蒸馏：后台 subagent 反省 + 技能更新 |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1768 | 🟢 ok | AgentTeams 插件 |
...
| [Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 3402 | ⚪ unknown | 通用技能调度器：自动挑选最合适的本地 Skill 并编排整个 Harness 工作流，不用手动指定用哪个技能。 |
...
| [dsh-agent-team-gui](https://github.com/toolclub/dsh-agent-team-gui) | 225 | 🔴 broken (failed once, retried — install blocked by pnpm build-script policy (allowBuilds) — plugin likely OK, CI policy blocks git prepare scripts) | untranslated |
...
| [dsh-tavern](https://github.com/flizzywine/dsh-tavern) | 456 | 🟢 ok | untranslated |
...
| [dsh-ego-browser](https://github.com/Fisfzy/dsh-ego-browser) | 187 | 🟢 ok | untranslated |
...
| [loopx](https://github.com/huangruiteng/loopx) | 5922 | ⚪ unknown | untranslated |
| [sofagent](https://github.com/KongFangXun/sofagent) | 48 | ⚪ unknown | untranslated |
| [dsh-ultramath](https://github.com/Andiii208/dsh-ultramath) | 32 | 🟢 ok | untranslated |
| [dsh-Visual-Workflow](https://github.com/GZX2211/dsh-Visual-Workflow) | 30 | ⚪ unknown | untranslated |
| [pi-web-ui](https://github.com/xing-shuyin/pi-web-ui) | 224 | ⚪ unknown | untranslated |
| [dsh-plugin-developer-skill](https://github.com/liangdabiao/dsh-plugin-developer-skill) | 23 | ⚪ unknown | untranslated |
| [dsh-hub-cli](https://github.com/pax-beehive/dsh-hub-cli) | 438 | ⚪ unknown | untranslated |
| [dsh-trading](https://github.com/zhu1090093659/dsh-trading) | 195 | ⚪ unknown | untranslated |
| [dsh-evolve-in-git](https://github.com/Kytolly/dsh-evolve-in-git) | 56 | ⚪ unknown | untranslated |
...
| [Openwrite](https://github.com/LiPu-jpg/Openwrite) | 753 | ⚪ unknown | untranslated |
...
| [loopx](https://github.com/loopx-project/loopx) | 5922 | ⚪ unknown | untranslated |
| [SmartMoney-Cub](https://github.com/myc0576/SmartMoney-Cub) | 26 | ⚪ unknown | untranslated |
| [jev-dsh-decision](https://github.com/Devin-AXIS/jev-dsh-decision) | 94 | ⚪ unknown | untranslated |
...
| [dsh-remote](https://github.com/flymysql/dsh-remote) | 95 | 🟢 ok | 远程接入助手：/remote 命令 + 设置页直接打印 SSH 隧道/反向隧道命令，远程工作区一键连。 |
...
| [deepseek-harness-mobile](https://github.com/sorsama/deepseek-harness-mobile) | 94 | ⚪ unknown | 安卓伴侣应用：聊天、目标、审批与通知，手机随时遥控 DSH。 |
...
| [dsh-web-lan-access](https://github.com/AcidGr/dsh-web-lan-access) | 34 | 🟢 ok | 局域网访问 Web 插件。 |
...
| [dsh-pocket](https://github.com/shaobeichen/dsh-pocket) | 1288 | 🟢 ok | untranslated |
...
| [dsh-damage-pulse](https://github.com/wssfk12138/dsh-damage-pulse) | 188 | 🟢 ok | untranslated |
...
| [ds-harness-remote](https://github.com/liguobao/ds-harness-remote) | 213 | 🟢 ok | untranslated |
...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [EchoBird](https://github.com/edison7009/EchoBird) | 3269 | ⚪ unknown | 一键安装+切换 Claude Code/Codex/Kimi/Qwen 等 20+ 编码智能体 |
...
| [awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 1091 | ⚪ unknown | DSH 生态精选：插件、工具与基建 |
...
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 632 | ⚪ unknown | 2005 年中文站点风格侧栏广告插件（恶搞） |
...
| [awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 357 | ⚪ unknown | 双语 DSH 插件生态完整列表 |
...
> 徽章含义：🟢 兼容 · 🔴 不兼容 · ⚪ 未实测 · ⚫ 弃坑。
> 共 1944 个条目，按分类分表、类内按 ⭐ 降序。收录 / 字段词典见 [docs/catalog-schema.md](docs/catalog-schema.md)。
<!-- CATALOG:END -->
