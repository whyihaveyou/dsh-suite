...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 7589 | 🟢 ok | DSH Web UI 插件与皮肤合集：任务板、Git 面板等 |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3603 | 🟢 ok | 侧边栏完整工作台：文件渲染/终端/Git/子代理 |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 2081 | ⚪ unknown | DSH Web 鲸鱼娘皮肤系列（深海女仆工坊） |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 880 | 🟢 ok | 给纯文本模型加视觉：图片问答、长截图 OCR、UI 还原 |
| [dsh_workflow](https://github.com/icetomoyo/dsh_workflow) | 123 | 🟢 ok | 把 Claude Code 的 UltraCode 模式带给 DSH，多 Agent 调度可治理 |
| [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) | 116 | 🟢 ok | 对话回退：回滚会话与工作区状态 |
| [mstar-harness](https://github.com/btspoony/mstar-harness) | 59 | ⚪ unknown | Skill 驱动的 Harness/Loop 工程工作流插件 |
...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [open-managed-agents](https://github.com/openma-ai/open-managed-agents) | 277 | ⚪ unknown | Claude Managed Agents API 的开源自托管平台（Cloudflare Workers） |
...
| [dsh-data-agent](https://github.com/omdsh-dev/dsh-data-agent) | 194 | 🟢 ok | 连数据库、写 SQL 的插件 |
...
| [dsh-toolkit](https://github.com/omdsh-dev/dsh-toolkit) | 29 | ⚪ unknown | 零依赖工具包合集（time/encoding/json/csv/regex） |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 373 | 🟢 ok | Mnemon 三层记忆体深度集成 |
...
| [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) | 72 | 🟢 ok | OpenMAIC：课堂/幻灯片/交互式组件 |
...
| [ego-browser](https://github.com/Fisfzy/ego-browser) | 167 | 🟢 ok | 把 ego-lite 浏览器接入 DSH（给 Agent 用的 Chromium） |
| [math-lean](https://github.com/Fisfzy/math-lean) | 0 | ⚪ unknown | Lean 内核验证的数学推理插件 |
| [plugin-template](https://github.com/omdsh-dev/plugin-template) | 14 | ⚪ unknown | 官方 turtle ui 仓库派生的插件模板 |
...
| [modsearch](https://github.com/liustack/modsearch) | 481 | ⚪ unknown | DeepSeek Harness 的联网搜索插件。 |
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 656 | 🟢 ok | Chrome 侧边栏扩展，让 DSH 操控浏览器。 |
...
| [dsh-expression](https://github.com/yyh-001/dsh-expression) | 85 | 🟢 ok | 找得到、发得出 —— DSH 表情包插件：语义搜图，只发真实文件，走 companion QQ 通道 |
...
| [dsh-plugin-template](https://github.com/bugmaker2/dsh-plugin-template) | 111 | 🔴 broken (failed once, retried — install blocked by pnpm build-script policy (allowBuilds) — plugin likely OK, CI policy blocks git prepare scripts) | dsh-plugin-template — DSH 插件（工具） |
...
| [dsh-github](https://github.com/PerryLink/dsh-github) | 10 | 🟢 ok | dsh-github — DSH 插件（工具） |
...
| [dsh-codex-connect](https://github.com/franksong2702/dsh-codex-connect) | 104 | 🟢 ok | 通过 ChatGPT OAuth 在 DeepSeek Harness 中使用 OpenAI Codex 模型。 |
...
| [dsh-robotic-harness](https://github.com/dingkaihu63/dsh-robotic-harness) | 21 | ⚪ unknown | dsh-robotic-harness — DSH 插件（工具） |
| [dsh-codex-subscription](https://github.com/WSL043/dsh-codex-subscription) | 66 | 🟢 ok | dsh-codex-subscription — DSH 插件（工具） |
...
| [dsh-passwords](https://github.com/slywalker2006/dsh-passwords) | 56 | 🟢 ok | 让 DeepSeek Harness 变成服务器级多租户平台：远程访问 + 自动 HTTPS、子用户权限与配额、沙盒强制、加密认证与审计日志。 |
...
| [anysearch-dsh](https://github.com/anysearch-team/anysearch-dsh) | 416 | 🟢 ok | AnySearch 联网搜索接入：给 DSH 配上 AnySearch 的搜索 provider 和进阶搜索工具。 |
...
| [dsh-agy](https://github.com/chaos-03x/dsh-agy) | 38 | 🟢 ok | Google Antigravity (agy) 接入：OAuth 授权 + 多账号池 + 429 自动轮换 + 设备指纹。 |
...
| [dsh-auto-mode](https://github.com/NanmiCoder/dsh-auto-mode) | 157 | 🟢 ok | 安全的自动授权：在「每次都要点批准」和「无脑全放开」之间加一档，按规则自动放行常规操作。 |
...
| [dsh-hanako](https://github.com/Nyasers/dsh-hanako) | 50 | ⚪ unknown | 把 DSH 接进 Hana：作为进程外 subagent 使用，任务走 dsh web host 执行。 |
...
| [dsh-solo-thinking](https://github.com/fredalxin/dsh-solo-thinking) | 24 | ⚪ unknown | 独立头脑风暴分支：每个方向一个独立会话，分支间只交换 agent 主动写的 Handoff。 |
...
| [Deepseek-Harness-for-VS-Code](https://github.com/Vithrive/Deepseek-Harness-for-VS-Code) | 24 | ⚪ unknown | untranslated |
...
| [dsh-win32](https://github.com/sjh9714/dsh-win32) | 43 | 🟢 ok | untranslated |
...
| [deepseek-harness-workbench-plugin](https://github.com/loadingvx/deepseek-harness-workbench-plugin) | 32 | ⚪ unknown | untranslated |
...
| [DSH-Think-zh](https://github.com/Len7183/DSH-Think-zh) | 20 | ⚪ unknown | untranslated |
| [dsh-anchored-standard](https://github.com/Jungod1121/dsh-anchored-standard) | 25 | ⚪ unknown | untranslated |
| [dsh-pentest](https://github.com/howmp/dsh-pentest) | 473 | 🟢 ok | untranslated |
...
| [helm-d](https://github.com/ADWMC/helm-d) | 41 | ⚪ unknown | untranslated |
...
| [dsh-voice-ai-girlfriend](https://github.com/beiyege-01/dsh-voice-ai-girlfriend) | 89 | ⚪ unknown | untranslated |
...
| [dsh-ai4scholar](https://github.com/literaf/dsh-ai4scholar) | 25 | 🟢 ok | untranslated |
| [webdsh](https://github.com/futrime/webdsh) | 30 | ⚪ unknown | untranslated |
| [dsh-wallpaper-engine](https://github.com/elysia395/dsh-wallpaper-engine) | 281 | 🔴 broken (failed once, retried — install blocked by pnpm build-script policy (allowBuilds) — plugin likely OK, CI policy blocks git prepare scripts) | untranslated |
...
| [dsh-meme](https://github.com/yyh-001/dsh-meme) | 85 | 🟢 ok | untranslated |
...
| [dsh-univer-office](https://github.com/dream-num/dsh-univer-office) | 343 | 🟢 ok | untranslated |
...
| [dsh-taskboard](https://github.com/cloader/dsh-taskboard) | 40 | 🟢 ok | untranslated |
...
| [dsh-redteam-model](https://github.com/SeaOf0/dsh-redteam-model) | 463 | 🟢 ok | untranslated |
...
| [custom-first-control-prompt](https://github.com/WM-CODER/custom-first-control-prompt) | 72 | 🟢 ok | untranslated |
...
| [garmin-connect-plugin-for-dsh](https://github.com/Likenttt/garmin-connect-plugin-for-dsh) | 17 | ⚪ unknown | untranslated |
...
| [dsh-personal-center](https://github.com/PolinniZhong/dsh-personal-center) | 125 | 🟢 ok | untranslated |
...
| [dsh-network-settings](https://github.com/kanneiren/dsh-network-settings) | 110 | 🟢 ok | untranslated |
...
| [Invoice-Downloader](https://github.com/EthanYoQ/Invoice-Downloader) | 415 | ⚪ unknown | untranslated |
| [dsh-hotplug-hub](https://github.com/ARFCON/dsh-hotplug-hub) | 28 | ⚪ unknown | untranslated |
| [dsh-wenshan](https://github.com/xuedai-mayi/dsh-wenshan) | 105 | ⚪ unknown | untranslated |
...
| [dsh-ssh-ops](https://github.com/caoyiwei850/dsh-ssh-ops) | 20 | 🟢 ok | untranslated |
...
| [dsh-preset-plus](https://github.com/Rain-kl/dsh-preset-plus) | 116 | 🟢 ok | untranslated |
...
| [dsh-infinite-gen-2](https://github.com/Minglink/dsh-infinite-gen-2) | 1524 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | untranslated |
...
| [dsh-research-report](https://github.com/PerryLink/dsh-research-report) | 108 | 🟢 ok | untranslated |
| [dsh-otel](https://github.com/tma1-ai/dsh-otel) | 9 | 🟢 ok | untranslated |
| [DSH-Creator](https://github.com/Jackywxsz/DSH-Creator) | 98 | 🟢 ok | untranslated |
| [dsh-fund-research](https://github.com/PerryLink/dsh-fund-research) | 36 | 🟢 ok | untranslated |
| [dsh-yolo](https://github.com/hanshanyike/dsh-yolo) | 59 | 🟢 ok | untranslated |
| [dsh-emacs](https://github.com/vritser/dsh-emacs) | 24 | ⚪ unknown | untranslated |
| [dsh-smart-charts](https://github.com/hherosoul/dsh-smart-charts) | 11 | 🟢 ok | untranslated |
| [dsh-infinite-gen-3](https://github.com/Minglink/dsh-infinite-gen-3) | 1524 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | untranslated |
| [dsh-diagram](https://github.com/hanzhangzzz/dsh-diagram) | 12 | 🔴 broken (cordis 4.0.2 not in peer "4.0.1") | untranslated |
| [@xxxyz/dsh-mcp-manager](https://github.com/xxxyz/DeepSeekHarness-MCP-Manager) | 15 | 🟢 ok | DSH 双管理器——MCP 服务管理（设置页新增/编辑/启停/重启/删除、JSON 导入导出、4 个 mcp_manager_* 模型工具、带闸门的本地 HTTP API）+ Skills 技能管理（启停面板、持久化、HMR 即时生效）。 |
| [dsh-data-quality](https://github.com/PerryLink/dsh-data-quality) | 25 | 🟢 ok | untranslated |
...
| [dsh-plugin-shop](https://github.com/LivXue/dsh-plugin-shop) | 754 | 🟢 ok | untranslated |
...
| [dsh-approval-gate](https://github.com/moon09300731/dsh-approval-gate) | 69 | 🟢 ok | untranslated |
| [dsh-knowledge](https://github.com/lemoncat7/dsh-knowledge) | 12 | 🟢 ok | untranslated |
| [prts-terrarchive](https://github.com/HTian-qwq/prts-terrarchive) | 24 | ⚪ unknown | untranslated |
| [dsh-superpower](https://github.com/Wenaixi/dsh-superpower) | 13 | 🟢 ok | untranslated |
| [dsh-council](https://github.com/a1exsun/dsh-council) | 93 | ⚪ unknown | untranslated |
...
| [dsh-fylar-office-editor](https://github.com/FylarOpen/dsh-fylar-office-editor) | 49 | ⚪ unknown | untranslated |
| [dsh-defend](https://github.com/PerryLink/dsh-defend) | 12 | 🟢 ok | untranslated |
| [dsh-setting-restart](https://github.com/893413974-bit/dsh-setting-restart) | 14 | 🟢 ok | untranslated |
...
| [dsh-plugin-message-edit](https://github.com/SpookySandwich/dsh-plugin-message-edit) | 11 | ⚪ unknown | untranslated |
| [dsh-plugin-tav2](https://github.com/Drhushi/dsh-plugin-tav2) | 18 | ⚪ unknown | untranslated |
| [dsh-branchmark](https://github.com/zaizaizhao/dsh-branchmark) | 22 | 🟢 ok | untranslated |
| [dsh-local-ai](https://github.com/PerryLink/dsh-local-ai) | 12 | 🟢 ok | untranslated |
| [dsh-connect-trae](https://github.com/dingminhua/dsh-connect-trae) | 12 | ⚪ unknown | untranslated |
...
| [dsh-plugin-opencode-bridge](https://github.com/YYTbit/dsh-plugin-opencode-bridge) | 5 | 🟢 ok | dsh-plugin-opencode-bridge — DSH 插件（技能） |
| [dsh-plugin-pi-bridge](https://github.com/YYTbit/dsh-plugin-pi-bridge) | 3 | 🟢 ok | dsh-plugin-pi-bridge — DSH 插件（技能） |
...
| [dsh-skill-viewer](https://github.com/Fishquito7/dsh-skill-viewer) | 130 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | 技能管理面板：在设置页直接启用/停用、删除、添加 Skills，不用改配置文件。 |
...
| [dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill) | 141 | 🟢 ok | 逆向技能全家桶（85 个 SKILL.md）：逆向工程、授权渗透和安全研究的工作流，打包成插件。 |
...
| [dsh-skills-manager](https://github.com/MichengAI/dsh-skills-manager) | 49 | 🟢 ok | untranslated |
...
| [SpecFusion](https://github.com/wxkingstar/SpecFusion) | 66 | ⚪ unknown | untranslated |
...
| [dsh-skill-mcp-panel](https://github.com/Fishquito7/dsh-skill-mcp-panel) | 130 | 🟢 ok | untranslated |
...
| [oh-story-dsh](https://github.com/worldwonderer/oh-story-dsh) | 348 | ⚪ unknown | untranslated |
| [dsh-codex-sync](https://github.com/Walvez/dsh-codex-sync) | 25 | 🟢 ok | untranslated |
| [dsh-run2skill](https://github.com/qkycir-123/dsh-run2skill) | 114 | 🟢 ok | untranslated |
| [dsh-mattpocock-skills-deck](https://github.com/FeatherHunter/dsh-mattpocock-skills-deck) | 65 | 🟢 ok | untranslated |
| [oh-story-dsh](https://github.com/zenstory-ai/oh-story-dsh) | 348 | ⚪ unknown | untranslated |
| [dsh-industry-research](https://github.com/PerryLink/dsh-industry-research) | 110 | 🟢 ok | untranslated |
...
| [prompt-skill-armory](https://github.com/Qian-Ning/prompt-skill-armory) | 15 | ⚪ unknown | untranslated |
...
| [dsh-ui-whale](https://github.com/lhh010/dsh-ui-whale) | 33 | ⚪ unknown | 全手绘像素鲸鱼伙伴插件 |
| [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) | 117 | 🟢 ok | 选中批注：选文字→批注→随消息发送 |
...
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 453 | 🟢 ok | 会话内联渲染交互式 UI 组件 |
...
| [whale-girl](https://github.com/vlln/whale-girl) | 323 | 🟢 ok | QQ 宠物形态的桌面宠物插件 |
| [dsh-status-rotator](https://github.com/01Virex/dsh-status-rotator) | 82 | 🟢 ok | 替换 DSH 状态显示的 web 插件。 |
...
| [dsh-doublecheck](https://github.com/PerryLink/dsh-doublecheck) | 29 | 🟢 ok | 发布前双重检查：拷问需求、测试实现、防翻车。 |
...
| [dsh-undo-plugin](https://github.com/lire1131/dsh-undo-plugin) | 155 | 🟢 ok | 配置后悔药：插件/皮肤/设置改动自动快照，可撤销、可回滚，带快照管理面板和快捷键。 |
| [plugin-manager](https://github.com/whyihaveyou/dsh-suite) | 7 | 🟢 ok | DSH Web UI 内置插件商店：浏览 dsh-suite 目录、搜索/筛选/排序、兼容徽章、一键安装——设置页插件区的 Store 标签页。 |
...
| [dsh-computer-use](https://github.com/ZRui-C/dsh-computer-use) | 27 | 🟢 ok | 文本优先的浏览器与 macOS 后台控制：用文字指挥浏览器和电脑。 |
...
| [dsh-plugin-terminal](https://github.com/siberiah2o/dsh-plugin-terminal) | 5 | 🟢 ok | 底部终端面板：交互式多标签终端。 |
...
| [dsh-liang-skin](https://github.com/kingOfSoySauce/dsh-liang-skin) | 192 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | 滑动变祖器皮肤：滑块控制『梁圣等级』（自适应推理强度），梗图风 DSH 皮肤 |
...
| [deepseek-harness-genui](https://github.com/pengyue-polaron/deepseek-harness-genui) | 109 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | untranslated |
| [dsh-smooth-stream](https://github.com/Laplace-bit/dsh-smooth-stream) | 72 | 🟢 ok | 为 DeepSeek Harness Web UI 提供流畅流式渲染和丝滑滚动。 |
| [voyager](https://github.com/Nagi-ovo/voyager) | 20071 | ⚪ unknown | untranslated |
| [dsh-im](https://github.com/xmanrui/dsh-im) | 1320 | 🟢 ok | untranslated |
...
| [dsh-plugin-tts](https://github.com/1624318455/dsh-plugin-tts) | 16 | ⚪ unknown | untranslated |
...
| [dsh-catppuccin-theme](https://github.com/NoNameLeGo/dsh-catppuccin-theme) | 39 | ⚪ unknown | untranslated |
...
| [dsh-whale-musume](https://github.com/Sutera-Diffusus/dsh-whale-musume) | 65 | 🟢 ok | untranslated |
...
| [dsh-client-ui-skin-denia](https://github.com/Ewnscat-ya/dsh-client-ui-skin-denia) | 35 | ⚪ unknown | untranslated |
| [dsh-whale-animation](https://github.com/LeemanCheung/dsh-whale-animation) | 6 | ⚪ unknown | untranslated |
| [dsh-client-ui-custom](https://github.com/yoli-mi/dsh-client-ui-custom) | 33 | ⚪ unknown | untranslated |
...
| [dsh-endfield-ui](https://github.com/rison114514/dsh-endfield-ui) | 61 | ⚪ unknown | untranslated |
...
| [dsh-whale-galgame](https://github.com/JAdpp/dsh-whale-galgame) | 25 | 🟢 ok | untranslated |
| [dsh-better-sidebar-lite](https://github.com/pixellover1433/dsh-better-sidebar-lite) | 7 | 🟢 ok | untranslated |
| [DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 2408 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | untranslated |
| [dsh-opencode-palette](https://github.com/FeatherHunter/dsh-opencode-palette) | 26 | 🟢 ok | untranslated |
| [dsh-whale-meter](https://github.com/Shiye-10Pages/dsh-whale-meter) | 12 | 🟢 ok | untranslated |
| [dsh-kimino-theme](https://github.com/niiang/dsh-kimino-theme) | 34 | 🟢 ok | untranslated |
| [dsh-beauty-skins](https://github.com/XieRW/dsh-beauty-skins) | 101 | ⚪ unknown | untranslated |
| [open-sea-skin](https://github.com/d-dev0101/open-sea-skin) | 378 | 🟢 ok | untranslated |
...
| [dsh-vscode](https://github.com/Fengze233/dsh-vscode) | 33 | ⚪ unknown | untranslated |
| [dsh-prompt-optimize](https://github.com/1847123733/dsh-prompt-optimize) | 6 | 🟢 ok | untranslated |
| [dsh-undo-savepoint](https://github.com/lire1131/dsh-undo-savepoint) | 155 | 🟢 ok | untranslated |
...
| [dsh-theme-endfield](https://github.com/ymh0000123/dsh-theme-endfield) | 86 | 🟢 ok | untranslated |
...
| [dsh-coding-subscription-oauth](https://github.com/lninghaha/dsh-coding-subscription-oauth) | 24 | 🔴 broken (cordis 4.0.2 not in peer "4.0.1") | untranslated |
...
| [dsh-agy-link](https://github.com/amlyczz/dsh-agy-link) | 65 | 🟢 ok | untranslated |
| [dsh-bloom-theme](https://github.com/webkubor/dsh-bloom-theme) | 32 | ⚪ unknown | untranslated |
| [dsh-android](https://github.com/ZSeven-W/dsh-android) | 143 | ⚪ unknown | untranslated |
...
| [dsh-comfyui](https://github.com/fandc520/dsh-comfyui) | 66 | 🟢 ok | untranslated |
...
| [dsh-custom-skin](https://github.com/SLin-code/dsh-custom-skin) | 105 | 🟢 ok | untranslated |
...
| [dsh-tavern-v2](https://github.com/chen731215-dev/dsh-tavern-v2) | 18 | ⚪ unknown | untranslated |
| [dsh-mcp-manage](https://github.com/null119/dsh-mcp-manage) | 16 | 🟢 ok | untranslated |
| [dsh-raw-html-v2](https://github.com/plolpl789/dsh-raw-html-v2) | 43 | ⚪ unknown | untranslated |
| [dsh-voice-goodandready](https://github.com/GooDAnDReaDY/dsh-voice) | 5 | 🟢 ok | Web UI 语音输入：按停顿分段的流式听写 + 语音消息，每条可配独立的多服务商回退链。 |
| [dsh-tts](https://github.com/GooDAnDReaDY/dsh-tts) | 1 | 🟢 ok | Web UI 语音朗读助手回复：多服务商回退链（OpenAI/ElevenLabs/Google/Azure/Groq/Deepgram/Edge/Piper/eSpeak）。 |
| [dsh-russian-lang](https://github.com/GooDAnDReaDY/dsh-russian-lang) | 10 | 🟢 ok | Settings → General → Language 增加俄语选项：核心 + 30+ 插件 locale 命名空间运行时翻译（722+3989 键人工审校）。 |
| [dsh-infinite-gen-4](https://github.com/Minglink/dsh-infinite-gen-4) | 1524 | 🟢 ok | untranslated |
| [dsh-history](https://github.com/startnewlabs/dsh-history) | 15 | 🟢 ok | untranslated |
| [DeepSeek-Balance-Whale-Widget-Bowl](https://github.com/Witherwithwinter/DeepSeek-Balance-Whale-Widget-Bowl) | 13 | ⚪ unknown | untranslated |
| [augmentor-dsh-extension-plugin](https://github.com/ManoloRemiddi/augmentor-dsh-extension-plugin) | 27 | ⚪ unknown | untranslated |
| [DSHBox](https://github.com/WSK-build/DSHBox) | 18 | ⚪ unknown | untranslated |
...
| [dsh-context-doctor](https://github.com/Zhenyu98/dsh-context-doctor) | 30 | ⚪ unknown | 上下文注入审计：AGENTS.md/技能/tool schema token 成本 |
...
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 307 | 🟢 ok | 跨会话长期记忆 + 后台自我进化（纯插件） |
...
| [plugin-session-export](https://github.com/whyihaveyou/dsh-suite) | 3 | 🟢 ok | 把 append-only 会话日志导出成人读的 Markdown / HTML，按来源分组渲染（系统提示 / 思维链 / 工具调用 / 子agent）。 |
| [dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) | 163 | 🟢 ok | 从 Claude Code/Codex/Reasonix 导入历史消息到 DSH。 |
...
| [dsh-plugin-claude-bridge](https://github.com/YYTbit/dsh-plugin-claude-bridge) | 10 | 🟢 ok | dsh-plugin-claude-bridge — DSH 插件（会话） |
...
| [dsh-claude-move](https://github.com/PerryLink/dsh-claude-move) | 20 | 🟢 ok | dsh-claude-move — DSH 插件（会话） |
...
| [billion-context-dsh](https://github.com/Tyan66666/billion-context-dsh) | 93 | 🟢 ok | billion-context-dsh — DSH 插件（会话） |
...
| [dsh-memento](https://github.com/PerryLink/dsh-memento) | 93 | 🟢 ok | dsh-memento — DSH 插件（会话） |
...
| [dsh-mneme](https://github.com/modusensus/dsh-mneme) | 102 | 🟢 ok | Mneme——把记忆主权还给人的记忆插件：SQLite + 可人工编辑的 Markdown 双写，autoDream 在梦境中巩固记忆，106 个测试护航。 |
| [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) | 301 | 🟢 ok | DeepSeek Harness 会话费用统计插件:本会话费用、当日费用、历史记录与官方价格同步 |
...
| [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) | 170 | 🟢 ok | dsh-auto-review — DSH 插件（会话） |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 1388 | 🟢 ok | 上下文洞察面板：Web 界面加一个 Context 标签页，直观看到模型上下文窗口里装了什么、怎么变化的。 |
...
| [blender](https://github.com/CheshireJCat/blender) | 28 | ⚪ unknown | Blender 3D 全流程：建模、重建、渲染、校验、导出一站式，聊天里指挥 Blender 干活。 |
...
| [dsh-memory](https://github.com/FuRongJun-1999/dsh-memory) | 196 | 🟢 ok | 多 agent 时空记忆图谱：跨会话持久记忆。 |
...
| [dsh-browser](https://github.com/wqty123/dsh-browser) | 62 | 🟢 ok | 共享真实浏览器插件：多个 agent 共用一个浏览器。 |
...
| [dsh-plugin](https://github.com/loongsuite/dsh-plugin) | 24 | 🔴 broken (cordis 4.0.2 not in peer "4.0.1") | untranslated |
...
| [deepseek-harness-control-center](https://github.com/feibi-mochi/deepseek-harness-control-center) | 71 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | untranslated |
...
| [memtrace-public](https://github.com/syncable-dev/memtrace-public) | 471 | ⚪ unknown | untranslated |
...
| [dsh-remote](https://github.com/xgone/dsh-remote) | 63 | 🟢 ok | untranslated |
...
| [MemOS](https://github.com/MemTensor/MemOS) | 11325 | ⚪ unknown | untranslated |
...
| [dsh-sandbox-escalation-fix](https://github.com/JUSTMONIKA2022/dsh-sandbox-escalation-fix) | 54 | 🟢 ok | untranslated |
...
| [dsh-config-manager](https://github.com/xiajiajun516/dsh-config-manager) | 113 | 🟢 ok | untranslated |
| [dsh-archive-manager](https://github.com/MichengAI/dsh-archive-manager) | 58 | 🟢 ok | untranslated |
| [dsh-rewind](https://github.com/SiriLee/dsh-rewind) | 69 | 🟢 ok | untranslated |
| [dsh-Mmem](https://github.com/mianyoubiaoqing/dsh-Mmem) | 7 | ⚪ unknown | untranslated |
| [dsh-strata](https://github.com/jsdvjx/dsh-strata) | 111 | 🟢 ok | untranslated |
...
| [dsh-talk-map](https://github.com/Tasihi89/dsh-talk-map) | 87 | 🟢 ok | untranslated |
...
| [dsh-adult-tension](https://github.com/daha1216/dsh-adult-tension) | 39 | ⚪ unknown | untranslated |
...
| [dsh-ui-usage-billing](https://github.com/kenz1117/dsh-ui-usage-billing) | 50 | ⚪ unknown | untranslated |
| [distill-kura](https://github.com/lna-lab/distill-kura) | 47 | ⚪ unknown | untranslated |
| [StrataGate-AgentMemory](https://github.com/diqierjia/StrataGate-AgentMemory) | 77 | 🔴 broken (failed once, retried — install blocked by pnpm build-script policy (allowBuilds) — plugin likely OK, CI policy blocks git prepare scripts) | untranslated |
| [dsh-layered-memory](https://github.com/JunNanLYS/dsh-layered-memory) | 17 | 🟢 ok | untranslated |
...
| [dsh-sandbox-escalation-fix](https://github.com/HakureiMonika/dsh-sandbox-escalation-fix) | 54 | 🟢 ok | untranslated |
...
| [dsh-meow-cachebilling](https://github.com/Phant0Meow/dsh-meow-cachebilling) | 26 | ⚪ unknown | untranslated |
...
| [dsh-git-worktree](https://github.com/wloops/dsh-git-worktree) | 13 | 🟢 ok | untranslated |
...
| [clutch-dsh](https://github.com/Cerbur/clutch-dsh) | 23 | ⚪ unknown | untranslated |
| [dsh-memgas](https://github.com/quqxui/dsh-memgas) | 25 | 🟢 ok | untranslated |
| [dsh-memory](https://github.com/hr98w/dsh-memory) | 23 | 🟢 ok | untranslated |
| [dsh-nexttavern](https://github.com/a86582751/dsh-nexttavern) | 31 | ⚪ unknown | untranslated |
| [dsh-token-optimizer](https://github.com/Zoria-Lind/dsh-token-optimizer) | 12 | 🟢 ok | untranslated |
| [dsh-opencode-session-id](https://github.com/gausszhou/dsh-opencode-session-id) | 13 | ⚪ unknown | untranslated |
| [dsh-project-memory](https://github.com/00080000/dsh-project-memory) | 14 | 🔴 broken (cordis 4.0.2 not in peer "4.0.1") | untranslated |
| [dsh-flow](https://github.com/rootkiller6788/dsh-flow) | 14 | ⚪ unknown | untranslated |
| [dsh-prompt-optimizer](https://github.com/WestFox-AwA/dsh-prompt-optimizer) | 41 | ⚪ unknown | untranslated |
...
| [dsh-computer-use](https://github.com/Anionex/dsh-computer-use) | 41 | 🟢 ok | 电脑控制插件（Accessibility 观测 + 作用域权限） |
| [dsh-vision](https://github.com/william-jin-cmu/dsh-vision) | 33 | 🟢 ok | view_image 工具桥接任意 OpenAI 兼容 VLM |
| [modlens](https://github.com/liustack/modlens) | 3963 | 🟢 ok | DeepSeek Harness 首个视觉插件，纯文本模型看图。 |
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 1205 | ⚪ unknown | 为纯文本模型看图设计的视觉工具箱与技能：多图理解、图片问答、UI 还原、GUI 自动化。 |
...
| [dsh-mcp-manager](https://github.com/hyqhyq3/dsh-mcp-manager) | 16 | ⚪ unknown | dsh-mcp-manager — DSH 插件（模型） |
...
| [dsh-green-meter](https://github.com/dclichang2022/dsh-green-meter) | 101 | 🔴 broken (failed once, retried — install failed (exit 1):     at runCli (file:///home/runner/.npm/_npx/1e7f6d9597241db0/node_modules/@deepseek-ai/dsh/lib/bin.js:157:17) |) | 能耗与碳排放计量：看每次对话/请求的能耗、缓存减碳量和电费。 |
...
| [TokenLedger](https://github.com/zh667/TokenLedger) | 199 | ⚪ unknown | Token 记账：对账 New API 与 Sub2API 中转站账单。 |
...
| [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) | 251 | 🟢 ok | Command Code 的 LLM provider（非官方）：实时模型目录、推理强度支持，Models 页有卡片。 |
| [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) | 347 | 🟢 ok | 把 ChatGPT(Codex)、Claude、Grok(X Premium) 的订阅当 DSH 的模型 provider 用。 |
...
| [deepseek-harness-studio](https://github.com/fufankeji/deepseek-harness-studio) | 639 | ⚪ unknown | untranslated |
...
| [dsh-crew](https://github.com/ZSeven-W/dsh-crew) | 146 | 🟢 ok | untranslated |
...
| [dsh-imagegen](https://github.com/dickpy/dsh-imagegen) | 73 | 🟢 ok | untranslated |
...
| [opencues](https://github.com/opencues/opencues) | 48 | ⚪ unknown | untranslated |
| [dsh-live2d-mygo](https://github.com/U1s1-king/dsh-live2d-mygo) | 8 | ⚪ unknown | untranslated |
| [dsh-image-gen](https://github.com/shanliuling/dsh-image-gen) | 416 | 🟢 ok | untranslated |
| [dsh-mmx-bridge](https://github.com/welsione/dsh-mmx-bridge) | 10 | 🟢 ok | untranslated |
| [dsh-computer-use](https://github.com/988hj7tczd-oss/dsh-computer-use) | 34 | 🟢 ok | untranslated |
...
| [tongflow](https://github.com/tong-io/tongflow) | 1020 | ⚪ unknown | untranslated |
...
| [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 1104 | 🟢 ok | 给纯文本 DSH 智能体装上眼睛：内置免 key 免费视觉链 + 11 个像素级视觉工具，一条命令安装，无需 Python。 |
| [dsh-antigravity](https://github.com/LiZhenNet/dsh-antigravity) | 23 | ⚪ unknown | untranslated |
...
| [opencode2dsh](https://github.com/FishBottle7/opencode2dsh) | 63 | 🟢 ok | untranslated |
| [dsh-better-reasoning-effort](https://github.com/HaoyueQin/dsh-better-reasoning-effort) | 24 | 🟢 ok | untranslated |
| [dsh-purge](https://github.com/YuJunZhiXue/dsh-purge) | 927 | 🟢 ok | untranslated |
...
| [dsh-better-display](https://github.com/aa2246740/dsh-better-display) | 37 | ⚪ unknown | untranslated |
...
| [dsh-freeroute](https://github.com/dushaobindoudou/dsh-freeroute) | 14 | ⚪ unknown | untranslated |
...
| [mirage-dsh](https://github.com/strukto-ai/mirage) | 3630 | 🟢 ok | 把 DSH 的 fs/shell 提供者换成 mirage 虚拟工作区：文件工具与 shell 命令作用于挂载的资源（RAM/磁盘/S3/Redis/Postgres/Slack/Gmail/Notion）而非宿主磁盘。 |
...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [openhanako](https://github.com/liliMozi/openhanako) | 6571 | ⚪ unknown | 带记忆、人格与自主性的个人 AI 智能体 |
| [exo](https://github.com/exoharness/exo) | 1410 | ⚪ unknown | 可递归自编辑自身的 agent+harness 架构 |
| [synergy](https://github.com/SII-Holos/synergy) | 490 | ⚪ unknown | 面向 Open Agentic Web 的通用智能体 |
| [ccteam](https://github.com/firstintent/ccteam) | 545 | ⚪ unknown | 把 Claude Code/Codex/Grok/Kimi 编成团队，Telegram/飞书指挥 |
...
| [distill](https://github.com/LoserFox/distill) | 25 | ⚪ unknown | 自动对话蒸馏：后台 subagent 反省 + 技能更新 |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1652 | 🟢 ok | AgentTeams 插件 |
...
| [dsh-work](https://github.com/vibeinging/dsh-desktop) | 585 | ⚪ unknown | 本地优先 DSH 桌面工作台（原 dsh-work 更名 dsh-desktop） |
| [dsh-advisor](https://github.com/btspoony/dsh-advisor) | 20 | 🟢 ok | 第二模型被动审查每轮并注入建议 |
...
| [dsh-file-review](https://github.com/left0ver/dsh-file-review) | 40 | 🟢 ok | 改完就能审：agent 刚动过的文件直接看 diff，不用离开 DSH Web。 |
...
| [Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 3294 | ⚪ unknown | 通用技能调度器：自动挑选最合适的本地 Skill 并编排整个 Harness 工作流，不用手动指定用哪个技能。 |
...
| [dsh-plugin-development](https://github.com/w2112515/dsh-plugin-development) | 13 | 🟢 ok | 教 agent 开发 DSH 插件的可安装包：含开发与审计插件的技能，可装进 profile 直接当 agent 技能用。 |
...
| [sandbase-skills](https://github.com/sandbaseai/sandbase-skills) | 178 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | 88 个可直接安装的 Agent 技能：覆盖研究与增长工作流，带 npm CLI 分发。 |
...
| [godot-bridge](https://github.com/Smalldy/godot-bridge) | 26 | ⚪ unknown | Godot 4.x 游戏桥：启动并通过游戏内 TCP 服务器驱动运行中的游戏，替代手动操作。 |
...
| [dsh-zotero](https://github.com/Vncntvx/dsh-zotero) | 17 | 🟢 ok | untranslated |
| [dsh-ankh-guard](https://github.com/Khorsheed/dsh-ankh-guard) | 6 | ⚪ unknown | untranslated |
| [caliper](https://github.com/edonadei/caliper) | 93 | ⚪ unknown | untranslated |
| [dsh_workflow](https://github.com/omdsh-dev/dsh_workflow) | 123 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | untranslated |
...
| [dsh-quant](https://github.com/pengpengyi92/dsh-quant) | 38 | 🟢 ok | untranslated |
...
| [dsh-tavern](https://github.com/flizzywine/dsh-tavern) | 323 | 🟢 ok | untranslated |
...
| [dsh-ego-browser](https://github.com/Fisfzy/dsh-ego-browser) | 167 | 🟢 ok | untranslated |
| [dsh-ux](https://github.com/ayuanwong/dsh-ux) | 14 | ⚪ unknown | untranslated |
| [dsh-agency-agents](https://github.com/MichengAI/dsh-agency-agents) | 51 | ⚪ unknown | untranslated |
...
| [dsh-thinking-effort](https://github.com/hytime/dsh-thinking-effort) | 30 | ⚪ unknown | untranslated |
...
| [dsh-raw-html](https://github.com/plolpl789/dsh-raw-html) | 64 | 🟢 ok | untranslated |
...
| [dsh-Mimir-Academic-research](https://github.com/1692775560/dsh-Mimir-Academic-research) | 394 | ⚪ unknown | untranslated |
| [dsh-better-input](https://github.com/DIAG5/dsh-better-input) | 30 | 🟢 ok | untranslated |
| [dsh-watcher](https://github.com/aa2246740/dsh-watcher) | 73 | 🟢 ok | untranslated |
| [mattpocock-skills-dsh](https://github.com/gongyijie85/mattpocock-skills-dsh) | 14 | 🟢 ok | untranslated |
| [loopx](https://github.com/huangruiteng/loopx) | 5852 | ⚪ unknown | untranslated |
...
| [dsh-Visual-Workflow](https://github.com/GZX2211/dsh-Visual-Workflow) | 27 | ⚪ unknown | untranslated |
| [pi-web-ui](https://github.com/xing-shuyin/pi-web-ui) | 169 | ⚪ unknown | untranslated |
| [dsh-plugin-developer-skill](https://github.com/liangdabiao/dsh-plugin-developer-skill) | 22 | ⚪ unknown | untranslated |
| [dsh-hub-cli](https://github.com/pax-beehive/dsh-hub-cli) | 319 | ⚪ unknown | untranslated |
| [dsh-trading](https://github.com/zhu1090093659/dsh-trading) | 172 | ⚪ unknown | untranslated |
| [dsh-evolve-in-git](https://github.com/Kytolly/dsh-evolve-in-git) | 37 | ⚪ unknown | untranslated |
| [DSH-KRouter](https://github.com/398894496-arch/DSH-KRouter) | 39 | ⚪ unknown | untranslated |
| [dsh-antibrow](https://github.com/antibrow/dsh-antibrow) | 292 | 🟢 ok | untranslated |
| [dsh-qa](https://github.com/naodeng/dsh-qa) | 16 | 🟢 ok | untranslated |
| [dsh-browser-control](https://github.com/caob23/dsh-browser-control) | 14 | 🟢 ok | untranslated |
| [Openwrite](https://github.com/LiPu-jpg/Openwrite) | 725 | ⚪ unknown | untranslated |
| [dshana](https://github.com/Nyasers/dshana) | 50 | ⚪ unknown | untranslated |
| [DSHana](https://github.com/Nyasers/DSHana) | 50 | ⚪ unknown | untranslated |
...
| [dsh-lsp-actions](https://github.com/PerryLink/dsh-lsp-actions) | 20 | 🟢 ok | dsh-lsp-actions — DSH 插件（桥接） |
...
| [dsh-switch](https://github.com/dongsheng123132/dsh-switch) | 2 | ⚪ unknown | dsh-switch — DSH 插件（桥接） |
| [dsh-deepseek-balance](https://github.com/wangxiang0605qvq/dsh-deepseek-balance) | 0 | 🟢 ok | dsh-deepseek-balance — DSH 插件（桥接） |
| [dsh-usage-stats](https://github.com/Ychris12138/dsh-usage-stats) | 154 | 🟢 ok | Token 用量热力图 + 分模型明细 + DeepSeek 账户余额，全部在一个 Web 面板里看。 |
| [deepseek-harness-acp](https://github.com/openma-ai/deepseek-harness-acp) | 29 | ⚪ unknown | ACP 服务器实现：让外部工具通过 Agent Client Protocol 驱动 DSH。 |
...
| [dsh-remote](https://github.com/flymysql/dsh-remote) | 77 | 🟢 ok | 远程接入助手：/remote 命令 + 设置页直接打印 SSH 隧道/反向隧道命令，远程工作区一键连。 |
...
| [deepseek-harness-mobile](https://github.com/sorsama/deepseek-harness-mobile) | 77 | ⚪ unknown | 安卓伴侣应用：聊天、目标、审批与通知，手机随时遥控 DSH。 |
...
| [dsh-pocket](https://github.com/shaobeichen/dsh-pocket) | 1141 | 🟢 ok | untranslated |
...
| [dsh-proxy](https://github.com/smanx/dsh-proxy) | 20 | ⚪ unknown | untranslated |
| [dsh-damage-pulse](https://github.com/wssfk12138/dsh-damage-pulse) | 166 | 🟢 ok | untranslated |
| [dsh-reminder](https://github.com/Aisland-SJL/dsh-reminder) | 18 | 🟢 ok | untranslated |
| [dsh-mobile](https://github.com/saya-ch/dsh-mobile) | 266 | 🟢 ok | untranslated |
...
| [dsh-remote-web-gateway](https://github.com/summer1238/dsh-remote-web-gateway) | 148 | 🟢 ok | untranslated |
| [dsh-web-startup-auth](https://github.com/GDWhisper/dsh-web-startup-auth) | 40 | 🟢 ok | untranslated |
...
| [dsh-remote-mobile](https://github.com/IceApriler/dsh-remote-mobile) | 16 | 🟢 ok | untranslated |
| [ds-harness-remote](https://github.com/liguobao/ds-harness-remote) | 191 | 🟢 ok | untranslated |
| [dsh-remote](https://github.com/SCSpotato/dsh-remote) | 102 | 🟢 ok | untranslated |
| [dsh-plugin-hub](https://github.com/wingsky-1/dsh-plugin-hub) | 16 | 🟢 ok | untranslated |
| [dsh-remote](https://github.com/mrRisega/dsh-remote) | 52 | 🟢 ok | untranslated |
| [dsh-acp-interactive](https://github.com/ClickPM/dsh-acp-interactive) | 43 | ⚪ unknown | untranslated |
...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [EchoBird](https://github.com/edison7009/EchoBird) | 3238 | ⚪ unknown | 一键安装+切换 Claude Code/Codex/Kimi/Qwen 等 20+ 编码智能体 |
...
| [awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 1062 | ⚪ unknown | DSH 生态精选：插件、工具与基建 |
| [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 276 | 🟢 ok | DSH 终端 UI（TUI） |
...
| [dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil) | 171 | 🟢 ok | 把 DSH 接进 OpenPencil 设计工具：Agent 可以在设计稿上做预览和编辑，边聊边改设计。 |
| [oh-dsh-desktop](https://github.com/hust-open-atom-club/oh-dsh-desktop) | 316 | 🔴 broken (dump-config exit=1 but plugin not found in composed tree) | 可扩展的 macOS DSH 工作台（原生 PTY） |
| [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) | 260 | 🟢 ok | 对话内生成式 UI：把交互式 HTML 卡片画进会话 |
...
| [dsh-gomoku](https://github.com/omdsh-dev/dsh-gomoku) | 24 | ⚪ unknown | 在 DSH 里与 AI 下五子棋 |
...
| [awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 338 | ⚪ unknown | 双语 DSH 插件生态完整列表 |
...
| [orbis](https://github.com/icodesign/orbis) | 14 | ⚪ unknown | DSH 远程控制的移动客户端 |
...
| [dsh-lan](https://github.com/moxisuki/dsh-lan) | 5 | 🟢 ok | 一条 overlay 把 dsh web 暴露到局域网。 |
...
| [dsh-lark-link](https://github.com/amlyczz/dsh-lark-link) | 38 | 🟢 ok | 高可靠飞书桥接：扫码一键授权、多模式 agent、卡片式命令、零丢失发件箱。 |
...
| [dsh-notifier](https://github.com/THEWOLFWALKER/dsh-notifier) | 47 | 🟢 ok | untranslated |
...
| [dsh-meow-smooth](https://github.com/Phant0Meow/dsh-meow-smooth) | 44 | ⚪ unknown | untranslated |
| [harness-one](https://github.com/chumingjun/harness-one) | 19 | ⚪ unknown | untranslated |
| [dsh-dingtalk](https://github.com/DingTalk-Real-AI/dsh-dingtalk) | 16 | 🟢 ok | untranslated |
| [dsh-harness-one](https://github.com/chumingjun/dsh-harness-one) | 19 | 🟢 ok | untranslated |
| [dsh-wechat-article](https://github.com/aiworkskills/dsh-wechat-article) | 8 | ⚪ unknown | untranslated |
| [dsh-plugin-mobile-gateway](https://github.com/Clarklevis1995/dsh-plugin-mobile-gateway) | 26 | 🟢 ok | untranslated |
...
> 徽章含义：🟢 兼容 · 🔴 不兼容 · ⚪ 未实测 · ⚫ 弃坑。
> 共 1902 个条目，按分类分表、类内按 ⭐ 降序。收录 / 字段词典见 [docs/catalog-schema.md](docs/catalog-schema.md)。
<!-- CATALOG:END -->
