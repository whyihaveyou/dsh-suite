...
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 1597 | ⚪ unknown | DSH Web UI plugin & skin collection: task board, git panel, etc. |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 642 | ⚪ unknown | Sidebar workbench: file render/terminal/git/subagent |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 471 | ⚪ unknown | DSH Web whale-girl skin series |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 295 | ⚪ unknown | Vision for text-only models: image QA, screenshot OCR, UI reconstruction |
...
| [dsh-interconnect](https://github.com/Chinesezjc/dsh-interconnect) | 23 | ⚪ unknown | Cross-instance message/event handoff |
| [dsh-openbiliclaw](https://github.com/whiteguo233/dsh-openbiliclaw) | 19 | ⚪ unknown | OpenBiliClaw content-agent bridge for DSH |
| [dsh-plugin-check](https://github.com/omdsh-dev/dsh-plugin-check) | 16 | ⚪ unknown | Scan plugin repo manifest protocol / patch format / build traps |
...
| [dsh-plugin-mineru](https://github.com/HuanLinOTO/dsh-plugin-mineru) | 8 | ⚪ unknown | MineRU document parsing tools |
...
| [modsearch](https://github.com/liustack/modsearch) | 82 | ⚪ unknown | Web search plugin for DeepSeek Harness. |
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 73 | ⚪ unknown | Chrome sidebar extension letting DSH drive the browser. |
...
| [dsh-ui-whale](https://github.com/lhh010/dsh-ui-whale) | 26 | ⚪ unknown | Hand-drawn pixel whale companion |
| [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) | 34 | ⚪ unknown | Selection annotation: select→annotate→send |
...
| [whale-girl](https://github.com/vlln/whale-girl) | 116 | ⚪ unknown | QQ-pet-style desktop pet plugin |
...
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 35 | ⚪ unknown | Cross-session long-term memory + background self-evolution |
...
| [plugin-session-export](https://github.com/whyihaveyou/dsh-suite) | 3 | 🟢 ok | Export the append-only session log as human-readable Markdown / HTML, grouped by trajectory source (system prompt / reasoning / t… |
| [dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) | 19 | ⚪ unknown | Import chat history from Claude Code/Codex/Reasonix into DSH. |
...
| [dsh-model-config-sync](https://github.com/LiangYin233/dsh-model-config-sync) | 4 | ⚪ unknown | dsh-model-config-sync — DSH plugin (session) |
...
| [modlens](https://github.com/liustack/modlens) | 1103 | ⚪ unknown | The first vision plugin for DeepSeek Harness — let text-only models see. |
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 790 | ⚪ unknown | Vision toolbox & skills for text-only models: multi-image QA, UI reconstruction, GUI automation. |
...
| [dsh-vision-sidecar](https://github.com/121103qwq/dsh-vision-sidecar) | 3 | ⚪ unknown | Hosted free vision sidecar for DeepSeek Harness with durable session evidence |
...
| Plugin | ⭐ | Compat | Description |
|---|---|---|---|
| [openhanako](https://github.com/liliMozi/openhanako) | 6036 | ⚪ unknown | Personal AI agent with memory, personality and autonomy |
...
| [distill](https://github.com/LoserFox/distill) | 15 | ⚪ unknown | Auto conversation distillation: background subagent reflection |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 212 | ⚪ unknown | AgentTeams plugin |
...
| [dsh-work](https://github.com/vibeinging/dsh-work) | 22 | ⚪ unknown | Local-first AI workbench for DSH plugins |
...
| [dsh-explain](https://github.com/yuezengwu/dsh-explain) | 7 | ⚪ unknown | Local-first learning mode: cross-session learning thread |
...
| [awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) | 691 | ⚪ unknown | DSH plugin directory with daily compatibility tracking |
...
| [awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 331 | ⚪ unknown | DSH ecosystem curation: plugins, tools, infra |
| [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 116 | ⚪ unknown | DeepSeek Harness terminal UI |
...
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 293 | ⚪ unknown | 2005-style sidebar ads plugin (parody) |
...
| [oh-dsh-desktop](https://github.com/hust-open-atom-club/oh-dsh-desktop) | 153 | ⚪ unknown | Extensible macOS DSH workbench with native PTY |
| [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) | 73 | ⚪ unknown | In-chat generative UI: interactive HTML cards |
...
| [dsh-emoji](https://github.com/hellodigua/dsh-emoji) | 10 | ⚪ unknown | Auto-add emoji to AI replies |
...
| [awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 66 | ⚪ unknown | Bilingual complete list of the DSH plugin ecosystem |
...
| [plugin-registry](https://github.com/vlln/plugin-registry) | 29 | ⚪ unknown | DSH plugin registry infra: browser panel for official repository plugins |
| [create-dsh-plugin](https://github.com/whyihaveyou/dsh-suite) | 3 | 🟢 ok | Scaffold a DeepSeek Harness (DSH) plugin in seconds — tool / events / webui templates, next-tag version pinning, and a built-in -… |
...
| [dsh-lark-bridge](https://github.com/imetn/dsh-lark-bridge) | 4 | ⚪ unknown | Bidirectional Lark/Feishu controller for DeepSeek Harness |
...
> 934 entries total, grouped by category, sorted by ⭐ within each. Schema dictionary: [docs/catalog-schema.md](docs/catalog-schema.md).
<!-- CATALOG:END -->
