...
![Plugins](https://img.shields.io/badge/plugins-922-facc15?style=flat-square)
...
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 1545 | ⚪ unknown | DSH Web UI plugin & skin collection: task board, git panel, etc. |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 627 | ⚪ unknown | Sidebar workbench: file render/terminal/git/subagent |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 453 | ⚪ unknown | DSH Web whale-girl skin series |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 292 | ⚪ unknown | Vision for text-only models: image QA, screenshot OCR, UI reconstruction |
...
| [dsh-data-agent](https://github.com/omdsh-dev/dsh-data-agent) | 14 | ⚪ unknown | Connect DB and write SQL plugin |
...
| [dsh-plugin-check](https://github.com/omdsh-dev/dsh-plugin-check) | 15 | ⚪ unknown | Scan plugin repo manifest protocol / patch format / build traps |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 9 | ⚪ unknown | Mnemon three-layer memory deep integration |
...
| [ego-browser](https://github.com/Fisfzy/ego-browser) | 10 | ⚪ unknown | Bridge ego-lite Chromium browser into DSH |
...
| [modsearch](https://github.com/liustack/modsearch) | 80 | ⚪ unknown | Web search plugin for DeepSeek Harness. |
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 71 | ⚪ unknown | Chrome sidebar extension letting DSH drive the browser. |
...
| [dsh-composer-polish](https://github.com/tianji-qingtian/dsh-composer-polish) | 4 | ⚪ unknown | DeepSeek Harness plugin: one-click ✨ composer draft polishing — flash rewrite, auto fill-back into the input box |
...
| [dsh-toy](https://github.com/c3ll256/dsh-toy) | 2 | ⚪ unknown | Toy Control Protocol for DSH |
...
| [dsh-pixluna](https://github.com/PixLunaLab/dsh-pixluna) | 1 | ⚪ unknown | dsh-plugin-pixluna | 让 DSH 自己看涩图！ |
...
| [dsh-project-file-explorer](https://github.com/BillionSeniors/dsh-project-file-explorer) | 1 | ⚪ unknown | DeepSeek Harness ?????????:??????? + ????(??/??/??/???/PDF) |
...
| [superpowers-dsh](https://github.com/LayneChai/superpowers-dsh) | 10 | ⚪ unknown | Superpowers skills for DeepSeek Harness: TDD, debugging, planning, and collaboration skills adapted from obra/superpowers |
| [dsh-skill-viewer](https://github.com/Fishquito7/dsh-skill-viewer) | 10 | ⚪ unknown | DSH Web UI plugin: Skills settings section with hot enable/disable, delete and add |
...
| [dsh-side-panel](https://github.com/ccq1/dsh-side-panel) | 16 | ⚪ unknown | DSH side panel: file browser, terminal, git review |
| [dsh-ui-progress](https://github.com/lhh010/dsh-ui-progress) | 7 | ⚪ unknown | Session progress bar: todos progress + live token rate |
| [dsh-ui-whale](https://github.com/lhh010/dsh-ui-whale) | 25 | ⚪ unknown | Hand-drawn pixel whale companion |
| [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) | 32 | ⚪ unknown | Selection annotation: select→annotate→send |
...
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 67 | ⚪ unknown | Inline interactive UI components in chat |
...
| [dsh-plugin-background](https://github.com/gameswu/dsh-plugin-background) | 7 | ⚪ unknown | DSH wallpaper plugin |
...
| [dsh-spotlight](https://github.com/0xsline/dsh-spotlight) | 3 | ⚪ unknown | Keyboard-first command palette |
...
| [whale-girl](https://github.com/vlln/whale-girl) | 113 | ⚪ unknown | QQ-pet-style desktop pet plugin |
...
| [deepseek-harness-skin](https://github.com/HeiGeAi/deepseek-harness-skin) | 16 | ⚪ unknown | deepseek-harness-skin — DSH plugin (ui) |
...
| [dskin](https://github.com/dancingmemory/dskin) | 18 | ⚪ unknown | DSKIN · DeepSeek Harness（DSH）卡通像素皮肤插件 / Cartoon pixel skin plugin for DSH Web GUI — 原始界面不动，像素宠物会散步、眨眼、跳跃 / living pixel pets that… |
...
| [dsh-shuttle](https://github.com/omdsh-dev/dsh-shuttle) | 1 | ⚪ unknown | 在 DeepSeek Harness 与 Codex、Claude Code、Pi、Reasonix、OpenCode 之间双向迁移对话记录，支持 CLI 与 Web UI |
...
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 31 | ⚪ unknown | Cross-session long-term memory + background self-evolution |
...
| [plugin-session-export](https://github.com/whyihaveyou/dsh-suite) | 3 | 🟢 ok | Export the append-only session log as human-readable Markdown / HTML, grouped by trajectory source (system prompt / reasoning / t… |
| [dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) | 18 | ⚪ unknown | Import chat history from Claude Code/Codex/Reasonix into DSH. |
...
| [billion-context-dsh](https://github.com/Tyan66666/billion-context-dsh) | 6 | ⚪ unknown | Model-driven context management (Active Context Pruning / ACP) for the DeepSeek Harness — the model decides when and what to comp… |
...
| [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) | 5 | ⚪ unknown | dsh-cost-meter — DSH plugin (session) |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 15 | ⚪ unknown | A DeepSeek Harness plugin for Context insight panel — a Context tab in the web UI showing what the model's context window is made… |
...
| [dsh-archived-sessions](https://github.com/Zephyr-vibe/dsh-archived-sessions) | 2 | ⚪ unknown | DSH Session Manager: manage conversations, archive/restore, delete safely, open record folders. |
...
| [dsh-personalize](https://github.com/Zephyr-vibe/dsh-personalize) | 2 | ⚪ unknown | Per-host personalization for DSH: custom instructions, local long-term memory, and reply-tone presets. |
...
| [dsh-memory-evidence](https://github.com/LeslieWylie/dsh-memory-evidence) | 1 | ⚪ unknown | Git-first memory navigation and bounded evidence tools for DeepSeek Harness. |
| [dsh-ops-kit](https://github.com/LeslieWylie/dsh-ops-kit) | 1 | ⚪ unknown | A reusable DeepSeek Harness bundle for evidence-driven memory, orchestration, benchmark operations, and plugin release workflows. |
...
| [modlens](https://github.com/liustack/modlens) | 1085 | ⚪ unknown | The first vision plugin for DeepSeek Harness — let text-only models see. |
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 788 | ⚪ unknown | Vision toolbox & skills for text-only models: multi-image QA, UI reconstruction, GUI automation. |
...
| [dsh-vision](https://github.com/oil-oil/dsh-vision) | 8 | ⚪ unknown | Near-native image understanding for DeepSeek Harness |
...
| [dsh-llm-fallback](https://github.com/Visol-456/dsh-llm-fallback) | 1 | ⚪ unknown | DeepSeek Harness plugin: automatic provider/model fallback chains |
...
| Plugin | ⭐ | Compat | Description |
|---|---|---|---|
| [openhanako](https://github.com/liliMozi/openhanako) | 6035 | ⚪ unknown | Personal AI agent with memory, personality and autonomy |
...
| [distill](https://github.com/LoserFox/distill) | 15 | ⚪ unknown | Auto conversation distillation: background subagent reflection |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 209 | ⚪ unknown | AgentTeams plugin |
| [dsh-automation](https://github.com/titanwings/dsh-automation) | 26 | ⚪ unknown | Run scheduled tasks in fresh sessions per plan |
...
| [dsh-deep-research](https://github.com/omdsh-dev/dsh-deep-research) | 8 | ⚪ unknown | Adaptive deep-research orchestrator plugin |
| [dsh-explain](https://github.com/yuezengwu/dsh-explain) | 5 | ⚪ unknown | Local-first learning mode: cross-session learning thread |
...
| [dsh-milestone](https://github.com/SnowCrescenter-tech/dsh-milestone) | 8 | ⚪ unknown | Git-style milestone timeline plugin. |
...
| [Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 2722 | ⚪ unknown | VibeSkills is a general-purpose Skill that automatically routes local Skills and intelligently orchestrates harness workflows. |
...
| [dsh-codex-pet](https://github.com/skr311/dsh-codex-pet) | 2 | ⚪ unknown | dsh-codex-pet · DSH 桌面宠物插件 — 导入精灵图序列帧宠物，悬浮浮层渲染 + Agent 状态联动 |
...
| [dsh-agent-orchestration](https://github.com/LeslieWylie/dsh-agent-orchestration) | 1 | ⚪ unknown | Evidence-first multi-agent workflow planning, handoff validation, and Loop Guard skills for DeepSeek Harness. |
...
| [awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) | 671 | ⚪ unknown | DSH plugin directory with daily compatibility tracking |
...
| [awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 321 | ⚪ unknown | DSH ecosystem curation: plugins, tools, infra |
| [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 112 | ⚪ unknown | DeepSeek Harness terminal UI |
| [agent-skills](https://github.com/GitHubxsy/agent-skills) | 20 | ⚪ unknown | Reusable skills for AI coding agents |
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 106 | ⚪ unknown | Codex-style @file mentions for DeepSeek Harness: search workspace files in the composer and attach their contents to prompts. |
...
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 290 | ⚪ unknown | 2005-style sidebar ads plugin (parody) |
...
| [oh-dsh-desktop](https://github.com/hust-open-atom-club/oh-dsh-desktop) | 152 | ⚪ unknown | Extensible macOS DSH workbench with native PTY |
| [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) | 72 | ⚪ unknown | In-chat generative UI: interactive HTML cards |
...
| [oh-my-dsh](https://github.com/LaplaceYoung/oh-my-dsh) | 42 | ⚪ unknown | DSH plugin ecosystem (700+ plugins) |
| [dsh-gomoku](https://github.com/omdsh-dev/dsh-gomoku) | 10 | ⚪ unknown | Play Gomoku against AI in DSH |
| [dsh-web-review](https://github.com/CanglongCl/dsh-web-review) | 12 | ⚪ unknown | DeepSeek Harness Web GUI 的网页预览与元素批注插件，让 AI 根据可视化反馈直接修改前端源码。 |
...
| [awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 65 | ⚪ unknown | Bilingual complete list of the DSH plugin ecosystem |
| [dsh-launcher](https://github.com/Ruler4396/dsh-launcher) | 56 | ⚪ unknown | WebView2-based DSH launcher |
...
> 922 entries total, grouped by category, sorted by ⭐ within each. Schema dictionary: [docs/catalog-schema.md](docs/catalog-schema.md).
<!-- CATALOG:END -->
