...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 6536 | 🟢 ok | DSH Web UI 插件与皮肤合集：任务板、Git 面板等 |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3149 | 🟢 ok | 侧边栏完整工作台：文件渲染/终端/Git/子代理 |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1839 | ⚪ unknown | DSH Web 鲸鱼娘皮肤系列（深海女仆工坊） |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 845 | 🟢 ok | 给纯文本模型加视觉：图片问答、长截图 OCR、UI 还原 |
| [dsh_workflow](https://github.com/icetomoyo/dsh_workflow) | 110 | 🟢 ok | 把 Claude Code 的 UltraCode 模式带给 DSH，多 Agent 调度可治理 |
| [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) | 106 | 🟢 ok | 对话回退：回滚会话与工作区状态 |
...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [open-managed-agents](https://github.com/openma-ai/open-managed-agents) | 251 | ⚪ unknown | Claude Managed Agents API 的开源自托管平台（Cloudflare Workers） |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 301 | 🟢 ok | Mnemon 三层记忆体深度集成 |
...
| [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) | 33 | ⚪ unknown | OpenMAIC：课堂/幻灯片/交互式组件 |
...
| [ego-browser](https://github.com/Fisfzy/ego-browser) | 72 | ⚪ unknown | 把 ego-lite 浏览器接入 DSH（给 Agent 用的 Chromium） |
...
| [modsearch](https://github.com/liustack/modsearch) | 324 | ⚪ unknown | DeepSeek Harness 的联网搜索插件。 |
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 533 | 🟢 ok | Chrome 侧边栏扩展，让 DSH 操控浏览器。 |
...
| [dsh-expression](https://github.com/yyh-001/dsh-expression) | 68 | 🟢 ok | 找得到、发得出 —— DSH 表情包插件：语义搜图，只发真实文件，走 companion QQ 通道 |
...
| [dsh-plugin-template](https://github.com/bugmaker2/dsh-plugin-template) | 76 | ⚪ unknown | dsh-plugin-template — DSH 插件（工具） |
...
| [dsh-codex-connect](https://github.com/franksong2702/dsh-codex-connect) | 67 | 🟢 ok | 通过 ChatGPT OAuth 在 DeepSeek Harness 中使用 OpenAI Codex 模型。 |
...
| [dsh-codex-subscription](https://github.com/WSL043/dsh-codex-subscription) | 29 | 🟢 ok | dsh-codex-subscription — DSH 插件（工具） |
...
| [dsh-passwords](https://github.com/slywalker2006/dsh-passwords) | 35 | ⚪ unknown | 让 DeepSeek Harness 变成服务器级多租户平台：远程访问 + 自动 HTTPS、子用户权限与配额、沙盒强制、加密认证与审计日志。 |
...
| [anysearch-dsh](https://github.com/anysearch-team/anysearch-dsh) | 373 | 🟢 ok | AnySearch 联网搜索接入：给 DSH 配上 AnySearch 的搜索 provider 和进阶搜索工具。 |
...
| [dsh-plugin](https://github.com/Tabbit-Browser/dsh-plugin) | 98 | 🔴 broken (cordis 4.0.2 not in peer "4.0.1") | 让 DSH 通过插件控制 Tabbit 浏览器：安装后 agent 可以驱动 Tabbit 做浏览器操作。 |
...
| [deepseek-harness-for-vscode](https://github.com/skymecode/deepseek-harness-for-vscode) | 116 | ⚪ unknown | deepseek-harness 的 VS Code 社区扩展。 |
...
| [dsh-auto-mode](https://github.com/NanmiCoder/dsh-auto-mode) | 139 | 🟢 ok | 安全的自动授权：在「每次都要点批准」和「无脑全放开」之间加一档，按规则自动放行常规操作。 |
...
| [Deepseek-Harness-for-VS-Code](https://github.com/Vithrive/Deepseek-Harness-for-VS-Code) | 12 | ⚪ unknown | untranslated |
...
| [dsh-win32](https://github.com/sjh9714/dsh-win32) | 27 | 🟢 ok | untranslated |
...
| [dsh-pentest](https://github.com/howmp/dsh-pentest) | 330 | 🟢 ok | untranslated |
...
| [amadeus-for-dsh](https://github.com/yyxcnasd/amadeus-for-dsh) | 20 | ⚪ unknown | untranslated |
...
| [helm-d](https://github.com/ADWMC/helm-d) | 31 | ⚪ unknown | untranslated |
...
| [dsh-voice-ai-girlfriend](https://github.com/beiyege-01/dsh-voice-ai-girlfriend) | 51 | ⚪ unknown | untranslated |
...
| [dsh-trading](https://github.com/maddogfinance/dsh-trading) | 24 | ⚪ unknown | untranslated |
...
| [dsh-wallpaper-engine](https://github.com/elysia395/dsh-wallpaper-engine) | 216 | 🔴 broken (failed once, retried — install blocked by pnpm build-script policy (allowBuilds) — plugin likely OK, CI policy blocks git prepare scripts) | untranslated |
...
| [dsh-meme](https://github.com/yyh-001/dsh-meme) | 68 | ⚪ unknown | untranslated |
...
| [dsh-univer-office](https://github.com/dream-num/dsh-univer-office) | 207 | 🟢 ok | untranslated |
...
| [dsh-taskboard](https://github.com/cloader/dsh-taskboard) | 30 | ⚪ unknown | untranslated |
| [dsh-omi-voice](https://github.com/PolinniZhong/dsh-omi-voice) | 77 | ⚪ unknown | untranslated |
| [forgeax-dsh-game-plugin](https://github.com/ForgeaX-Games/forgeax-dsh-game-plugin) | 6 | ⚪ unknown | untranslated |
| [dsh-redteam-model](https://github.com/SeaOf0/dsh-redteam-model) | 133 | ⚪ unknown | untranslated |
...
| [dsh-oil-creator](https://github.com/oil-oil/dsh-oil-creator) | 168 | ⚪ unknown | untranslated |
...
| [custom-first-control-prompt](https://github.com/WM-CODER/custom-first-control-prompt) | 57 | ⚪ unknown | untranslated |
...
| [dsh-network-settings](https://github.com/kanneiren/dsh-network-settings) | 89 | ⚪ unknown | untranslated |
| [dsh-tabbit](https://github.com/Tabbit-Browser/dsh-tabbit) | 98 | 🟢 ok | untranslated |
| [dsh-ros2](https://github.com/StvLi/dsh-ros2) | 8 | 🟢 ok | untranslated |
...
| [dsh-secure-audit](https://github.com/PensiveFei/dsh-secure-audit) | 68 | ⚪ unknown | untranslated |
| [Invoice-Downloader](https://github.com/EthanYoQ/Invoice-Downloader) | 279 | ⚪ unknown | untranslated |
| [dsh-hotplug-hub](https://github.com/ARFCON/dsh-hotplug-hub) | 27 | ⚪ unknown | untranslated |
| [dsh-wenshan](https://github.com/xuedai-mayi/dsh-wenshan) | 93 | ⚪ unknown | untranslated |
| [dsh-portable](https://github.com/sqs404/dsh-portable) | 14 | ⚪ unknown | untranslated |
| [dsh-obsidian](https://github.com/mingzeng21/dsh-obsidian) | 10 | 🟢 ok | untranslated |
| [dsh-ssh-ops](https://github.com/caoyiwei850/dsh-ssh-ops) | 15 | ⚪ unknown | untranslated |
...
| [dsh-preset-plus](https://github.com/Rain-kl/dsh-preset-plus) | 62 | ⚪ unknown | untranslated |
...
| [dsh-automation](https://github.com/MichengAI/dsh-automation) | 12 | 🟢 ok | untranslated |
| [dsh-infinite-gen-2](https://github.com/Minglink/dsh-infinite-gen-2) | 673 | ⚪ unknown | untranslated |
...
| [dsh-research-report](https://github.com/PerryLink/dsh-research-report) | 31 | 🟢 ok | untranslated |
| [dsh-otel](https://github.com/tma1-ai/dsh-otel) | 9 | 🟢 ok | untranslated |
| [DSH-Creator](https://github.com/Jackywxsz/DSH-Creator) | 61 | ⚪ unknown | untranslated |
| [dsh-fund-research](https://github.com/PerryLink/dsh-fund-research) | 14 | 🟢 ok | untranslated |
| [dsh-yolo](https://github.com/hanshanyike/dsh-yolo) | 21 | ⚪ unknown | untranslated |
| [dsh-emacs](https://github.com/vritser/dsh-emacs) | 11 | ⚪ unknown | untranslated |
...
| [superpowers-dsh](https://github.com/LayneChai/superpowers-dsh) | 110 | 🟢 ok | Superpowers 技能包移植版：TDD、调试、规划、协作等经典工作流技能，装进 DSH 直接用。 |
| [dsh-skill-viewer](https://github.com/Fishquito7/dsh-skill-viewer) | 111 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | 技能管理面板：在设置页直接启用/停用、删除、添加 Skills，不用改配置文件。 |
...
| [dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill) | 96 | ⚪ unknown | 逆向技能全家桶（85 个 SKILL.md）：逆向工程、授权渗透和安全研究的工作流，打包成插件。 |
...
| [dsh-skills-manager](https://github.com/MichengAI/dsh-skills-manager) | 26 | 🟢 ok | untranslated |
...
| [dsh-skill-mcp-panel](https://github.com/Fishquito7/dsh-skill-mcp-panel) | 111 | 🟢 ok | untranslated |
...
| [oh-story-dsh](https://github.com/worldwonderer/oh-story-dsh) | 225 | ⚪ unknown | untranslated |
...
| [dsh-mattpocock-skills-deck](https://github.com/FeatherHunter/dsh-mattpocock-skills-deck) | 34 | ⚪ unknown | untranslated |
| [oh-story-dsh](https://github.com/zenstory-ai/oh-story-dsh) | 225 | ⚪ unknown | untranslated |
| [dsh-industry-research](https://github.com/PerryLink/dsh-industry-research) | 28 | 🟢 ok | untranslated |
...
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 375 | 🟢 ok | 会话内联渲染交互式 UI 组件 |
...
| [whale-girl](https://github.com/vlln/whale-girl) | 299 | 🟢 ok | QQ 宠物形态的桌面宠物插件 |
| [dsh-status-rotator](https://github.com/01Virex/dsh-status-rotator) | 62 | 🟢 ok | 替换 DSH 状态显示的 web 插件。 |
...
| [dsh-undo-plugin](https://github.com/lire1131/dsh-undo-plugin) | 138 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | 配置后悔药：插件/皮肤/设置改动自动快照，可撤销、可回滚，带快照管理面板和快捷键。 |
| [plugin-manager](https://github.com/whyihaveyou/dsh-suite) | 7 | 🟢 ok | DSH Web UI 内置插件商店：浏览 dsh-suite 目录、搜索/筛选/排序、兼容徽章、一键安装——设置页插件区的 Store 标签页。 |
...
| [dsh-liang-skin](https://github.com/kingOfSoySauce/dsh-liang-skin) | 151 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree (client-inject skin may need web restart)) | 滑动变祖器皮肤：滑块控制『梁圣等级』（自适应推理强度），梗图风 DSH 皮肤 |
...
| [dsh-smooth-stream](https://github.com/Laplace-bit/dsh-smooth-stream) | 63 | 🟢 ok | 为 DeepSeek Harness Web UI 提供流畅流式渲染和丝滑滚动。 |
| [voyager](https://github.com/Nagi-ovo/voyager) | 19902 | ⚪ unknown | untranslated |
| [dsh-im](https://github.com/xmanrui/dsh-im) | 1020 | 🟢 ok | untranslated |
...
| [dsh-whale-musume](https://github.com/Sutera-Diffusus/dsh-whale-musume) | 48 | ⚪ unknown | untranslated |
...
| [dsh-endfield-ui](https://github.com/rison114514/dsh-endfield-ui) | 50 | ⚪ unknown | untranslated |
...
| [DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 1416 | ⚪ unknown | untranslated |
...
| [dsh-kimino-theme](https://github.com/niiang/dsh-kimino-theme) | 28 | ⚪ unknown | untranslated |
...
| [dsh-undo-savepoint](https://github.com/lire1131/dsh-undo-savepoint) | 138 | ⚪ unknown | untranslated |
| [dsh-code-review](https://github.com/CooStack/dsh-code-review) | 7 | ⚪ unknown | untranslated |
| [dsh-knowledge](https://github.com/Soren-ABT/dsh-knowledge) | 20 | ⚪ unknown | untranslated |
...
| [dsh-codex-ui](https://github.com/MichengAI/dsh-codex-ui) | 44 | ⚪ unknown | untranslated |
| [dsh-theme-endfield](https://github.com/ymh0000123/dsh-theme-endfield) | 63 | ⚪ unknown | untranslated |
...
| [dsh-agy-link](https://github.com/amlyczz/dsh-agy-link) | 30 | 🟢 ok | untranslated |
| [dsh-bloom-theme](https://github.com/webkubor/dsh-bloom-theme) | 17 | ⚪ unknown | untranslated |
| [dsh-android](https://github.com/ZSeven-W/dsh-android) | 128 | ⚪ unknown | untranslated |
...
| [dsh-comfyui](https://github.com/fandc520/dsh-comfyui) | 39 | 🟢 ok | untranslated |
...
| [dsh-custom-skin](https://github.com/SLin-code/dsh-custom-skin) | 99 | ⚪ unknown | untranslated |
...
| [dsh-filesnap](https://github.com/extracurricular-ai/dsh-filesnap) | 20 | 🟢 ok | untranslated |
| [dsh-minecraft-ui](https://github.com/TFboy1/dsh-minecraft-ui) | 11 | 🟢 ok | untranslated |
...
| [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) | 106 | 🟢 ok | 对话回退：回滚会话与工作区状态 |
| [dsh-share](https://github.com/hellodigua/dsh-share) | 35 | 🟢 ok | DSH 对话分享插件 |
| [dsh-message-edit](https://github.com/Moeblack/dsh-message-edit) | 46 | 🟢 ok | 分支式消息编辑、reroll、版本时间线 |
...
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 262 | 🟢 ok | 跨会话长期记忆 + 后台自我进化（纯插件） |
...
| [plugin-session-export](https://github.com/whyihaveyou/dsh-suite) | 3 | 🟢 ok | 把 append-only 会话日志导出成人读的 Markdown / HTML，按来源分组渲染（系统提示 / 思维链 / 工具调用 / 子agent）。 |
| [dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) | 125 | 🟢 ok | 从 Claude Code/Codex/Reasonix 导入历史消息到 DSH。 |
...
| [billion-context-dsh](https://github.com/Tyan66666/billion-context-dsh) | 59 | 🟢 ok | billion-context-dsh — DSH 插件（会话） |
...
| [dsh-memento](https://github.com/PerryLink/dsh-memento) | 77 | 🟢 ok | dsh-memento — DSH 插件（会话） |
...
| [dsh-mneme](https://github.com/modusensus/dsh-mneme) | 67 | ⚪ unknown | Mneme——把记忆主权还给人的记忆插件：SQLite + 可人工编辑的 Markdown 双写，autoDream 在梦境中巩固记忆，106 个测试护航。 |
| [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) | 227 | 🟢 ok | DeepSeek Harness 会话费用统计插件:本会话费用、当日费用、历史记录与官方价格同步 |
...
| [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) | 122 | 🟢 ok | dsh-auto-review — DSH 插件（会话） |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 1187 | 🟢 ok | 上下文洞察面板：Web 界面加一个 Context 标签页，直观看到模型上下文窗口里装了什么、怎么变化的。 |
...
| [dsh-memory](https://github.com/FuRongJun-1999/dsh-memory) | 80 | 🟢 ok | 多 agent 时空记忆图谱：跨会话持久记忆。 |
...
| [dsh-browser](https://github.com/wqty123/dsh-browser) | 41 | 🟢 ok | 共享真实浏览器插件：多个 agent 共用一个浏览器。 |
...
| [dsh-files](https://github.com/taxueseek/dsh-files) | 29 | ⚪ unknown | 双面插件：会话隔离的文件上传（彩色卡片）+ 文档读取工具（text/PDF/DOCX/XLSX）。 |
...
| [dsh-plugin](https://github.com/loongsuite/dsh-plugin) | 19 | 🔴 broken (cordis 4.0.2 not in peer "4.0.1") | untranslated |
...
| [dsh-remote](https://github.com/xgone/dsh-remote) | 52 | 🟢 ok | untranslated |
...
| [MemOS](https://github.com/MemTensor/MemOS) | 11100 | ⚪ unknown | untranslated |
...
| [dsh-trace-compare](https://github.com/lamost423/dsh-trace-compare) | 59 | 🟢 ok | 执行轨迹可视化：主干、失败支路、折返点与子代理支路画在同一根墙钟时间轴上；支持上传 1–2 个 session log 同轴对比，或在会话页签实时看迷宫生长。 |
...
| [dsh-recall-unread](https://github.com/hg1048596-pixel/dsh-recall-unread) | 112 | ⚪ unknown | untranslated |
| [dsh-config-manager](https://github.com/xiajiajun516/dsh-config-manager) | 54 | ⚪ unknown | untranslated |
| [dsh-archive-manager](https://github.com/MichengAI/dsh-archive-manager) | 32 | 🟢 ok | untranslated |
| [dsh-rewind](https://github.com/SiriLee/dsh-rewind) | 26 | 🟢 ok | untranslated |
| [dsh-Mmem](https://github.com/mianyoubiaoqing/dsh-Mmem) | 8 | ⚪ unknown | untranslated |
| [dsh-strata](https://github.com/jsdvjx/dsh-strata) | 67 | 🟢 ok | untranslated |
| [dsh-capability-menu](https://github.com/PKUfudawei/dsh-capability-menu) | 73 | ⚪ unknown | untranslated |
| [dsh-talk-map](https://github.com/Tasihi89/dsh-talk-map) | 65 | ⚪ unknown | untranslated |
...
| [dsh-novel-writer](https://github.com/siweina/dsh-novel-writer) | 14 | ⚪ unknown | untranslated |
| [dsh-sessions-manager](https://github.com/TOBYCAI/dsh-sessions-manager) | 6 | 🟢 ok | DSH 设置面板会话管理器：归档/恢复/彻底删除/移动到其他工作区，带工作区标签与会话日期 |
...
| [StrataGate-AgentMemory](https://github.com/diqierjia/StrataGate-AgentMemory) | 19 | ⚪ unknown | untranslated |
| [dsh-layered-memory](https://github.com/JunNanLYS/dsh-layered-memory) | 10 | 🟢 ok | untranslated |
| [dsh-maze](https://github.com/lamost423/dsh-maze) | 59 | 🟢 ok | untranslated |
...
| [dsh-mcp-manager-ui](https://github.com/Imzl-zl/dsh-mcp-manager-ui) | 11 | ⚪ unknown | untranslated |
...
| [modlens](https://github.com/liustack/modlens) | 3783 | 🟢 ok | DeepSeek Harness 首个视觉插件，纯文本模型看图。 |
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 1126 | ⚪ unknown | 为纯文本模型看图设计的视觉工具箱与技能：多图理解、图片问答、UI 还原、GUI 自动化。 |
...
| [TokenLedger](https://github.com/zh667/TokenLedger) | 190 | ⚪ unknown | Token 记账：对账 New API 与 Sub2API 中转站账单。 |
...
| [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) | 132 | 🟢 ok | Command Code 的 LLM provider（非官方）：实时模型目录、推理强度支持，Models 页有卡片。 |
| [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) | 301 | 🟢 ok | 把 ChatGPT(Codex)、Claude、Grok(X Premium) 的订阅当 DSH 的模型 provider 用。 |
...
| [deepseek-harness-studio](https://github.com/fufankeji/deepseek-harness-studio) | 573 | ⚪ unknown | untranslated |
...
| [dsh-heatmap](https://github.com/283Gawin/dsh-heatmap) | 4 | 🟢 ok | untranslated |
...
| [dsh-imagegen](https://github.com/dickpy/dsh-imagegen) | 42 | ⚪ unknown | untranslated |
...
| [dsh-directorx](https://github.com/LaplaceYoung/dsh-directorx) | 17 | ⚪ unknown | untranslated |
| [dsh-studio](https://github.com/jiuge2467/dsh-studio) | 11 | ⚪ unknown | untranslated |
| [opencues](https://github.com/opencues/opencues) | 41 | ⚪ unknown | untranslated |
| [dsh-live2d-mygo](https://github.com/U1s1-king/dsh-live2d-mygo) | 8 | ⚪ unknown | untranslated |
| [dsh-image-gen](https://github.com/shanliuling/dsh-image-gen) | 285 | 🟢 ok | untranslated |
| [dsh-mmx-bridge](https://github.com/welsione/dsh-mmx-bridge) | 10 | ⚪ unknown | untranslated |
| [dsh-computer-use](https://github.com/988hj7tczd-oss/dsh-computer-use) | 19 | ⚪ unknown | untranslated |
...
| [tongflow](https://github.com/tong-io/tongflow) | 1001 | ⚪ unknown | untranslated |
...
| [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 1034 | ⚪ unknown (watchlist 占位→plugins；dsh.client 声明完整) | 给纯文本 DSH 智能体装上眼睛：内置免 key 免费视觉链 + 11 个像素级视觉工具，一条命令安装，无需 Python。 |
...
| [dsh-voice-scribe](https://github.com/PensiveFei/dsh-voice-scribe) | 28 | ⚪ unknown | untranslated |

### 🛡️ 沙箱

| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [dsh-plugin-miliastra-toolbox](https://github.com/1475505/dsh-plugin-miliastra-toolbox) | 7 | ⚪ unknown | 将千星沙箱（原神千星奇域）知识库接入 Deepseek Harness 的插件 |
...
| [dsh-approve-for-me](https://github.com/timeance/dsh-approve-for-me) | 13 | 🟢 ok | untranslated |
| [mirage-dsh](https://github.com/strukto-ai/mirage) | 3588 | 🟢 ok | 把 DSH 的 fs/shell 提供者换成 mirage 虚拟工作区：文件工具与 shell 命令作用于挂载的资源（RAM/磁盘/S3/Redis/Postgres/Slack/Gmail/Notion）而非宿主磁盘。 |
...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [openhanako](https://github.com/liliMozi/openhanako) | 6433 | ⚪ unknown | 带记忆、人格与自主性的个人 AI 智能体 |
| [exo](https://github.com/exoharness/exo) | 905 | ⚪ unknown | 可递归自编辑自身的 agent+harness 架构 |
| [synergy](https://github.com/SII-Holos/synergy) | 549 | ⚪ unknown | 面向 Open Agentic Web 的通用智能体 |
| [ccteam](https://github.com/firstintent/ccteam) | 378 | ⚪ unknown | 把 Claude Code/Codex/Grok/Kimi 编成团队，Telegram/飞书指挥 |
...
| [distill](https://github.com/LoserFox/distill) | 24 | ⚪ unknown | 自动对话蒸馏：后台 subagent 反省 + 技能更新 |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1214 | 🟢 ok | AgentTeams 插件 |
...
| [dsh-file-review](https://github.com/left0ver/dsh-file-review) | 31 | 🟢 ok | 改完就能审：agent 刚动过的文件直接看 diff，不用离开 DSH Web。 |
...
| [Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 3094 | ⚪ unknown | 通用技能调度器：自动挑选最合适的本地 Skill 并编排整个 Harness 工作流，不用手动指定用哪个技能。 |
...
| [sandbase-skills](https://github.com/sandbaseai/sandbase-skills) | 88 | ⚪ unknown | 88 个可直接安装的 Agent 技能：覆盖研究与增长工作流，带 npm CLI 分发。 |
...
| [dsh-plugin-subagent-director](https://github.com/SeverusZh/dsh-plugin-subagent-director) | 11 | 🟢 ok | 子代理导演：逐个 subagent 指定 LLM 供应商与模型，用角色模板规划主从分工。 |
...
| [dsh-deepread](https://github.com/xiehuan123/dsh-deepread) | 42 | 🟢 ok | untranslated |
...
| [dsh-tavern](https://github.com/flizzywine/dsh-tavern) | 62 | ⚪ unknown | untranslated |
...
| [dsh-evolve-modes](https://github.com/GraySilver/dsh-evolve-modes) | 183 | ⚪ unknown | untranslated |
...
| [dsh-ego-browser](https://github.com/Fisfzy/dsh-ego-browser) | 72 | ⚪ unknown | untranslated |
| [dsh-ux](https://github.com/ayuanwong/dsh-ux) | 14 | ⚪ unknown | untranslated |
| [dsh-agency-agents](https://github.com/MichengAI/dsh-agency-agents) | 26 | ⚪ unknown | untranslated |
...
| [dsh-thinking-effort](https://github.com/hytime/dsh-thinking-effort) | 21 | ⚪ unknown | untranslated |
| [dsh-file-review-tab](https://github.com/Lzh3070/dsh-file-review-tab) | 16 | 🟢 ok | untranslated |
| [pptwise](https://github.com/liustack/pptwise) | 11 | ⚪ unknown | untranslated |
...
| [dsh-raw-html](https://github.com/plolpl789/dsh-raw-html) | 41 | ⚪ unknown | untranslated |
...
| [dsh-Mimir-Academic-research](https://github.com/1692775560/dsh-Mimir-Academic-research) | 137 | ⚪ unknown | untranslated |
| [dsh-better-input](https://github.com/DIAG5/dsh-better-input) | 21 | 🟢 ok | untranslated |
| [dsh-watcher](https://github.com/aa2246740/dsh-watcher) | 14 | ⚪ unknown | untranslated |
| [mattpocock-skills-dsh](https://github.com/gongyijie85/mattpocock-skills-dsh) | 11 | ⚪ unknown | untranslated |
...
| [dsh-lsp-actions](https://github.com/PerryLink/dsh-lsp-actions) | 13 | 🟢 ok | dsh-lsp-actions — DSH 插件（桥接） |
...
| [dsh-usage-stats](https://github.com/Ychris12138/dsh-usage-stats) | 132 | 🟢 ok | Token 用量热力图 + 分模型明细 + DeepSeek 账户余额，全部在一个 Web 面板里看。 |
...
| [dsh-remote](https://github.com/flymysql/dsh-remote) | 46 | 🟢 ok | 远程接入助手：/remote 命令 + 设置页直接打印 SSH 隧道/反向隧道命令，远程工作区一键连。 |
...
| [dsh-better-deepseek](https://github.com/EdgeTypE/dsh-better-deepseek) | 22 | 🟢 ok | untranslated |
| [dsh-mobile-gate](https://github.com/Bernardxu123/dsh-mobile-gate) | 5 | ⚪ unknown | untranslated |
| [dsh-pocket](https://github.com/shaobeichen/dsh-pocket) | 839 | 🟢 ok | untranslated |
...
| [dsh-usage](https://github.com/Aisland-SJL/dsh-usage) | 74 | 🟢 ok | untranslated |
| [dsh-qq-bridge](https://github.com/TomoyoNatsume/dsh-qq-bridge) | 11 | 🟢 ok | untranslated |
| [dsh-proxy](https://github.com/smanx/dsh-proxy) | 11 | ⚪ unknown | untranslated |
| [dsh-damage-pulse](https://github.com/wssfk12138/dsh-damage-pulse) | 145 | 🟢 ok | untranslated |
| [dsh-reminder](https://github.com/Aisland-SJL/dsh-reminder) | 17 | 🟢 ok | untranslated |
| [dsh-mobile](https://github.com/saya-ch/dsh-mobile) | 180 | 🟢 ok | untranslated |
...
| [dsh-remote-web-gateway](https://github.com/summer1238/dsh-remote-web-gateway) | 164 | 🟢 ok | untranslated |
...
| [ds-harness-remote](https://github.com/liguobao/ds-harness-remote) | 136 | 🟢 ok | untranslated |
| [dsh-remote](https://github.com/SCSpotato/dsh-remote) | 9 | ⚪ unknown | untranslated |
...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [EchoBird](https://github.com/edison7009/EchoBird) | 3148 | ⚪ unknown | 一键安装+切换 Claude Code/Codex/Kimi/Qwen 等 20+ 编码智能体 |
| [awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) | 1434 | ⚪ unknown | DSH 插件目录，带每日兼容性跟踪 |
| [deepseek-harness-applicants](https://github.com/Octo-o-o-o/deepseek-harness-applicants) | 54 | ⚪ unknown | DSH 内测申请者名单 |
| [awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 957 | ⚪ unknown | DSH 生态精选：插件、工具与基建 |
...
| [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 499 | 🟢 ok | Codex 风格的 @ 文件引用：在输入框打 @ 就能搜索工作区文件并把内容直接带进对话。 |
| [dsh-open-in-vscode](https://github.com/omdsh-dev/dsh-open-in-vscode) | 55 | 🟢 ok | 一键用 VS Code 打开 DSH 的工作区目录，不用自己复制路径。 |
| [dsh-notification](https://github.com/omdsh-dev/dsh-notification) | 78 | 🟢 ok | DSH 桌面通知：任务回合结束弹系统通知，可按结果类型和关键词自定义哪些才提醒。 |
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 591 | ⚪ unknown | 2005 年中文站点风格侧栏广告插件（恶搞） |
...
| [dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil) | 156 | 🟢 ok | 把 DSH 接进 OpenPencil 设计工具：Agent 可以在设计稿上做预览和编辑，边聊边改设计。 |
| [oh-dsh-desktop](https://github.com/hust-open-atom-club/oh-dsh-desktop) | 293 | 🔴 broken (dump-config exit=1 but plugin not found in composed tree) | 可扩展的 macOS DSH 工作台（原生 PTY） |
| [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) | 231 | 🟢 ok | 对话内生成式 UI：把交互式 HTML 卡片画进会话 |
...
| [awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 302 | ⚪ unknown | 双语 DSH 插件生态完整列表 |
| [dsh-launcher](https://github.com/Ruler4396/dsh-launcher) | 187 | 🟢 ok | 基于 WebView2 的 DSH 启动器 |
...
| [dsh-lark-link](https://github.com/amlyczz/dsh-lark-link) | 32 | 🟢 ok | 高可靠飞书桥接：扫码一键授权、多模式 agent、卡片式命令、零丢失发件箱。 |
...
| [dsh-notifier](https://github.com/THEWOLFWALKER/dsh-notifier) | 81 | 🟢 ok | untranslated |
| [dsh-lark](https://github.com/sugarforever/dsh-lark) | 26 | ⚪ unknown | untranslated |
| [ax-feishu-bridge](https://github.com/AX1202/ax-feishu-bridge) | 42 | 🟢 ok | untranslated |
...
> 徽章含义：🟢 兼容 · 🔴 不兼容 · ⚪ 未实测 · ⚫ 弃坑。
> 共 1799 个条目，按分类分表、类内按 ⭐ 降序。收录 / 字段词典见 [docs/catalog-schema.md](docs/catalog-schema.md)。
<!-- CATALOG:END -->
