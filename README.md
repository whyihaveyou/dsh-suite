...
![Plugins](https://img.shields.io/badge/plugins-784-facc15?style=flat-square)
...
> 784 entries total, grouped by category, sorted by ⭐ within each. Schema dictionary: [docs/catalog-schema.md](docs/catalog-schema.md).
<!-- CATALOG:END -->
