...
const LEARN_RESOURCES = [
  ...
  { id: 'dsh-handbook', type: 'community', lang: 'EN / 多语言',
    url: 'https://github.com/sandbaseai/deepseek-harness-handbook/',
    name_en: 'DeepSeek Harness Handbook (SandbaseAI)', name_zh: 'DeepSeek Harness Handbook（SandbaseAI）',
    desc_en: 'Agent-first, source-backed DSH ops handbook — runtime, tools, sessions, plugins, MCP, sandboxing, troubleshooting.',
    desc_zh: 'Agent-first、source-backed 的 DSH 运维手册（英文主线 + 多语言导航），覆盖 runtime/tools/sessions/plugins/MCP/sandboxing/troubleshooting。' },
  ...
  { id: 'dsh-docs', type: 'chinese-docs', lang: '中文',
    url: 'https://dsh-docs.com/',
    name_en: 'dsh-docs.com (our Chinese docs site)', name_zh: 'dsh-docs.com（自家中文文档站）',
    desc_en: 'Our own Chinese DSH tutorial & docs site — no VPN needed, ready out of the box.',
    desc_zh: '自家中文教程与文档站——开箱即用，无需翻墙。' },
  ...
  { id: 'dsplugin', type: 'chinese-docs', lang: '中文',
    url: 'https://dsplugin.app/',
    name_en: 'dsplugin.app — community plugin directory (unofficial)', name_zh: 'dsplugin.app — 社区插件目录（非官方）',
    desc_en: 'A community DSH plugin registry: browse, publish and auto-discover dsh-plugin repos.',
    desc_zh: '社区 DSH 插件目录：浏览、发布与自动发现 dsh-plugin 仓库。' },
